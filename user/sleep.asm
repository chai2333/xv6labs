...
int main(int argc, char *argv[]) {
  ...
  12:	7e258593          	addi	a1,a1,2018 # 7f0 <malloc+0xec>
  16:	4509                	li	a0,2
  ...
  26:	2ac080e7          	jalr	684(ra) # 2ce <exit>
  }
  ...
  38:	32a080e7          	jalr	810(ra) # 35e <sleep>

  exit(0);
  3c:	4501                	li	a0,0
  3e:	00000097          	auipc	ra,0x0
  42:	290080e7          	jalr	656(ra) # 2ce <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b6:	45e50513          	addi	a0,a0,1118 # 810 <digits>
 3ba:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 482:	392b8b93          	addi	s7,s7,914 # 810 <digits>
 ...
 5c2:	24a90913          	addi	s2,s2,586 # 808 <malloc+0x104>
        while(*s != 0){
