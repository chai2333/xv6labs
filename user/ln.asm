...
main(int argc, char *argv[])
{
  ...
  14:	82058593          	addi	a1,a1,-2016 # 830 <malloc+0xec>
  18:	4509                	li	a0,2
  ...
  36:	32c080e7          	jalr	812(ra) # 35e <link>
  3a:	00054763          	bltz	a0,48 <main+0x48>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit(0);
  3e:	4501                	li	a0,0
  40:	00000097          	auipc	ra,0x0
  44:	2be080e7          	jalr	702(ra) # 2fe <exit>
    fprintf(2, "link %s %s: failed\n", argv[1], argv[2]);
  48:	6894                	ld	a3,16(s1)
  4a:	6490                	ld	a2,8(s1)
  4c:	00000597          	auipc	a1,0x0
  50:	7fc58593          	addi	a1,a1,2044 # 848 <malloc+0x104>
  54:	4509                	li	a0,2
...
_main()
{
  ...
  76:	28c080e7          	jalr	652(ra) # 2fe <exit>
...
gets(char *buf, int max)
{
 ...
 168:	1b2080e7          	jalr	434(ra) # 316 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1ca:	190080e7          	jalr	400(ra) # 356 <fstat>
 1ce:	892a                	mv	s2,a0
  close(fd);
 1d0:	8526                	mv	a0,s1
 1d2:	00000097          	auipc	ra,0x0
 1d6:	154080e7          	jalr	340(ra) # 326 <close>
  return r;
}
 1da:	854a                	mv	a0,s2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 408:	0007c783          	lbu	a5,0(a5) # 4000000 <base+0x3ffeff0>
...
malloc(uint nbytes)
{
 ...
 81c:	b6e080e7          	jalr	-1170(ra) # 386 <sbrk>
  if(p == (char*)-1)
