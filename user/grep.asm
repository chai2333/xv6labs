...
000000000000011a <grep>:
{
 ...
 180:	3e0080e7          	jalr	992(ra) # 55c <write>
 ...
 198:	3c0080e7          	jalr	960(ra) # 554 <read>
...
00000000000001de <main>:
{
 ...
 21e:	362080e7          	jalr	866(ra) # 57c <open>
 222:	84aa                	mv	s1,a0
 ...
 23a:	32e080e7          	jalr	814(ra) # 564 <close>
  for(i = 2; i < argc; i++){
 ...
 24a:	2f6080e7          	jalr	758(ra) # 53c <exit>
    fprintf(2, "usage: grep pattern [file ...]\n");
 24e:	00001597          	auipc	a1,0x1
 252:	82258593          	addi	a1,a1,-2014 # a70 <malloc+0xee>
 256:	4509                	li	a0,2
 ...
 266:	2da080e7          	jalr	730(ra) # 53c <exit>
    grep(pattern, 0);
 26a:	4581                	li	a1,0
 26c:	8552                	mv	a0,s4
 ...
 27c:	2c4080e7          	jalr	708(ra) # 53c <exit>
      printf("grep: cannot open %s\n", argv[i]);
 280:	00093583          	ld	a1,0(s2)
 284:	00001517          	auipc	a0,0x1
 288:	80c50513          	addi	a0,a0,-2036 # a90 <malloc+0x10e>
 28c:	00000097          	auipc	ra,0x0
 290:	638080e7          	jalr	1592(ra) # 8c4 <printf>
      exit(1);
 294:	4505                	li	a0,1
 296:	00000097          	auipc	ra,0x0
 29a:	2a6080e7          	jalr	678(ra) # 53c <exit>
...
_main()
{
 ...
 2b4:	28c080e7          	jalr	652(ra) # 53c <exit>
...
gets(char *buf, int max)
{
 ...
 3a6:	1b2080e7          	jalr	434(ra) # 554 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 3f8:	188080e7          	jalr	392(ra) # 57c <open>
  if(fd < 0)
 ...
 408:	190080e7          	jalr	400(ra) # 594 <fstat>
 40c:	892a                	mv	s2,a0
  close(fd);
 40e:	8526                	mv	a0,s1
 410:	00000097          	auipc	ra,0x0
 414:	154080e7          	jalr	340(ra) # 564 <close>
  return r;
}
 418:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 522:	0800                	addi	s0,sp,16
  ...
  return u->pid;
 524:	040007b7          	lui	a5,0x4000
}
 528:	17f5                	addi	a5,a5,-3
...
putc(int fd, char c)
{
 ...
 602:	f5e080e7          	jalr	-162(ra) # 55c <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 634:	48050513          	addi	a0,a0,1152 # ab0 <digits>
 638:	883a                	mv	a6,a4
 ...
 646:	0007c783          	lbu	a5,0(a5) # 4000000 <base+0x3ffebf0>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 700:	3b4b8b93          	addi	s7,s7,948 # ab0 <digits>
 ...
 840:	26c90913          	addi	s2,s2,620 # aa8 <malloc+0x126>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 9de:	a3678793          	addi	a5,a5,-1482 # 1410 <base>
 ...
 a5a:	b6e080e7          	jalr	-1170(ra) # 5c4 <sbrk>
  if(p == (char*)-1)
