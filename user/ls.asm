...
ls(char *path)
{
  ...
  de:	4dc080e7          	jalr	1244(ra) # 5b6 <open>
  ...
  f0:	4e2080e7          	jalr	1250(ra) # 5ce <fstat>
 ...
 12c:	9a850513          	addi	a0,a0,-1624 # ad0 <malloc+0x114>
 ...
 13e:	464080e7          	jalr	1124(ra) # 59e <close>
}
 ...
 16a:	93a58593          	addi	a1,a1,-1734 # aa0 <malloc+0xe4>
 16e:	4509                	li	a0,2
 ...
 180:	93c58593          	addi	a1,a1,-1732 # ab8 <malloc+0xfc>
 184:	4509                	li	a0,2
 ...
 194:	40e080e7          	jalr	1038(ra) # 59e <close>
    return;
 ...
 1b2:	93250513          	addi	a0,a0,-1742 # ae0 <malloc+0x124>
 ...
 1f8:	904a0a13          	addi	s4,s4,-1788 # af8 <malloc+0x13c>
        printf("ls: cannot stat %s\n", buf);
 1fc:	00001a97          	auipc	s5,0x1
 200:	8bca8a93          	addi	s5,s5,-1860 # ab8 <malloc+0xfc>
 ...
 210:	6f2080e7          	jalr	1778(ra) # 8fe <printf>
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 214:	4641                	li	a2,16
 216:	db040593          	addi	a1,s0,-592
 21a:	8526                	mv	a0,s1
 21c:	00000097          	auipc	ra,0x0
 220:	372080e7          	jalr	882(ra) # 58e <read>
 224:	47c1                	li	a5,16
 ...
 278:	68a080e7          	jalr	1674(ra) # 8fe <printf>
...
main(int argc, char *argv[])
{
 ...
 2ba:	2c0080e7          	jalr	704(ra) # 576 <exit>
    ls(".");
 2be:	00001517          	auipc	a0,0x1
 2c2:	84a50513          	addi	a0,a0,-1974 # b08 <malloc+0x14c>
 2c6:	00000097          	auipc	ra,0x0
 2ca:	dee080e7          	jalr	-530(ra) # b4 <ls>
    exit(0);
 2ce:	4501                	li	a0,0
 2d0:	00000097          	auipc	ra,0x0
 2d4:	2a6080e7          	jalr	678(ra) # 576 <exit>
...
_main()
{
 ...
 2ee:	28c080e7          	jalr	652(ra) # 576 <exit>
...
gets(char *buf, int max)
{
 ...
 3e0:	1b2080e7          	jalr	434(ra) # 58e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 432:	188080e7          	jalr	392(ra) # 5b6 <open>
  if(fd < 0)
 ...
 442:	190080e7          	jalr	400(ra) # 5ce <fstat>
 446:	892a                	mv	s2,a0
  close(fd);
 448:	8526                	mv	a0,s1
 44a:	00000097          	auipc	ra,0x0
 44e:	154080e7          	jalr	340(ra) # 59e <close>
  return r;
}
 452:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 55c:	0800                	addi	s0,sp,16
  ...
  return u->pid;
 55e:	040007b7          	lui	a5,0x4000
}
 562:	17f5                	addi	a5,a5,-3
 564:	07b2                	slli	a5,a5,0xc
 566:	4388                	lw	a0,0(a5)
 568:	6422                	ld	s0,8(sp)
...
putc(int fd, char c)
{
 ...
 63c:	f5e080e7          	jalr	-162(ra) # 596 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 66e:	4ae50513          	addi	a0,a0,1198 # b18 <digits>
 672:	883a                	mv	a6,a4
 ...
 680:	0007c783          	lbu	a5,0(a5) # 4000000 <base+0x3ffefe0>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 73a:	3e2b8b93          	addi	s7,s7,994 # b18 <digits>
 ...
 87a:	29a90913          	addi	s2,s2,666 # b10 <malloc+0x154>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 a94:	b6e080e7          	jalr	-1170(ra) # 5fe <sbrk>
  if(p == (char*)-1)
