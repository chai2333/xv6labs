...
main(int argc, char **argv)
{
  ...
  60:	2a6080e7          	jalr	678(ra) # 302 <exit>
...
_main()
{
  ...
  7a:	28c080e7          	jalr	652(ra) # 302 <exit>
...
gets(char *buf, int max)
{
 ...
 16c:	1b2080e7          	jalr	434(ra) # 31a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1be:	188080e7          	jalr	392(ra) # 342 <open>
  if(fd < 0)
 ...
 1ce:	190080e7          	jalr	400(ra) # 35a <fstat>
 1d2:	892a                	mv	s2,a0
  close(fd);
 1d4:	8526                	mv	a0,s1
 1d6:	00000097          	auipc	ra,0x0
 1da:	154080e7          	jalr	340(ra) # 32a <close>
  return r;
}
 1de:	854a                	mv	a0,s2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40c:	0007c783          	lbu	a5,0(a5) # 4000000 <base+0x3ffeff0>
