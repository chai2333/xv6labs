...
print(const char *s)
{
  ...
  20:	3c0080e7          	jalr	960(ra) # 3dc <write>
}
  24:	60e2                	ld	ra,24(sp)
  26:	6442                	ld	s0,16(sp)
  28:	64a2                	ld	s1,8(sp)
...
forktest(void)
{
  ...
  3e:	43650513          	addi	a0,a0,1078 # 470 <pgaccess+0xc>
  ...
  54:	364080e7          	jalr	868(ra) # 3b4 <fork>
    if(pid < 0)
  ...
  68:	41c50513          	addi	a0,a0,1052 # 480 <pgaccess+0x1c>
  ...
  82:	33e080e7          	jalr	830(ra) # 3bc <exit>
  if(n == N){
  ...
  98:	330080e7          	jalr	816(ra) # 3c4 <wait>
  ...
  aa:	31e080e7          	jalr	798(ra) # 3c4 <wait>
  ae:	57fd                	li	a5,-1
  ...
  b8:	41c50513          	addi	a0,a0,1052 # 4d0 <pgaccess+0x6c>
  ...
  d4:	3d050513          	addi	a0,a0,976 # 4a0 <pgaccess+0x3c>
  d8:	00000097          	auipc	ra,0x0
  dc:	f28080e7          	jalr	-216(ra) # 0 <print>
      exit(1);
  e0:	4505                	li	a0,1
  e2:	00000097          	auipc	ra,0x0
  e6:	2da080e7          	jalr	730(ra) # 3bc <exit>
    print("wait got too many\n");
  ea:	00000517          	auipc	a0,0x0
  ee:	3ce50513          	addi	a0,a0,974 # 4b8 <pgaccess+0x54>
  f2:	00000097          	auipc	ra,0x0
  f6:	f0e080e7          	jalr	-242(ra) # 0 <print>
    exit(1);
  fa:	4505                	li	a0,1
  fc:	00000097          	auipc	ra,0x0
 100:	2c0080e7          	jalr	704(ra) # 3bc <exit>
...
main(void)
{
 ...
 11a:	2a6080e7          	jalr	678(ra) # 3bc <exit>
...
_main()
{
 ...
 134:	28c080e7          	jalr	652(ra) # 3bc <exit>
...
gets(char *buf, int max)
{
 ...
 226:	1b2080e7          	jalr	434(ra) # 3d4 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 278:	188080e7          	jalr	392(ra) # 3fc <open>
  if(fd < 0)
 ...
 288:	190080e7          	jalr	400(ra) # 414 <fstat>
 28c:	892a                	mv	s2,a0
  close(fd);
 28e:	8526                	mv	a0,s1
 290:	00000097          	auipc	ra,0x0
 294:	154080e7          	jalr	340(ra) # 3e4 <close>
  return r;
}
 298:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 3a2:	0800                	addi	s0,sp,16
  ...
  return u->pid;
 3a4:	040007b7          	lui	a5,0x4000
}
 3a8:	17f5                	addi	a5,a5,-3
 3aa:	07b2                	slli	a5,a5,0xc
 3ac:	4388                	lw	a0,0(a5)
 3ae:	6422                	ld	s0,8(sp)
