...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open((char *)addr, O_CREATE|O_WRONLY);
      ...
      14:	c0c080e7          	jalr	-1012(ra) # 5c1c <open>
    if(fd >= 0){
    ...
    int fd = open((char *)addr, O_CREATE|O_WRONLY);
      ...
      26:	bfa080e7          	jalr	-1030(ra) # 5c1c <open>
    uint64 addr = addrs[ai];
      2a:	55fd                	li	a1,-1
    if(fd >= 0){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0f250513          	addi	a0,a0,242 # 6130 <malloc+0x10e>
      46:	00006097          	auipc	ra,0x6
      4a:	f1e080e7          	jalr	-226(ra) # 5f64 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      50:	00006097          	auipc	ra,0x6
      54:	b8c080e7          	jalr	-1140(ra) # 5bdc <exit>
      ...
      74:	8082                	ret
{
      ...
      84:	0d050513          	addi	a0,a0,208 # 6150 <malloc+0x12e>
      88:	00006097          	auipc	ra,0x6
      8c:	edc080e7          	jalr	-292(ra) # 5f64 <printf>
      exit(1);
      90:	4505                	li	a0,1
      92:	00006097          	auipc	ra,0x6
      96:	b4a080e7          	jalr	-1206(ra) # 5bdc <exit>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0c050513          	addi	a0,a0,192 # 6168 <malloc+0x146>
      b0:	00006097          	auipc	ra,0x6
      b4:	b6c080e7          	jalr	-1172(ra) # 5c1c <open>
  if(fd < 0){
      b8:	02054663          	bltz	a0,e4 <opentest+0x4a>
  close(fd);
      bc:	00006097          	auipc	ra,0x6
      c0:	b48080e7          	jalr	-1208(ra) # 5c04 <close>
  fd = open("doesnotexist", 0);
      c4:	4581                	li	a1,0
      c6:	00006517          	auipc	a0,0x6
      ca:	0c250513          	addi	a0,a0,194 # 6188 <malloc+0x166>
      ce:	00006097          	auipc	ra,0x6
      d2:	b4e080e7          	jalr	-1202(ra) # 5c1c <open>
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	08a50513          	addi	a0,a0,138 # 6170 <malloc+0x14e>
      ee:	00006097          	auipc	ra,0x6
      f2:	e76080e7          	jalr	-394(ra) # 5f64 <printf>
    exit(1);
      f6:	4505                	li	a0,1
      f8:	00006097          	auipc	ra,0x6
      fc:	ae4080e7          	jalr	-1308(ra) # 5bdc <exit>
    printf("%s: open doesnotexist succeeded!\n", s);
     100:	85a6                	mv	a1,s1
     102:	00006517          	auipc	a0,0x6
     106:	09650513          	addi	a0,a0,150 # 6198 <malloc+0x176>
     10a:	00006097          	auipc	ra,0x6
     10e:	e5a080e7          	jalr	-422(ra) # 5f64 <printf>
    exit(1);
     112:	4505                	li	a0,1
     114:	00006097          	auipc	ra,0x6
     118:	ac8080e7          	jalr	-1336(ra) # 5bdc <exit>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	09450513          	addi	a0,a0,148 # 61c0 <malloc+0x19e>
     134:	00006097          	auipc	ra,0x6
     138:	af8080e7          	jalr	-1288(ra) # 5c2c <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	08050513          	addi	a0,a0,128 # 61c0 <malloc+0x19e>
     148:	00006097          	auipc	ra,0x6
     14c:	ad4080e7          	jalr	-1324(ra) # 5c1c <open>
     150:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     152:	4611                	li	a2,4
     154:	00006597          	auipc	a1,0x6
     158:	07c58593          	addi	a1,a1,124 # 61d0 <malloc+0x1ae>
     15c:	00006097          	auipc	ra,0x6
     160:	aa0080e7          	jalr	-1376(ra) # 5bfc <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	05850513          	addi	a0,a0,88 # 61c0 <malloc+0x19e>
     170:	00006097          	auipc	ra,0x6
     174:	aac080e7          	jalr	-1364(ra) # 5c1c <open>
     178:	892a                	mv	s2,a0
  int n = write(fd1, "x", 1);
     17a:	4605                	li	a2,1
     17c:	00006597          	auipc	a1,0x6
     180:	05c58593          	addi	a1,a1,92 # 61d8 <malloc+0x1b6>
     184:	8526                	mv	a0,s1
     186:	00006097          	auipc	ra,0x6
     18a:	a76080e7          	jalr	-1418(ra) # 5bfc <write>
  if(n != -1){
     18e:	57fd                	li	a5,-1
     190:	02f51b63          	bne	a0,a5,1c6 <truncate2+0xaa>
  unlink("truncfile");
     194:	00006517          	auipc	a0,0x6
     198:	02c50513          	addi	a0,a0,44 # 61c0 <malloc+0x19e>
     19c:	00006097          	auipc	ra,0x6
     1a0:	a90080e7          	jalr	-1392(ra) # 5c2c <unlink>
  close(fd1);
     1a4:	8526                	mv	a0,s1
     1a6:	00006097          	auipc	ra,0x6
     1aa:	a5e080e7          	jalr	-1442(ra) # 5c04 <close>
  close(fd2);
     1ae:	854a                	mv	a0,s2
     1b0:	00006097          	auipc	ra,0x6
     1b4:	a54080e7          	jalr	-1452(ra) # 5c04 <close>
}
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	01650513          	addi	a0,a0,22 # 61e0 <malloc+0x1be>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	d92080e7          	jalr	-622(ra) # 5f64 <printf>
    exit(1);
     1da:	4505                	li	a0,1
     1dc:	00006097          	auipc	ra,0x6
     1e0:	a00080e7          	jalr	-1536(ra) # 5bdc <exit>
...
00000000000001e4 <createtest>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     214:	a0c080e7          	jalr	-1524(ra) # 5c1c <open>
    close(fd);
     218:	00006097          	auipc	ra,0x6
     21c:	9ec080e7          	jalr	-1556(ra) # 5c04 <close>
  for(i = 0; i < N; i++){
  ...
  for(i = 0; i < N; i++){
    ...
    unlink(name);
     ...
     24a:	9e6080e7          	jalr	-1562(ra) # 5c2c <unlink>
  for(i = 0; i < N; i++){
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f8c50513          	addi	a0,a0,-116 # 6208 <malloc+0x1e6>
     284:	00006097          	auipc	ra,0x6
     288:	9a8080e7          	jalr	-1624(ra) # 5c2c <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     28c:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     290:	00006a97          	auipc	s5,0x6
     294:	f78a8a93          	addi	s5,s5,-136 # 6208 <malloc+0x1e6>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2b0:	970080e7          	jalr	-1680(ra) # 5c1c <open>
     2b4:	892a                	mv	s2,a0
    if(fd < 0){
     ...
     2c2:	93e080e7          	jalr	-1730(ra) # 5bfc <write>
     2c6:	89aa                	mv	s3,a0
      if(cc != sz){
     ...
     2d6:	92a080e7          	jalr	-1750(ra) # 5bfc <write>
      if(cc != sz){
     2da:	04951963          	bne	a0,s1,32c <bigwrite+0xc8>
    close(fd);
     2de:	854a                	mv	a0,s2
     2e0:	00006097          	auipc	ra,0x6
     2e4:	924080e7          	jalr	-1756(ra) # 5c04 <close>
    unlink("bigwrite");
     2e8:	8556                	mv	a0,s5
     2ea:	00006097          	auipc	ra,0x6
     2ee:	942080e7          	jalr	-1726(ra) # 5c2c <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f0650513          	addi	a0,a0,-250 # 6218 <malloc+0x1f6>
     31a:	00006097          	auipc	ra,0x6
     31e:	c4a080e7          	jalr	-950(ra) # 5f64 <printf>
      exit(1);
     322:	4505                	li	a0,1
     324:	00006097          	auipc	ra,0x6
     328:	8b8080e7          	jalr	-1864(ra) # 5bdc <exit>
     32c:	84ce                	mv	s1,s3
      int cc = write(fd, buf, sz);
     32e:	89aa                	mv	s3,a0
     ...
     33a:	f0250513          	addi	a0,a0,-254 # 6238 <malloc+0x216>
     33e:	00006097          	auipc	ra,0x6
     342:	c26080e7          	jalr	-986(ra) # 5f64 <printf>
        exit(1);
     346:	4505                	li	a0,1
     348:	00006097          	auipc	ra,0x6
     34c:	894080e7          	jalr	-1900(ra) # 5bdc <exit>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     364:	ef050513          	addi	a0,a0,-272 # 6250 <malloc+0x22e>
     368:	00006097          	auipc	ra,0x6
     36c:	8c4080e7          	jalr	-1852(ra) # 5c2c <unlink>
     370:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     374:	00006997          	auipc	s3,0x6
     378:	edc98993          	addi	s3,s3,-292 # 6250 <malloc+0x22e>
    if(fd < 0){
    ...
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     38c:	894080e7          	jalr	-1900(ra) # 5c1c <open>
     390:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    write(fd, (char*)0xffffffffffL, 1);
     ...
     39e:	862080e7          	jalr	-1950(ra) # 5bfc <write>
    close(fd);
     3a2:	8526                	mv	a0,s1
     3a4:	00006097          	auipc	ra,0x6
     3a8:	860080e7          	jalr	-1952(ra) # 5c04 <close>
    unlink("junk");
     3ac:	854e                	mv	a0,s3
     3ae:	00006097          	auipc	ra,0x6
     3b2:	87e080e7          	jalr	-1922(ra) # 5c2c <unlink>
  for(int i = 0; i < assumed_free; i++){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c4:	e9050513          	addi	a0,a0,-368 # 6250 <malloc+0x22e>
     3c8:	00006097          	auipc	ra,0x6
     3cc:	854080e7          	jalr	-1964(ra) # 5c1c <open>
     3d0:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3dc:	e0058593          	addi	a1,a1,-512 # 61d8 <malloc+0x1b6>
     3e0:	00006097          	auipc	ra,0x6
     3e4:	81c080e7          	jalr	-2020(ra) # 5bfc <write>
     3e8:	4785                	li	a5,1
     3ea:	04f50963          	beq	a0,a5,43c <badwrite+0xec>
    printf("write failed\n");
     3ee:	00006517          	auipc	a0,0x6
     3f2:	e8250513          	addi	a0,a0,-382 # 6270 <malloc+0x24e>
     3f6:	00006097          	auipc	ra,0x6
     3fa:	b6e080e7          	jalr	-1170(ra) # 5f64 <printf>
    exit(1);
     3fe:	4505                	li	a0,1
     400:	00005097          	auipc	ra,0x5
     404:	7dc080e7          	jalr	2012(ra) # 5bdc <exit>
      printf("open junk failed\n");
     408:	00006517          	auipc	a0,0x6
     40c:	e5050513          	addi	a0,a0,-432 # 6258 <malloc+0x236>
     410:	00006097          	auipc	ra,0x6
     414:	b54080e7          	jalr	-1196(ra) # 5f64 <printf>
      exit(1);
     418:	4505                	li	a0,1
     41a:	00005097          	auipc	ra,0x5
     41e:	7c2080e7          	jalr	1986(ra) # 5bdc <exit>
    printf("open junk failed\n");
     422:	00006517          	auipc	a0,0x6
     426:	e3650513          	addi	a0,a0,-458 # 6258 <malloc+0x236>
     42a:	00006097          	auipc	ra,0x6
     42e:	b3a080e7          	jalr	-1222(ra) # 5f64 <printf>
    exit(1);
     432:	4505                	li	a0,1
     434:	00005097          	auipc	ra,0x5
     438:	7a8080e7          	jalr	1960(ra) # 5bdc <exit>
  }
  close(fd);
     43c:	8526                	mv	a0,s1
     43e:	00005097          	auipc	ra,0x5
     442:	7c6080e7          	jalr	1990(ra) # 5c04 <close>
  unlink("junk");
     446:	00006517          	auipc	a0,0x6
     44a:	e0a50513          	addi	a0,a0,-502 # 6250 <malloc+0x22e>
     44e:	00005097          	auipc	ra,0x5
     452:	7de080e7          	jalr	2014(ra) # 5c2c <unlink>

  exit(0);
     456:	4501                	li	a0,0
     458:	00005097          	auipc	ra,0x5
     45c:	784080e7          	jalr	1924(ra) # 5bdc <exit>
...
outofinodes(char *s)
{
  ...
  for(int i = 0; i < nzz; i++){
    ...
    close(fd);
     ...
     4cc:	73c080e7          	jalr	1852(ra) # 5c04 <close>
  for(int i = 0; i < nzz; i++){
  ...
  for(int i = 0; i < nzz; i++){
    ...
    unlink(name);
     ...
     518:	718080e7          	jalr	1816(ra) # 5c2c <unlink>
  for(int i = 0; i < nzz; i++){
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     556:	d2ea0a13          	addi	s4,s4,-722 # 6280 <malloc+0x25e>
    uint64 addr = addrs[ai];
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     568:	6b8080e7          	jalr	1720(ra) # 5c1c <open>
     56c:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     602:	c8a50513          	addi	a0,a0,-886 # 6288 <malloc+0x266>
     606:	00006097          	auipc	ra,0x6
     60a:	95e080e7          	jalr	-1698(ra) # 5f64 <printf>
      exit(1);
     60e:	4505                	li	a0,1
     610:	00005097          	auipc	ra,0x5
     614:	5cc080e7          	jalr	1484(ra) # 5bdc <exit>
      printf("write(fd, %p, 8192) returned %d, not -1\n", addr, n);
     618:	862a                	mv	a2,a0
     61a:	85ce                	mv	a1,s3
     61c:	00006517          	auipc	a0,0x6
     620:	c8450513          	addi	a0,a0,-892 # 62a0 <malloc+0x27e>
     624:	00006097          	auipc	ra,0x6
     628:	940080e7          	jalr	-1728(ra) # 5f64 <printf>
      exit(1);
     62c:	4505                	li	a0,1
     62e:	00005097          	auipc	ra,0x5
     632:	5ae080e7          	jalr	1454(ra) # 5bdc <exit>
      printf("write(1, %p, 8192) returned %d, not -1 or 0\n", addr, n);
     636:	862a                	mv	a2,a0
     638:	85ce                	mv	a1,s3
     63a:	00006517          	auipc	a0,0x6
     63e:	c9650513          	addi	a0,a0,-874 # 62d0 <malloc+0x2ae>
     642:	00006097          	auipc	ra,0x6
     646:	922080e7          	jalr	-1758(ra) # 5f64 <printf>
      exit(1);
     64a:	4505                	li	a0,1
     64c:	00005097          	auipc	ra,0x5
     650:	590080e7          	jalr	1424(ra) # 5bdc <exit>
      printf("pipe() failed\n");
     654:	00006517          	auipc	a0,0x6
     658:	cac50513          	addi	a0,a0,-852 # 6300 <malloc+0x2de>
     65c:	00006097          	auipc	ra,0x6
     660:	908080e7          	jalr	-1784(ra) # 5f64 <printf>
      exit(1);
     664:	4505                	li	a0,1
     666:	00005097          	auipc	ra,0x5
     66a:	576080e7          	jalr	1398(ra) # 5bdc <exit>
      printf("write(pipe, %p, 8192) returned %d, not -1 or 0\n", addr, n);
     66e:	862a                	mv	a2,a0
     670:	85ce                	mv	a1,s3
     672:	00006517          	auipc	a0,0x6
     676:	c9e50513          	addi	a0,a0,-866 # 6310 <malloc+0x2ee>
     67a:	00006097          	auipc	ra,0x6
     67e:	8ea080e7          	jalr	-1814(ra) # 5f64 <printf>
      exit(1);
     682:	4505                	li	a0,1
     684:	00005097          	auipc	ra,0x5
     688:	558080e7          	jalr	1368(ra) # 5bdc <exit>
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b4:	c90a0a13          	addi	s4,s4,-880 # 6340 <malloc+0x31e>
    n = write(fds[1], "x", 1);
     6b8:	00006a97          	auipc	s5,0x6
     6bc:	b20a8a93          	addi	s5,s5,-1248 # 61d8 <malloc+0x1b6>
    uint64 addr = addrs[ai];
    ...
    int fd = open("README", 0);
     ...
     6cc:	554080e7          	jalr	1364(ra) # 5c1c <open>
     6d0:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    n = write(fds[1], "x", 1);
     ...
     70c:	4f4080e7          	jalr	1268(ra) # 5bfc <write>
    if(n != 1){
     710:	4785                	li	a5,1
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     762:	bea50513          	addi	a0,a0,-1046 # 6348 <malloc+0x326>
     766:	00005097          	auipc	ra,0x5
     76a:	7fe080e7          	jalr	2046(ra) # 5f64 <printf>
      exit(1);
     76e:	4505                	li	a0,1
     770:	00005097          	auipc	ra,0x5
     774:	46c080e7          	jalr	1132(ra) # 5bdc <exit>
      printf("read(fd, %p, 8192) returned %d, not -1 or 0\n", addr, n);
     778:	862a                	mv	a2,a0
     77a:	85ce                	mv	a1,s3
     77c:	00006517          	auipc	a0,0x6
     780:	be450513          	addi	a0,a0,-1052 # 6360 <malloc+0x33e>
     784:	00005097          	auipc	ra,0x5
     788:	7e0080e7          	jalr	2016(ra) # 5f64 <printf>
      exit(1);
     78c:	4505                	li	a0,1
     78e:	00005097          	auipc	ra,0x5
     792:	44e080e7          	jalr	1102(ra) # 5bdc <exit>
      printf("pipe() failed\n");
     796:	00006517          	auipc	a0,0x6
     79a:	b6a50513          	addi	a0,a0,-1174 # 6300 <malloc+0x2de>
     79e:	00005097          	auipc	ra,0x5
     7a2:	7c6080e7          	jalr	1990(ra) # 5f64 <printf>
      exit(1);
     7a6:	4505                	li	a0,1
     7a8:	00005097          	auipc	ra,0x5
     7ac:	434080e7          	jalr	1076(ra) # 5bdc <exit>
      printf("pipe write failed\n");
     7b0:	00006517          	auipc	a0,0x6
     7b4:	be050513          	addi	a0,a0,-1056 # 6390 <malloc+0x36e>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	7ac080e7          	jalr	1964(ra) # 5f64 <printf>
      exit(1);
     7c0:	4505                	li	a0,1
     7c2:	00005097          	auipc	ra,0x5
     7c6:	41a080e7          	jalr	1050(ra) # 5bdc <exit>
      printf("read(pipe, %p, 8192) returned %d, not -1 or 0\n", addr, n);
     7ca:	862a                	mv	a2,a0
     7cc:	85ce                	mv	a1,s3
     7ce:	00006517          	auipc	a0,0x6
     7d2:	bda50513          	addi	a0,a0,-1062 # 63a8 <malloc+0x386>
     7d6:	00005097          	auipc	ra,0x5
     7da:	78e080e7          	jalr	1934(ra) # 5f64 <printf>
      exit(1);
     7de:	4505                	li	a0,1
     7e0:	00005097          	auipc	ra,0x5
     7e4:	3fc080e7          	jalr	1020(ra) # 5bdc <exit>
...
00000000000007e8 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     800:	9c450513          	addi	a0,a0,-1596 # 61c0 <malloc+0x19e>
     804:	00005097          	auipc	ra,0x5
     808:	428080e7          	jalr	1064(ra) # 5c2c <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     80c:	60100593          	li	a1,1537
     810:	00006517          	auipc	a0,0x6
     814:	9b050513          	addi	a0,a0,-1616 # 61c0 <malloc+0x19e>
     818:	00005097          	auipc	ra,0x5
     81c:	404080e7          	jalr	1028(ra) # 5c1c <open>
     820:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     822:	4611                	li	a2,4
     824:	00006597          	auipc	a1,0x6
     828:	9ac58593          	addi	a1,a1,-1620 # 61d0 <malloc+0x1ae>
     82c:	00005097          	auipc	ra,0x5
     830:	3d0080e7          	jalr	976(ra) # 5bfc <write>
  close(fd1);
     834:	8526                	mv	a0,s1
     836:	00005097          	auipc	ra,0x5
     83a:	3ce080e7          	jalr	974(ra) # 5c04 <close>
  int fd2 = open("truncfile", O_RDONLY);
     83e:	4581                	li	a1,0
     840:	00006517          	auipc	a0,0x6
     844:	98050513          	addi	a0,a0,-1664 # 61c0 <malloc+0x19e>
     848:	00005097          	auipc	ra,0x5
     84c:	3d4080e7          	jalr	980(ra) # 5c1c <open>
     850:	84aa                	mv	s1,a0
  int n = read(fd2, buf, sizeof(buf));
     852:	02000613          	li	a2,32
     856:	fa040593          	addi	a1,s0,-96
     85a:	00005097          	auipc	ra,0x5
     85e:	39a080e7          	jalr	922(ra) # 5bf4 <read>
  if(n != 4){
     862:	4791                	li	a5,4
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     870:	95450513          	addi	a0,a0,-1708 # 61c0 <malloc+0x19e>
     874:	00005097          	auipc	ra,0x5
     878:	3a8080e7          	jalr	936(ra) # 5c1c <open>
     87c:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     87e:	4581                	li	a1,0
     880:	00006517          	auipc	a0,0x6
     884:	94050513          	addi	a0,a0,-1728 # 61c0 <malloc+0x19e>
     888:	00005097          	auipc	ra,0x5
     88c:	394080e7          	jalr	916(ra) # 5c1c <open>
     890:	892a                	mv	s2,a0
  n = read(fd3, buf, sizeof(buf));
     892:	02000613          	li	a2,32
     896:	fa040593          	addi	a1,s0,-96
     89a:	00005097          	auipc	ra,0x5
     89e:	35a080e7          	jalr	858(ra) # 5bf4 <read>
     8a2:	8a2a                	mv	s4,a0
  if(n != 0){
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     8b4:	344080e7          	jalr	836(ra) # 5bf4 <read>
     8b8:	8a2a                	mv	s4,a0
  if(n != 0){
  ...
  write(fd1, "abcdef", 6);
     ...
     8c2:	b7a58593          	addi	a1,a1,-1158 # 6438 <malloc+0x416>
     8c6:	854e                	mv	a0,s3
     8c8:	00005097          	auipc	ra,0x5
     8cc:	334080e7          	jalr	820(ra) # 5bfc <write>
  n = read(fd3, buf, sizeof(buf));
     8d0:	02000613          	li	a2,32
     8d4:	fa040593          	addi	a1,s0,-96
     8d8:	854a                	mv	a0,s2
     8da:	00005097          	auipc	ra,0x5
     8de:	31a080e7          	jalr	794(ra) # 5bf4 <read>
  if(n != 6){
     8e2:	4799                	li	a5,6
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     8f6:	302080e7          	jalr	770(ra) # 5bf4 <read>
  if(n != 2){
     8fa:	4789                	li	a5,2
     8fc:	0ef51063          	bne	a0,a5,9dc <truncate1+0x1f4>
  unlink("truncfile");
     900:	00006517          	auipc	a0,0x6
     904:	8c050513          	addi	a0,a0,-1856 # 61c0 <malloc+0x19e>
     908:	00005097          	auipc	ra,0x5
     90c:	324080e7          	jalr	804(ra) # 5c2c <unlink>
  close(fd1);
     910:	854e                	mv	a0,s3
     912:	00005097          	auipc	ra,0x5
     916:	2f2080e7          	jalr	754(ra) # 5c04 <close>
  close(fd2);
     91a:	8526                	mv	a0,s1
     91c:	00005097          	auipc	ra,0x5
     920:	2e8080e7          	jalr	744(ra) # 5c04 <close>
  close(fd3);
     924:	854a                	mv	a0,s2
     926:	00005097          	auipc	ra,0x5
     92a:	2de080e7          	jalr	734(ra) # 5c04 <close>
}
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     948:	a9450513          	addi	a0,a0,-1388 # 63d8 <malloc+0x3b6>
     94c:	00005097          	auipc	ra,0x5
     950:	618080e7          	jalr	1560(ra) # 5f64 <printf>
    exit(1);
     954:	4505                	li	a0,1
     956:	00005097          	auipc	ra,0x5
     95a:	286080e7          	jalr	646(ra) # 5bdc <exit>
    printf("aaa fd3=%d\n", fd3);
     95e:	85ca                	mv	a1,s2
     960:	00006517          	auipc	a0,0x6
     964:	a9850513          	addi	a0,a0,-1384 # 63f8 <malloc+0x3d6>
     968:	00005097          	auipc	ra,0x5
     96c:	5fc080e7          	jalr	1532(ra) # 5f64 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     970:	8652                	mv	a2,s4
     972:	85d6                	mv	a1,s5
     974:	00006517          	auipc	a0,0x6
     978:	a9450513          	addi	a0,a0,-1388 # 6408 <malloc+0x3e6>
     97c:	00005097          	auipc	ra,0x5
     980:	5e8080e7          	jalr	1512(ra) # 5f64 <printf>
    exit(1);
     984:	4505                	li	a0,1
     986:	00005097          	auipc	ra,0x5
     98a:	256080e7          	jalr	598(ra) # 5bdc <exit>
    printf("bbb fd2=%d\n", fd2);
     98e:	85a6                	mv	a1,s1
     990:	00006517          	auipc	a0,0x6
     994:	a9850513          	addi	a0,a0,-1384 # 6428 <malloc+0x406>
     998:	00005097          	auipc	ra,0x5
     99c:	5cc080e7          	jalr	1484(ra) # 5f64 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     9a0:	8652                	mv	a2,s4
     9a2:	85d6                	mv	a1,s5
     9a4:	00006517          	auipc	a0,0x6
     9a8:	a6450513          	addi	a0,a0,-1436 # 6408 <malloc+0x3e6>
     9ac:	00005097          	auipc	ra,0x5
     9b0:	5b8080e7          	jalr	1464(ra) # 5f64 <printf>
    exit(1);
     9b4:	4505                	li	a0,1
     9b6:	00005097          	auipc	ra,0x5
     9ba:	226080e7          	jalr	550(ra) # 5bdc <exit>
    printf("%s: read %d bytes, wanted 6\n", s, n);
     9be:	862a                	mv	a2,a0
     9c0:	85d6                	mv	a1,s5
     9c2:	00006517          	auipc	a0,0x6
     9c6:	a7e50513          	addi	a0,a0,-1410 # 6440 <malloc+0x41e>
     9ca:	00005097          	auipc	ra,0x5
     9ce:	59a080e7          	jalr	1434(ra) # 5f64 <printf>
    exit(1);
     9d2:	4505                	li	a0,1
     9d4:	00005097          	auipc	ra,0x5
     9d8:	208080e7          	jalr	520(ra) # 5bdc <exit>
    printf("%s: read %d bytes, wanted 2\n", s, n);
     9dc:	862a                	mv	a2,a0
     9de:	85d6                	mv	a1,s5
     9e0:	00006517          	auipc	a0,0x6
     9e4:	a8050513          	addi	a0,a0,-1408 # 6460 <malloc+0x43e>
     9e8:	00005097          	auipc	ra,0x5
     9ec:	57c080e7          	jalr	1404(ra) # 5f64 <printf>
    exit(1);
     9f0:	4505                	li	a0,1
     9f2:	00005097          	auipc	ra,0x5
     9f6:	1ea080e7          	jalr	490(ra) # 5bdc <exit>
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a18:	a6c50513          	addi	a0,a0,-1428 # 6480 <malloc+0x45e>
     a1c:	00005097          	auipc	ra,0x5
     a20:	200080e7          	jalr	512(ra) # 5c1c <open>
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a30:	a7c98993          	addi	s3,s3,-1412 # 64a8 <malloc+0x486>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a34:	00006a97          	auipc	s5,0x6
     a38:	aaca8a93          	addi	s5,s5,-1364 # 64e0 <malloc+0x4be>
  for(i = 0; i < N; i++){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a4a:	1b6080e7          	jalr	438(ra) # 5bfc <write>
     a4e:	47a9                	li	a5,10
    ...
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     ...
     a5e:	1a2080e7          	jalr	418(ra) # 5bfc <write>
     a62:	47a9                	li	a5,10
  ...
  close(fd);
     ...
     a74:	194080e7          	jalr	404(ra) # 5c04 <close>
  fd = open("small", O_RDONLY);
     a78:	4581                	li	a1,0
     a7a:	00006517          	auipc	a0,0x6
     a7e:	a0650513          	addi	a0,a0,-1530 # 6480 <malloc+0x45e>
     a82:	00005097          	auipc	ra,0x5
     a86:	19a080e7          	jalr	410(ra) # 5c1c <open>
     a8a:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     aa0:	158080e7          	jalr	344(ra) # 5bf4 <read>
  if(i != N*SZ*2){
  ...
  close(fd);
     ...
     ab2:	156080e7          	jalr	342(ra) # 5c04 <close>
  if(unlink("small") < 0){
     ab6:	00006517          	auipc	a0,0x6
     aba:	9ca50513          	addi	a0,a0,-1590 # 6480 <malloc+0x45e>
     abe:	00005097          	auipc	ra,0x5
     ac2:	16e080e7          	jalr	366(ra) # 5c2c <unlink>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae4:	9a850513          	addi	a0,a0,-1624 # 6488 <malloc+0x466>
     ae8:	00005097          	auipc	ra,0x5
     aec:	47c080e7          	jalr	1148(ra) # 5f64 <printf>
    exit(1);
     af0:	4505                	li	a0,1
     af2:	00005097          	auipc	ra,0x5
     af6:	0ea080e7          	jalr	234(ra) # 5bdc <exit>
      printf("%s: error: write aa %d new file failed\n", s, i);
     afa:	8626                	mv	a2,s1
     afc:	85da                	mv	a1,s6
     afe:	00006517          	auipc	a0,0x6
     b02:	9ba50513          	addi	a0,a0,-1606 # 64b8 <malloc+0x496>
     b06:	00005097          	auipc	ra,0x5
     b0a:	45e080e7          	jalr	1118(ra) # 5f64 <printf>
      exit(1);
     b0e:	4505                	li	a0,1
     b10:	00005097          	auipc	ra,0x5
     b14:	0cc080e7          	jalr	204(ra) # 5bdc <exit>
      printf("%s: error: write bb %d new file failed\n", s, i);
     b18:	8626                	mv	a2,s1
     b1a:	85da                	mv	a1,s6
     b1c:	00006517          	auipc	a0,0x6
     b20:	9d450513          	addi	a0,a0,-1580 # 64f0 <malloc+0x4ce>
     b24:	00005097          	auipc	ra,0x5
     b28:	440080e7          	jalr	1088(ra) # 5f64 <printf>
      exit(1);
     b2c:	4505                	li	a0,1
     b2e:	00005097          	auipc	ra,0x5
     b32:	0ae080e7          	jalr	174(ra) # 5bdc <exit>
    printf("%s: error: open small failed!\n", s);
     b36:	85da                	mv	a1,s6
     b38:	00006517          	auipc	a0,0x6
     b3c:	9e050513          	addi	a0,a0,-1568 # 6518 <malloc+0x4f6>
     b40:	00005097          	auipc	ra,0x5
     b44:	424080e7          	jalr	1060(ra) # 5f64 <printf>
    exit(1);
     b48:	4505                	li	a0,1
     b4a:	00005097          	auipc	ra,0x5
     b4e:	092080e7          	jalr	146(ra) # 5bdc <exit>
    printf("%s: read failed\n", s);
     b52:	85da                	mv	a1,s6
     b54:	00006517          	auipc	a0,0x6
     b58:	9e450513          	addi	a0,a0,-1564 # 6538 <malloc+0x516>
     b5c:	00005097          	auipc	ra,0x5
     b60:	408080e7          	jalr	1032(ra) # 5f64 <printf>
    exit(1);
     b64:	4505                	li	a0,1
     b66:	00005097          	auipc	ra,0x5
     b6a:	076080e7          	jalr	118(ra) # 5bdc <exit>
    printf("%s: unlink small failed\n", s);
     b6e:	85da                	mv	a1,s6
     b70:	00006517          	auipc	a0,0x6
     b74:	9e050513          	addi	a0,a0,-1568 # 6550 <malloc+0x52e>
     b78:	00005097          	auipc	ra,0x5
     b7c:	3ec080e7          	jalr	1004(ra) # 5f64 <printf>
    exit(1);
     b80:	4505                	li	a0,1
     b82:	00005097          	auipc	ra,0x5
     b86:	05a080e7          	jalr	90(ra) # 5bdc <exit>
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba6:	9ce50513          	addi	a0,a0,-1586 # 6570 <malloc+0x54e>
     baa:	00005097          	auipc	ra,0x5
     bae:	072080e7          	jalr	114(ra) # 5c1c <open>
     bb2:	89aa                	mv	s3,a0
  for(i = 0; i < MAXFILE; i++){
     bb4:	4481                	li	s1,0
    ((int*)buf)[0] = i;
  ...
  if(fd < 0){
    ...
    if(write(fd, buf, BSIZE) != BSIZE){
     ...
     bd6:	02a080e7          	jalr	42(ra) # 5bfc <write>
  ...
  close(fd);
     ...
     bee:	01a080e7          	jalr	26(ra) # 5c04 <close>
  fd = open("big", O_RDONLY);
     bf2:	4581                	li	a1,0
     bf4:	00006517          	auipc	a0,0x6
     bf8:	97c50513          	addi	a0,a0,-1668 # 6570 <malloc+0x54e>
     bfc:	00005097          	auipc	ra,0x5
     c00:	020080e7          	jalr	32(ra) # 5c1c <open>
     c04:	89aa                	mv	s3,a0
  n = 0;
     c06:	4481                	li	s1,0
    i = read(fd, buf, BSIZE);
  ...
  if(fd < 0){
    ...
    i = read(fd, buf, BSIZE);
     ...
     c20:	fd8080e7          	jalr	-40(ra) # 5bf4 <read>
    if(i == 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	93c50513          	addi	a0,a0,-1732 # 6578 <malloc+0x556>
     c44:	00005097          	auipc	ra,0x5
     c48:	320080e7          	jalr	800(ra) # 5f64 <printf>
    exit(1);
     c4c:	4505                	li	a0,1
     c4e:	00005097          	auipc	ra,0x5
     c52:	f8e080e7          	jalr	-114(ra) # 5bdc <exit>
      printf("%s: error: write big file failed\n", s, i);
     c56:	8626                	mv	a2,s1
     c58:	85d6                	mv	a1,s5
     c5a:	00006517          	auipc	a0,0x6
     c5e:	93e50513          	addi	a0,a0,-1730 # 6598 <malloc+0x576>
     c62:	00005097          	auipc	ra,0x5
     c66:	302080e7          	jalr	770(ra) # 5f64 <printf>
      exit(1);
     c6a:	4505                	li	a0,1
     c6c:	00005097          	auipc	ra,0x5
     c70:	f70080e7          	jalr	-144(ra) # 5bdc <exit>
    printf("%s: error: open big failed!\n", s);
     c74:	85d6                	mv	a1,s5
     c76:	00006517          	auipc	a0,0x6
     c7a:	94a50513          	addi	a0,a0,-1718 # 65c0 <malloc+0x59e>
     c7e:	00005097          	auipc	ra,0x5
     c82:	2e6080e7          	jalr	742(ra) # 5f64 <printf>
    exit(1);
     c86:	4505                	li	a0,1
     c88:	00005097          	auipc	ra,0x5
     c8c:	f54080e7          	jalr	-172(ra) # 5bdc <exit>
      if(n == MAXFILE - 1){
  ...
  close(fd);
     ...
     c9e:	f6a080e7          	jalr	-150(ra) # 5c04 <close>
  if(unlink("big") < 0){
     ca2:	00006517          	auipc	a0,0x6
     ca6:	8ce50513          	addi	a0,a0,-1842 # 6570 <malloc+0x54e>
     caa:	00005097          	auipc	ra,0x5
     cae:	f82080e7          	jalr	-126(ra) # 5c2c <unlink>
     ...
     cd2:	91250513          	addi	a0,a0,-1774 # 65e0 <malloc+0x5be>
     cd6:	00005097          	auipc	ra,0x5
     cda:	28e080e7          	jalr	654(ra) # 5f64 <printf>
        exit(1);
     cde:	4505                	li	a0,1
     ce0:	00005097          	auipc	ra,0x5
     ce4:	efc080e7          	jalr	-260(ra) # 5bdc <exit>
      printf("%s: read failed %d\n", s, i);
     ce8:	862a                	mv	a2,a0
     cea:	85d6                	mv	a1,s5
     cec:	00006517          	auipc	a0,0x6
     cf0:	91c50513          	addi	a0,a0,-1764 # 6608 <malloc+0x5e6>
     cf4:	00005097          	auipc	ra,0x5
     cf8:	270080e7          	jalr	624(ra) # 5f64 <printf>
      exit(1);
     cfc:	4505                	li	a0,1
     cfe:	00005097          	auipc	ra,0x5
     d02:	ede080e7          	jalr	-290(ra) # 5bdc <exit>
      printf("%s: read content of block %d is %d\n", s,
     d06:	8626                	mv	a2,s1
     d08:	85d6                	mv	a1,s5
     d0a:	00006517          	auipc	a0,0x6
     d0e:	91650513          	addi	a0,a0,-1770 # 6620 <malloc+0x5fe>
     d12:	00005097          	auipc	ra,0x5
     d16:	252080e7          	jalr	594(ra) # 5f64 <printf>
      exit(1);
     d1a:	4505                	li	a0,1
     d1c:	00005097          	auipc	ra,0x5
     d20:	ec0080e7          	jalr	-320(ra) # 5bdc <exit>
    printf("%s: unlink big failed\n", s);
     d24:	85d6                	mv	a1,s5
     d26:	00006517          	auipc	a0,0x6
     d2a:	92250513          	addi	a0,a0,-1758 # 6648 <malloc+0x626>
     d2e:	00005097          	auipc	ra,0x5
     d32:	236080e7          	jalr	566(ra) # 5f64 <printf>
    exit(1);
     d36:	4505                	li	a0,1
     d38:	00005097          	auipc	ra,0x5
     d3c:	ea4080e7          	jalr	-348(ra) # 5bdc <exit>
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	90c50513          	addi	a0,a0,-1780 # 6660 <malloc+0x63e>
     d5c:	00005097          	auipc	ra,0x5
     d60:	ec0080e7          	jalr	-320(ra) # 5c1c <open>
  if(fd < 0){
  ...
  write(fd, "hello", SZ);
     ...
     d70:	92458593          	addi	a1,a1,-1756 # 6690 <malloc+0x66e>
     d74:	00005097          	auipc	ra,0x5
     d78:	e88080e7          	jalr	-376(ra) # 5bfc <write>
  close(fd);
     d7c:	8526                	mv	a0,s1
     d7e:	00005097          	auipc	ra,0x5
     d82:	e86080e7          	jalr	-378(ra) # 5c04 <close>
  fd = open("unlinkread", O_RDWR);
     d86:	4589                	li	a1,2
     d88:	00006517          	auipc	a0,0x6
     d8c:	8d850513          	addi	a0,a0,-1832 # 6660 <malloc+0x63e>
     d90:	00005097          	auipc	ra,0x5
     d94:	e8c080e7          	jalr	-372(ra) # 5c1c <open>
     d98:	84aa                	mv	s1,a0
  if(fd < 0){
     d9a:	0c054863          	bltz	a0,e6a <unlinkread+0x12a>
  if(unlink("unlinkread") != 0){
     d9e:	00006517          	auipc	a0,0x6
     da2:	8c250513          	addi	a0,a0,-1854 # 6660 <malloc+0x63e>
     da6:	00005097          	auipc	ra,0x5
     daa:	e86080e7          	jalr	-378(ra) # 5c2c <unlink>
     dae:	ed61                	bnez	a0,e86 <unlinkread+0x146>
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     db0:	20200593          	li	a1,514
     db4:	00006517          	auipc	a0,0x6
     db8:	8ac50513          	addi	a0,a0,-1876 # 6660 <malloc+0x63e>
     dbc:	00005097          	auipc	ra,0x5
     dc0:	e60080e7          	jalr	-416(ra) # 5c1c <open>
     dc4:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     dc6:	460d                	li	a2,3
     dc8:	00006597          	auipc	a1,0x6
     dcc:	91058593          	addi	a1,a1,-1776 # 66d8 <malloc+0x6b6>
     dd0:	00005097          	auipc	ra,0x5
     dd4:	e2c080e7          	jalr	-468(ra) # 5bfc <write>
  close(fd1);
     dd8:	854a                	mv	a0,s2
     dda:	00005097          	auipc	ra,0x5
     dde:	e2a080e7          	jalr	-470(ra) # 5c04 <close>
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     df2:	e06080e7          	jalr	-506(ra) # 5bf4 <read>
     df6:	4795                	li	a5,5
  ...
  if(write(fd, buf, 10) != 10){
     ...
     e1c:	de4080e7          	jalr	-540(ra) # 5bfc <write>
     e20:	47a9                	li	a5,10
     e22:	0af51c63          	bne	a0,a5,eda <unlinkread+0x19a>
  close(fd);
     e26:	8526                	mv	a0,s1
     e28:	00005097          	auipc	ra,0x5
     e2c:	ddc080e7          	jalr	-548(ra) # 5c04 <close>
  unlink("unlinkread");
     e30:	00006517          	auipc	a0,0x6
     e34:	83050513          	addi	a0,a0,-2000 # 6660 <malloc+0x63e>
     e38:	00005097          	auipc	ra,0x5
     e3c:	df4080e7          	jalr	-524(ra) # 5c2c <unlink>
}
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	82050513          	addi	a0,a0,-2016 # 6670 <malloc+0x64e>
     e58:	00005097          	auipc	ra,0x5
     e5c:	10c080e7          	jalr	268(ra) # 5f64 <printf>
    exit(1);
     e60:	4505                	li	a0,1
     e62:	00005097          	auipc	ra,0x5
     e66:	d7a080e7          	jalr	-646(ra) # 5bdc <exit>
    printf("%s: open unlinkread failed\n", s);
     e6a:	85ce                	mv	a1,s3
     e6c:	00006517          	auipc	a0,0x6
     e70:	82c50513          	addi	a0,a0,-2004 # 6698 <malloc+0x676>
     e74:	00005097          	auipc	ra,0x5
     e78:	0f0080e7          	jalr	240(ra) # 5f64 <printf>
    exit(1);
     e7c:	4505                	li	a0,1
     e7e:	00005097          	auipc	ra,0x5
     e82:	d5e080e7          	jalr	-674(ra) # 5bdc <exit>
    printf("%s: unlink unlinkread failed\n", s);
     e86:	85ce                	mv	a1,s3
     e88:	00006517          	auipc	a0,0x6
     e8c:	83050513          	addi	a0,a0,-2000 # 66b8 <malloc+0x696>
     e90:	00005097          	auipc	ra,0x5
     e94:	0d4080e7          	jalr	212(ra) # 5f64 <printf>
    exit(1);
     e98:	4505                	li	a0,1
     e9a:	00005097          	auipc	ra,0x5
     e9e:	d42080e7          	jalr	-702(ra) # 5bdc <exit>
    printf("%s: unlinkread read failed", s);
     ea2:	85ce                	mv	a1,s3
     ea4:	00006517          	auipc	a0,0x6
     ea8:	83c50513          	addi	a0,a0,-1988 # 66e0 <malloc+0x6be>
     eac:	00005097          	auipc	ra,0x5
     eb0:	0b8080e7          	jalr	184(ra) # 5f64 <printf>
    exit(1);
     eb4:	4505                	li	a0,1
     eb6:	00005097          	auipc	ra,0x5
     eba:	d26080e7          	jalr	-730(ra) # 5bdc <exit>
    printf("%s: unlinkread wrong data\n", s);
     ebe:	85ce                	mv	a1,s3
     ec0:	00006517          	auipc	a0,0x6
     ec4:	84050513          	addi	a0,a0,-1984 # 6700 <malloc+0x6de>
     ec8:	00005097          	auipc	ra,0x5
     ecc:	09c080e7          	jalr	156(ra) # 5f64 <printf>
    exit(1);
     ed0:	4505                	li	a0,1
     ed2:	00005097          	auipc	ra,0x5
     ed6:	d0a080e7          	jalr	-758(ra) # 5bdc <exit>
    printf("%s: unlinkread write failed\n", s);
     eda:	85ce                	mv	a1,s3
     edc:	00006517          	auipc	a0,0x6
     ee0:	84450513          	addi	a0,a0,-1980 # 6720 <malloc+0x6fe>
     ee4:	00005097          	auipc	ra,0x5
     ee8:	080080e7          	jalr	128(ra) # 5f64 <printf>
    exit(1);
     eec:	4505                	li	a0,1
     eee:	00005097          	auipc	ra,0x5
     ef2:	cee080e7          	jalr	-786(ra) # 5bdc <exit>
...
0000000000000ef6 <linktest>:
{
  ...
  unlink("lf1");
     ...
     f08:	83c50513          	addi	a0,a0,-1988 # 6740 <malloc+0x71e>
     f0c:	00005097          	auipc	ra,0x5
     f10:	d20080e7          	jalr	-736(ra) # 5c2c <unlink>
  unlink("lf2");
     f14:	00006517          	auipc	a0,0x6
     f18:	83450513          	addi	a0,a0,-1996 # 6748 <malloc+0x726>
     f1c:	00005097          	auipc	ra,0x5
     f20:	d10080e7          	jalr	-752(ra) # 5c2c <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     f24:	20200593          	li	a1,514
     f28:	00006517          	auipc	a0,0x6
     f2c:	81850513          	addi	a0,a0,-2024 # 6740 <malloc+0x71e>
     f30:	00005097          	auipc	ra,0x5
     f34:	cec080e7          	jalr	-788(ra) # 5c1c <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	75058593          	addi	a1,a1,1872 # 6690 <malloc+0x66e>
     f48:	00005097          	auipc	ra,0x5
     f4c:	cb4080e7          	jalr	-844(ra) # 5bfc <write>
     f50:	4795                	li	a5,5
     f52:	10f51863          	bne	a0,a5,1062 <linktest+0x16c>
  close(fd);
     f56:	8526                	mv	a0,s1
     f58:	00005097          	auipc	ra,0x5
     f5c:	cac080e7          	jalr	-852(ra) # 5c04 <close>
  if(link("lf1", "lf2") < 0){
     f60:	00005597          	auipc	a1,0x5
     f64:	7e858593          	addi	a1,a1,2024 # 6748 <malloc+0x726>
     f68:	00005517          	auipc	a0,0x5
     f6c:	7d850513          	addi	a0,a0,2008 # 6740 <malloc+0x71e>
     f70:	00005097          	auipc	ra,0x5
     f74:	ccc080e7          	jalr	-820(ra) # 5c3c <link>
     f78:	10054363          	bltz	a0,107e <linktest+0x188>
  unlink("lf1");
     f7c:	00005517          	auipc	a0,0x5
     f80:	7c450513          	addi	a0,a0,1988 # 6740 <malloc+0x71e>
     f84:	00005097          	auipc	ra,0x5
     f88:	ca8080e7          	jalr	-856(ra) # 5c2c <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00005517          	auipc	a0,0x5
     f92:	7b250513          	addi	a0,a0,1970 # 6740 <malloc+0x71e>
     f96:	00005097          	auipc	ra,0x5
     f9a:	c86080e7          	jalr	-890(ra) # 5c1c <open>
     f9e:	0e055e63          	bgez	a0,109a <linktest+0x1a4>
  fd = open("lf2", 0);
     fa2:	4581                	li	a1,0
     fa4:	00005517          	auipc	a0,0x5
     fa8:	7a450513          	addi	a0,a0,1956 # 6748 <malloc+0x726>
     fac:	00005097          	auipc	ra,0x5
     fb0:	c70080e7          	jalr	-912(ra) # 5c1c <open>
     fb4:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     fc8:	c30080e7          	jalr	-976(ra) # 5bf4 <read>
     fcc:	4795                	li	a5,5
     fce:	10f51263          	bne	a0,a5,10d2 <linktest+0x1dc>
  close(fd);
     fd2:	8526                	mv	a0,s1
     fd4:	00005097          	auipc	ra,0x5
     fd8:	c30080e7          	jalr	-976(ra) # 5c04 <close>
  if(link("lf2", "lf2") >= 0){
     fdc:	00005597          	auipc	a1,0x5
     fe0:	76c58593          	addi	a1,a1,1900 # 6748 <malloc+0x726>
     fe4:	852e                	mv	a0,a1
     fe6:	00005097          	auipc	ra,0x5
     fea:	c56080e7          	jalr	-938(ra) # 5c3c <link>
     fee:	10055063          	bgez	a0,10ee <linktest+0x1f8>
  unlink("lf2");
     ff2:	00005517          	auipc	a0,0x5
     ff6:	75650513          	addi	a0,a0,1878 # 6748 <malloc+0x726>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c32080e7          	jalr	-974(ra) # 5c2c <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00005597          	auipc	a1,0x5
    1006:	73e58593          	addi	a1,a1,1854 # 6740 <malloc+0x71e>
    100a:	00005517          	auipc	a0,0x5
    100e:	73e50513          	addi	a0,a0,1854 # 6748 <malloc+0x726>
    1012:	00005097          	auipc	ra,0x5
    1016:	c2a080e7          	jalr	-982(ra) # 5c3c <link>
    101a:	0e055863          	bgez	a0,110a <linktest+0x214>
  if(link(".", "lf1") >= 0){
    101e:	00005597          	auipc	a1,0x5
    1022:	72258593          	addi	a1,a1,1826 # 6740 <malloc+0x71e>
    1026:	00006517          	auipc	a0,0x6
    102a:	82a50513          	addi	a0,a0,-2006 # 6850 <malloc+0x82e>
    102e:	00005097          	auipc	ra,0x5
    1032:	c0e080e7          	jalr	-1010(ra) # 5c3c <link>
    ...
    104c:	70850513          	addi	a0,a0,1800 # 6750 <malloc+0x72e>
    1050:	00005097          	auipc	ra,0x5
    1054:	f14080e7          	jalr	-236(ra) # 5f64 <printf>
    exit(1);
    1058:	4505                	li	a0,1
    105a:	00005097          	auipc	ra,0x5
    105e:	b82080e7          	jalr	-1150(ra) # 5bdc <exit>
    printf("%s: write lf1 failed\n", s);
    1062:	85ca                	mv	a1,s2
    1064:	00005517          	auipc	a0,0x5
    1068:	70450513          	addi	a0,a0,1796 # 6768 <malloc+0x746>
    106c:	00005097          	auipc	ra,0x5
    1070:	ef8080e7          	jalr	-264(ra) # 5f64 <printf>
    exit(1);
    1074:	4505                	li	a0,1
    1076:	00005097          	auipc	ra,0x5
    107a:	b66080e7          	jalr	-1178(ra) # 5bdc <exit>
    printf("%s: link lf1 lf2 failed\n", s);
    107e:	85ca                	mv	a1,s2
    1080:	00005517          	auipc	a0,0x5
    1084:	70050513          	addi	a0,a0,1792 # 6780 <malloc+0x75e>
    1088:	00005097          	auipc	ra,0x5
    108c:	edc080e7          	jalr	-292(ra) # 5f64 <printf>
    exit(1);
    1090:	4505                	li	a0,1
    1092:	00005097          	auipc	ra,0x5
    1096:	b4a080e7          	jalr	-1206(ra) # 5bdc <exit>
    printf("%s: unlinked lf1 but it is still there!\n", s);
    109a:	85ca                	mv	a1,s2
    109c:	00005517          	auipc	a0,0x5
    10a0:	70450513          	addi	a0,a0,1796 # 67a0 <malloc+0x77e>
    10a4:	00005097          	auipc	ra,0x5
    10a8:	ec0080e7          	jalr	-320(ra) # 5f64 <printf>
    exit(1);
    10ac:	4505                	li	a0,1
    10ae:	00005097          	auipc	ra,0x5
    10b2:	b2e080e7          	jalr	-1234(ra) # 5bdc <exit>
    printf("%s: open lf2 failed\n", s);
    10b6:	85ca                	mv	a1,s2
    10b8:	00005517          	auipc	a0,0x5
    10bc:	71850513          	addi	a0,a0,1816 # 67d0 <malloc+0x7ae>
    10c0:	00005097          	auipc	ra,0x5
    10c4:	ea4080e7          	jalr	-348(ra) # 5f64 <printf>
    exit(1);
    10c8:	4505                	li	a0,1
    10ca:	00005097          	auipc	ra,0x5
    10ce:	b12080e7          	jalr	-1262(ra) # 5bdc <exit>
    printf("%s: read lf2 failed\n", s);
    10d2:	85ca                	mv	a1,s2
    10d4:	00005517          	auipc	a0,0x5
    10d8:	71450513          	addi	a0,a0,1812 # 67e8 <malloc+0x7c6>
    10dc:	00005097          	auipc	ra,0x5
    10e0:	e88080e7          	jalr	-376(ra) # 5f64 <printf>
    exit(1);
    10e4:	4505                	li	a0,1
    10e6:	00005097          	auipc	ra,0x5
    10ea:	af6080e7          	jalr	-1290(ra) # 5bdc <exit>
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
    10ee:	85ca                	mv	a1,s2
    10f0:	00005517          	auipc	a0,0x5
    10f4:	71050513          	addi	a0,a0,1808 # 6800 <malloc+0x7de>
    10f8:	00005097          	auipc	ra,0x5
    10fc:	e6c080e7          	jalr	-404(ra) # 5f64 <printf>
    exit(1);
    1100:	4505                	li	a0,1
    1102:	00005097          	auipc	ra,0x5
    1106:	ada080e7          	jalr	-1318(ra) # 5bdc <exit>
    printf("%s: link non-existent succeeded! oops\n", s);
    110a:	85ca                	mv	a1,s2
    110c:	00005517          	auipc	a0,0x5
    1110:	71c50513          	addi	a0,a0,1820 # 6828 <malloc+0x806>
    1114:	00005097          	auipc	ra,0x5
    1118:	e50080e7          	jalr	-432(ra) # 5f64 <printf>
    exit(1);
    111c:	4505                	li	a0,1
    111e:	00005097          	auipc	ra,0x5
    1122:	abe080e7          	jalr	-1346(ra) # 5bdc <exit>
    printf("%s: link . lf1 succeeded! oops\n", s);
    1126:	85ca                	mv	a1,s2
    1128:	00005517          	auipc	a0,0x5
    112c:	73050513          	addi	a0,a0,1840 # 6858 <malloc+0x836>
    1130:	00005097          	auipc	ra,0x5
    1134:	e34080e7          	jalr	-460(ra) # 5f64 <printf>
    exit(1);
    1138:	4505                	li	a0,1
    113a:	00005097          	auipc	ra,0x5
    113e:	aa2080e7          	jalr	-1374(ra) # 5bdc <exit>
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	71e98993          	addi	s3,s3,1822 # 6878 <malloc+0x856>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1172:	ace080e7          	jalr	-1330(ra) # 5c3c <link>
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	6f250513          	addi	a0,a0,1778 # 6888 <malloc+0x866>
    119e:	00005097          	auipc	ra,0x5
    11a2:	dc6080e7          	jalr	-570(ra) # 5f64 <printf>
      exit(1);
    11a6:	4505                	li	a0,1
    11a8:	00005097          	auipc	ra,0x5
    11ac:	a34080e7          	jalr	-1484(ra) # 5bdc <exit>
...
00000000000011b0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    11ca:	6e250513          	addi	a0,a0,1762 # 68a8 <malloc+0x886>
    11ce:	00005097          	auipc	ra,0x5
    11d2:	a5e080e7          	jalr	-1442(ra) # 5c2c <unlink>
  fd = open("bd", O_CREATE);
    11d6:	20000593          	li	a1,512
    11da:	00005517          	auipc	a0,0x5
    11de:	6ce50513          	addi	a0,a0,1742 # 68a8 <malloc+0x886>
    11e2:	00005097          	auipc	ra,0x5
    11e6:	a3a080e7          	jalr	-1478(ra) # 5c1c <open>
  if(fd < 0){
    11ea:	0c054963          	bltz	a0,12bc <bigdir+0x10c>
  close(fd);
    11ee:	00005097          	auipc	ra,0x5
    11f2:	a16080e7          	jalr	-1514(ra) # 5c04 <close>
  for(i = 0; i < N; i++){
    11f6:	4901                	li	s2,0
    name[0] = 'x';
    ...
    1200:	6aca0a13          	addi	s4,s4,1708 # 68a8 <malloc+0x886>
  for(i = 0; i < N; i++){
    ...
    1240:	a00080e7          	jalr	-1536(ra) # 5c3c <link>
    1244:	84aa                	mv	s1,a0
  ...
  unlink("bd");
    ...
    1252:	65a50513          	addi	a0,a0,1626 # 68a8 <malloc+0x886>
    1256:	00005097          	auipc	ra,0x5
    125a:	9d6080e7          	jalr	-1578(ra) # 5c2c <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    129c:	994080e7          	jalr	-1644(ra) # 5c2c <unlink>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	5f250513          	addi	a0,a0,1522 # 68b0 <malloc+0x88e>
    12c6:	00005097          	auipc	ra,0x5
    12ca:	c9e080e7          	jalr	-866(ra) # 5f64 <printf>
    exit(1);
    12ce:	4505                	li	a0,1
    12d0:	00005097          	auipc	ra,0x5
    12d4:	90c080e7          	jalr	-1780(ra) # 5bdc <exit>
      printf("%s: bigdir link(bd, %s) failed\n", s, name);
    12d8:	fb040613          	addi	a2,s0,-80
    12dc:	85ce                	mv	a1,s3
    12de:	00005517          	auipc	a0,0x5
    12e2:	5f250513          	addi	a0,a0,1522 # 68d0 <malloc+0x8ae>
    12e6:	00005097          	auipc	ra,0x5
    12ea:	c7e080e7          	jalr	-898(ra) # 5f64 <printf>
      exit(1);
    12ee:	4505                	li	a0,1
    12f0:	00005097          	auipc	ra,0x5
    12f4:	8ec080e7          	jalr	-1812(ra) # 5bdc <exit>
      printf("%s: bigdir unlink failed", s);
    12f8:	85ce                	mv	a1,s3
    12fa:	00005517          	auipc	a0,0x5
    12fe:	5f650513          	addi	a0,a0,1526 # 68f0 <malloc+0x8ce>
    1302:	00005097          	auipc	ra,0x5
    1306:	c62080e7          	jalr	-926(ra) # 5f64 <printf>
      exit(1);
    130a:	4505                	li	a0,1
    130c:	00005097          	auipc	ra,0x5
    1310:	8d0080e7          	jalr	-1840(ra) # 5bdc <exit>
...
0000000000001314 <pgbug>:
{
  ...
  exec(big, argv);
    ...
    1334:	8e4080e7          	jalr	-1820(ra) # 5c14 <exec>
  pipe(big);
    1338:	6088                	ld	a0,0(s1)
    133a:	00005097          	auipc	ra,0x5
    133e:	8b2080e7          	jalr	-1870(ra) # 5bec <pipe>
  exit(0);
    1342:	4501                	li	a0,0
    1344:	00005097          	auipc	ra,0x5
    1348:	898080e7          	jalr	-1896(ra) # 5bdc <exit>
...
000000000000134c <badarg>:
{
    ...
    136a:	e0298993          	addi	s3,s3,-510 # 6168 <malloc+0x146>
    argv[0] = (char*)0xffffffff;
    ...
    1380:	898080e7          	jalr	-1896(ra) # 5c14 <exec>
  ...
  exit(0);
    ...
    138e:	852080e7          	jalr	-1966(ra) # 5bdc <exit>
...
0000000000001392 <copyinstr2>:
{
  ...
  int ret = unlink(b);
    ...
    13bc:	874080e7          	jalr	-1932(ra) # 5c2c <unlink>
  if(ret != -1){
    13c0:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    13d2:	84e080e7          	jalr	-1970(ra) # 5c1c <open>
  if(fd != -1){
    13d6:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    13e6:	85a080e7          	jalr	-1958(ra) # 5c3c <link>
  if(ret != -1){
    13ea:	57fd                	li	a5,-1
    13ec:	0ef51b63          	bne	a0,a5,14e2 <copyinstr2+0x150>
  char *args[] = { "xx", 0 };
    13f0:	00006797          	auipc	a5,0x6
    13f4:	75878793          	addi	a5,a5,1880 # 7b48 <malloc+0x1b26>
  ...
  ret = exec(b, args);
    ...
    140c:	80c080e7          	jalr	-2036(ra) # 5c14 <exec>
  if(ret != -1){
    1410:	57fd                	li	a5,-1
    1412:	0ef51963          	bne	a0,a5,1504 <copyinstr2+0x172>
  int pid = fork();
    1416:	00004097          	auipc	ra,0x4
    141a:	7be080e7          	jalr	1982(ra) # 5bd4 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    1450:	11c78793          	addi	a5,a5,284 # 8568 <malloc+0x2546>
    ...
    1474:	cf850513          	addi	a0,a0,-776 # 6168 <malloc+0x146>
    1478:	00004097          	auipc	ra,0x4
    147c:	79c080e7          	jalr	1948(ra) # 5c14 <exec>
    if(ret != -1){
    1480:	57fd                	li	a5,-1
    ...
    148c:	51050513          	addi	a0,a0,1296 # 6998 <malloc+0x976>
    1490:	00005097          	auipc	ra,0x5
    1494:	ad4080e7          	jalr	-1324(ra) # 5f64 <printf>
      exit(1);
    1498:	4505                	li	a0,1
    149a:	00004097          	auipc	ra,0x4
    149e:	742080e7          	jalr	1858(ra) # 5bdc <exit>
    printf("unlink(%s) returned %d, not -1\n", b, ret);
    14a2:	862a                	mv	a2,a0
    14a4:	f6840593          	addi	a1,s0,-152
    14a8:	00005517          	auipc	a0,0x5
    14ac:	46850513          	addi	a0,a0,1128 # 6910 <malloc+0x8ee>
    14b0:	00005097          	auipc	ra,0x5
    14b4:	ab4080e7          	jalr	-1356(ra) # 5f64 <printf>
    exit(1);
    14b8:	4505                	li	a0,1
    14ba:	00004097          	auipc	ra,0x4
    14be:	722080e7          	jalr	1826(ra) # 5bdc <exit>
    printf("open(%s) returned %d, not -1\n", b, fd);
    14c2:	862a                	mv	a2,a0
    14c4:	f6840593          	addi	a1,s0,-152
    14c8:	00005517          	auipc	a0,0x5
    14cc:	46850513          	addi	a0,a0,1128 # 6930 <malloc+0x90e>
    14d0:	00005097          	auipc	ra,0x5
    14d4:	a94080e7          	jalr	-1388(ra) # 5f64 <printf>
    exit(1);
    14d8:	4505                	li	a0,1
    14da:	00004097          	auipc	ra,0x4
    14de:	702080e7          	jalr	1794(ra) # 5bdc <exit>
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
    14e2:	86aa                	mv	a3,a0
    14e4:	f6840613          	addi	a2,s0,-152
    14e8:	85b2                	mv	a1,a2
    14ea:	00005517          	auipc	a0,0x5
    14ee:	46650513          	addi	a0,a0,1126 # 6950 <malloc+0x92e>
    14f2:	00005097          	auipc	ra,0x5
    14f6:	a72080e7          	jalr	-1422(ra) # 5f64 <printf>
    exit(1);
    14fa:	4505                	li	a0,1
    14fc:	00004097          	auipc	ra,0x4
    1500:	6e0080e7          	jalr	1760(ra) # 5bdc <exit>
    printf("exec(%s) returned %d, not -1\n", b, fd);
    1504:	567d                	li	a2,-1
    1506:	f6840593          	addi	a1,s0,-152
    150a:	00005517          	auipc	a0,0x5
    150e:	46e50513          	addi	a0,a0,1134 # 6978 <malloc+0x956>
    1512:	00005097          	auipc	ra,0x5
    1516:	a52080e7          	jalr	-1454(ra) # 5f64 <printf>
    exit(1);
    151a:	4505                	li	a0,1
    151c:	00004097          	auipc	ra,0x4
    1520:	6c0080e7          	jalr	1728(ra) # 5bdc <exit>
    printf("fork failed\n");
    1524:	00006517          	auipc	a0,0x6
    1528:	8d450513          	addi	a0,a0,-1836 # 6df8 <malloc+0xdd6>
    152c:	00005097          	auipc	ra,0x5
    1530:	a38080e7          	jalr	-1480(ra) # 5f64 <printf>
    exit(1);
    1534:	4505                	li	a0,1
    1536:	00004097          	auipc	ra,0x4
    153a:	6a6080e7          	jalr	1702(ra) # 5bdc <exit>
    exit(747); // OK
    153e:	2eb00513          	li	a0,747
    1542:	00004097          	auipc	ra,0x4
    1546:	69a080e7          	jalr	1690(ra) # 5bdc <exit>
  int st = 0;
    154a:	f4042a23          	sw	zero,-172(s0)
  wait(&st);
    154e:	f5440513          	addi	a0,s0,-172
    1552:	00004097          	auipc	ra,0x4
    1556:	692080e7          	jalr	1682(ra) # 5be4 <wait>
  if(st != 747){
    ...
    1572:	45250513          	addi	a0,a0,1106 # 69c0 <malloc+0x99e>
    1576:	00005097          	auipc	ra,0x5
    157a:	9ee080e7          	jalr	-1554(ra) # 5f64 <printf>
    exit(1);
    157e:	4505                	li	a0,1
    1580:	00004097          	auipc	ra,0x4
    1584:	65c080e7          	jalr	1628(ra) # 5bdc <exit>
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a4:	c2050513          	addi	a0,a0,-992 # 61c0 <malloc+0x19e>
    15a8:	00004097          	auipc	ra,0x4
    15ac:	674080e7          	jalr	1652(ra) # 5c1c <open>
    15b0:	00004097          	auipc	ra,0x4
    15b4:	654080e7          	jalr	1620(ra) # 5c04 <close>
  pid = fork();
    15b8:	00004097          	auipc	ra,0x4
    15bc:	61c080e7          	jalr	1564(ra) # 5bd4 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    15ce:	bf6a0a13          	addi	s4,s4,-1034 # 61c0 <malloc+0x19e>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	44ea8a93          	addi	s5,s5,1102 # 6a20 <malloc+0x9fe>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    15de:	00004097          	auipc	ra,0x4
    15e2:	63e080e7          	jalr	1598(ra) # 5c1c <open>
    15e6:	84aa                	mv	s1,a0
      if(fd < 0){
    ...
    15f4:	60c080e7          	jalr	1548(ra) # 5bfc <write>
      if(n != 10){
    15f8:	47a9                	li	a5,10
    ...
    1604:	604080e7          	jalr	1540(ra) # 5c04 <close>
      fd = open("truncfile", O_RDONLY);
    1608:	4581                	li	a1,0
    160a:	8552                	mv	a0,s4
    160c:	00004097          	auipc	ra,0x4
    1610:	610080e7          	jalr	1552(ra) # 5c1c <open>
    1614:	84aa                	mv	s1,a0
      read(fd, buf, sizeof(buf));
    1616:	02000613          	li	a2,32
    161a:	f9840593          	addi	a1,s0,-104
    161e:	00004097          	auipc	ra,0x4
    1622:	5d6080e7          	jalr	1494(ra) # 5bf4 <read>
      close(fd);
    1626:	8526                	mv	a0,s1
    1628:	00004097          	auipc	ra,0x4
    162c:	5dc080e7          	jalr	1500(ra) # 5c04 <close>
    for(int i = 0; i < 100; i++){
    ...
    163c:	5a4080e7          	jalr	1444(ra) # 5bdc <exit>
    printf("%s: fork failed\n", s);
    1640:	85ca                	mv	a1,s2
    1642:	00005517          	auipc	a0,0x5
    1646:	3ae50513          	addi	a0,a0,942 # 69f0 <malloc+0x9ce>
    164a:	00005097          	auipc	ra,0x5
    164e:	91a080e7          	jalr	-1766(ra) # 5f64 <printf>
    exit(1);
    1652:	4505                	li	a0,1
    1654:	00004097          	auipc	ra,0x4
    1658:	588080e7          	jalr	1416(ra) # 5bdc <exit>
        printf("%s: open failed\n", s);
    165c:	85ca                	mv	a1,s2
    165e:	00005517          	auipc	a0,0x5
    1662:	3aa50513          	addi	a0,a0,938 # 6a08 <malloc+0x9e6>
    1666:	00005097          	auipc	ra,0x5
    166a:	8fe080e7          	jalr	-1794(ra) # 5f64 <printf>
        exit(1);
    166e:	4505                	li	a0,1
    1670:	00004097          	auipc	ra,0x4
    1674:	56c080e7          	jalr	1388(ra) # 5bdc <exit>
        printf("%s: write got %d, expected 10\n", s, n);
    1678:	862a                	mv	a2,a0
    167a:	85ca                	mv	a1,s2
    167c:	00005517          	auipc	a0,0x5
    1680:	3b450513          	addi	a0,a0,948 # 6a30 <malloc+0xa0e>
    1684:	00005097          	auipc	ra,0x5
    1688:	8e0080e7          	jalr	-1824(ra) # 5f64 <printf>
        exit(1);
    168c:	4505                	li	a0,1
    168e:	00004097          	auipc	ra,0x4
    1692:	54e080e7          	jalr	1358(ra) # 5bdc <exit>
    1696:	09600993          	li	s3,150
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    169a:	00005a17          	auipc	s4,0x5
    169e:	b26a0a13          	addi	s4,s4,-1242 # 61c0 <malloc+0x19e>
    int n = write(fd, "xxx", 3);
    16a2:	00005a97          	auipc	s5,0x5
    16a6:	3aea8a93          	addi	s5,s5,942 # 6a50 <malloc+0xa2e>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
    16aa:	60100593          	li	a1,1537
    16ae:	8552                	mv	a0,s4
    16b0:	00004097          	auipc	ra,0x4
    16b4:	56c080e7          	jalr	1388(ra) # 5c1c <open>
    16b8:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    16c6:	53a080e7          	jalr	1338(ra) # 5bfc <write>
    if(n != 3){
    16ca:	478d                	li	a5,3
    ...
    16d6:	532080e7          	jalr	1330(ra) # 5c04 <close>
  for(int i = 0; i < 150; i++){
  ...
  wait(&xstatus);
    ...
    16e8:	500080e7          	jalr	1280(ra) # 5be4 <wait>
  unlink("truncfile");
    16ec:	00005517          	auipc	a0,0x5
    16f0:	ad450513          	addi	a0,a0,-1324 # 61c0 <malloc+0x19e>
    16f4:	00004097          	auipc	ra,0x4
    16f8:	538080e7          	jalr	1336(ra) # 5c2c <unlink>
  exit(xstatus);
    16fc:	fbc42503          	lw	a0,-68(s0)
    1700:	00004097          	auipc	ra,0x4
    1704:	4dc080e7          	jalr	1244(ra) # 5bdc <exit>
      printf("%s: open failed\n", s);
    1708:	85ca                	mv	a1,s2
    170a:	00005517          	auipc	a0,0x5
    170e:	2fe50513          	addi	a0,a0,766 # 6a08 <malloc+0x9e6>
    1712:	00005097          	auipc	ra,0x5
    1716:	852080e7          	jalr	-1966(ra) # 5f64 <printf>
      exit(1);
    171a:	4505                	li	a0,1
    171c:	00004097          	auipc	ra,0x4
    1720:	4c0080e7          	jalr	1216(ra) # 5bdc <exit>
      printf("%s: write got %d, expected 3\n", s, n);
    1724:	862a                	mv	a2,a0
    1726:	85ca                	mv	a1,s2
    1728:	00005517          	auipc	a0,0x5
    172c:	33050513          	addi	a0,a0,816 # 6a58 <malloc+0xa36>
    1730:	00005097          	auipc	ra,0x5
    1734:	834080e7          	jalr	-1996(ra) # 5f64 <printf>
      exit(1);
    1738:	4505                	li	a0,1
    173a:	00004097          	auipc	ra,0x4
    173e:	4a2080e7          	jalr	1186(ra) # 5bdc <exit>
...
0000000000001742 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1754:	a1878793          	addi	a5,a5,-1512 # 6168 <malloc+0x146>
    1758:	fcf43023          	sd	a5,-64(s0)
    175c:	00005797          	auipc	a5,0x5
    1760:	31c78793          	addi	a5,a5,796 # 6a78 <malloc+0xa56>
    1764:	fcf43423          	sd	a5,-56(s0)
    1768:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176c:	00005517          	auipc	a0,0x5
    1770:	31450513          	addi	a0,a0,788 # 6a80 <malloc+0xa5e>
    1774:	00004097          	auipc	ra,0x4
    1778:	4b8080e7          	jalr	1208(ra) # 5c2c <unlink>
  pid = fork();
    177c:	00004097          	auipc	ra,0x4
    1780:	458080e7          	jalr	1112(ra) # 5bd4 <fork>
  if(pid < 0) {
  ...
  if(pid == 0) {
    ...
    1792:	476080e7          	jalr	1142(ra) # 5c04 <close>
    fd = open("echo-ok", O_CREATE|O_WRONLY);
    1796:	20100593          	li	a1,513
    179a:	00005517          	auipc	a0,0x5
    179e:	2e650513          	addi	a0,a0,742 # 6a80 <malloc+0xa5e>
    17a2:	00004097          	auipc	ra,0x4
    17a6:	47a080e7          	jalr	1146(ra) # 5c1c <open>
    if(fd < 0) {
    ...
    17ba:	2ea50513          	addi	a0,a0,746 # 6aa0 <malloc+0xa7e>
    17be:	00004097          	auipc	ra,0x4
    17c2:	7a6080e7          	jalr	1958(ra) # 5f64 <printf>
      exit(1);
    17c6:	4505                	li	a0,1
    17c8:	00004097          	auipc	ra,0x4
    17cc:	414080e7          	jalr	1044(ra) # 5bdc <exit>
     printf("%s: fork failed\n", s);
    17d0:	85ca                	mv	a1,s2
    17d2:	00005517          	auipc	a0,0x5
    17d6:	21e50513          	addi	a0,a0,542 # 69f0 <malloc+0x9ce>
    17da:	00004097          	auipc	ra,0x4
    17de:	78a080e7          	jalr	1930(ra) # 5f64 <printf>
     exit(1);
    17e2:	4505                	li	a0,1
    17e4:	00004097          	auipc	ra,0x4
    17e8:	3f8080e7          	jalr	1016(ra) # 5bdc <exit>
      printf("%s: create failed\n", s);
    17ec:	85ca                	mv	a1,s2
    17ee:	00005517          	auipc	a0,0x5
    17f2:	29a50513          	addi	a0,a0,666 # 6a88 <malloc+0xa66>
    17f6:	00004097          	auipc	ra,0x4
    17fa:	76e080e7          	jalr	1902(ra) # 5f64 <printf>
      exit(1);
    17fe:	4505                	li	a0,1
    1800:	00004097          	auipc	ra,0x4
    1804:	3dc080e7          	jalr	988(ra) # 5bdc <exit>
    if(exec("echo", echoargv) < 0){
    1808:	fc040593          	addi	a1,s0,-64
    180c:	00005517          	auipc	a0,0x5
    1810:	95c50513          	addi	a0,a0,-1700 # 6168 <malloc+0x146>
    1814:	00004097          	auipc	ra,0x4
    1818:	400080e7          	jalr	1024(ra) # 5c14 <exec>
    181c:	02054163          	bltz	a0,183e <exectest+0xfc>
  if (wait(&xstatus) != pid) {
    1820:	fdc40513          	addi	a0,s0,-36
    1824:	00004097          	auipc	ra,0x4
    1828:	3c0080e7          	jalr	960(ra) # 5be4 <wait>
  ...
  if(xstatus != 0)
    ...
    183a:	3a6080e7          	jalr	934(ra) # 5bdc <exit>
      printf("%s: exec echo failed\n", s);
    183e:	85ca                	mv	a1,s2
    1840:	00005517          	auipc	a0,0x5
    1844:	27050513          	addi	a0,a0,624 # 6ab0 <malloc+0xa8e>
    1848:	00004097          	auipc	ra,0x4
    184c:	71c080e7          	jalr	1820(ra) # 5f64 <printf>
      exit(1);
    1850:	4505                	li	a0,1
    1852:	00004097          	auipc	ra,0x4
    1856:	38a080e7          	jalr	906(ra) # 5bdc <exit>
    printf("%s: wait failed!\n", s);
    185a:	85ca                	mv	a1,s2
    185c:	00005517          	auipc	a0,0x5
    1860:	26c50513          	addi	a0,a0,620 # 6ac8 <malloc+0xaa6>
    1864:	00004097          	auipc	ra,0x4
    1868:	700080e7          	jalr	1792(ra) # 5f64 <printf>
    186c:	b7d1                	j	1830 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    186e:	4581                	li	a1,0
    1870:	00005517          	auipc	a0,0x5
    1874:	21050513          	addi	a0,a0,528 # 6a80 <malloc+0xa5e>
    1878:	00004097          	auipc	ra,0x4
    187c:	3a4080e7          	jalr	932(ra) # 5c1c <open>
  if(fd < 0) {
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    188e:	36a080e7          	jalr	874(ra) # 5bf4 <read>
    1892:	4789                	li	a5,2
    1894:	02f50e63          	beq	a0,a5,18d0 <exectest+0x18e>
    printf("%s: read failed\n", s);
    1898:	85ca                	mv	a1,s2
    189a:	00005517          	auipc	a0,0x5
    189e:	c9e50513          	addi	a0,a0,-866 # 6538 <malloc+0x516>
    18a2:	00004097          	auipc	ra,0x4
    18a6:	6c2080e7          	jalr	1730(ra) # 5f64 <printf>
    exit(1);
    18aa:	4505                	li	a0,1
    18ac:	00004097          	auipc	ra,0x4
    18b0:	330080e7          	jalr	816(ra) # 5bdc <exit>
    printf("%s: open failed\n", s);
    18b4:	85ca                	mv	a1,s2
    18b6:	00005517          	auipc	a0,0x5
    18ba:	15250513          	addi	a0,a0,338 # 6a08 <malloc+0x9e6>
    18be:	00004097          	auipc	ra,0x4
    18c2:	6a6080e7          	jalr	1702(ra) # 5f64 <printf>
    exit(1);
    18c6:	4505                	li	a0,1
    18c8:	00004097          	auipc	ra,0x4
    18cc:	314080e7          	jalr	788(ra) # 5bdc <exit>
  unlink("echo-ok");
    18d0:	00005517          	auipc	a0,0x5
    18d4:	1b050513          	addi	a0,a0,432 # 6a80 <malloc+0xa5e>
    18d8:	00004097          	auipc	ra,0x4
    18dc:	354080e7          	jalr	852(ra) # 5c2c <unlink>
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fe:	1e650513          	addi	a0,a0,486 # 6ae0 <malloc+0xabe>
    1902:	00004097          	auipc	ra,0x4
    1906:	662080e7          	jalr	1634(ra) # 5f64 <printf>
    exit(1);
    190a:	4505                	li	a0,1
    190c:	00004097          	auipc	ra,0x4
    1910:	2d0080e7          	jalr	720(ra) # 5bdc <exit>
    exit(0);
    1914:	4501                	li	a0,0
    1916:	00004097          	auipc	ra,0x4
    191a:	2c6080e7          	jalr	710(ra) # 5bdc <exit>
...
000000000000191e <pipe1>:
{
  ...
  if(pipe(fds) != 0){
    ...
    193e:	2b2080e7          	jalr	690(ra) # 5bec <pipe>
    1942:	ed25                	bnez	a0,19ba <pipe1+0x9c>
    1944:	84aa                	mv	s1,a0
  pid = fork();
    1946:	00004097          	auipc	ra,0x4
    194a:	28e080e7          	jalr	654(ra) # 5bd4 <fork>
    194e:	8a2a                	mv	s4,a0
  if(pid == 0){
    ...
    195e:	2aa080e7          	jalr	682(ra) # 5c04 <close>
    total = 0;
    1962:	8a26                	mv	s4,s1
    cc = 1;
    1964:	4985                	li	s3,1
    ...
    197c:	27c080e7          	jalr	636(ra) # 5bf4 <read>
    ...
    19c0:	13c50513          	addi	a0,a0,316 # 6af8 <malloc+0xad6>
    19c4:	00004097          	auipc	ra,0x4
    19c8:	5a0080e7          	jalr	1440(ra) # 5f64 <printf>
    exit(1);
    19cc:	4505                	li	a0,1
    19ce:	00004097          	auipc	ra,0x4
    19d2:	20e080e7          	jalr	526(ra) # 5bdc <exit>
    close(fds[0]);
    19d6:	fa842503          	lw	a0,-88(s0)
    19da:	00004097          	auipc	ra,0x4
    19de:	22a080e7          	jalr	554(ra) # 5c04 <close>
    for(n = 0; n < N; n++){
    ...
    19fa:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a20:	1e0080e7          	jalr	480(ra) # 5bfc <write>
    ...
    1a3c:	1a4080e7          	jalr	420(ra) # 5bdc <exit>
        printf("%s: pipe1 oops 1\n", s);
    1a40:	85ca                	mv	a1,s2
    1a42:	00005517          	auipc	a0,0x5
    1a46:	0ce50513          	addi	a0,a0,206 # 6b10 <malloc+0xaee>
    1a4a:	00004097          	auipc	ra,0x4
    1a4e:	51a080e7          	jalr	1306(ra) # 5f64 <printf>
        exit(1);
    1a52:	4505                	li	a0,1
    1a54:	00004097          	auipc	ra,0x4
    1a58:	188080e7          	jalr	392(ra) # 5bdc <exit>
          printf("%s: pipe1 oops 2\n", s);
    1a5c:	85ca                	mv	a1,s2
    1a5e:	00005517          	auipc	a0,0x5
    1a62:	0ca50513          	addi	a0,a0,202 # 6b28 <malloc+0xb06>
    1a66:	00004097          	auipc	ra,0x4
    1a6a:	4fe080e7          	jalr	1278(ra) # 5f64 <printf>
}
    ...
    1a94:	0b050513          	addi	a0,a0,176 # 6b40 <malloc+0xb1e>
    1a98:	00004097          	auipc	ra,0x4
    1a9c:	4cc080e7          	jalr	1228(ra) # 5f64 <printf>
      exit(1);
    1aa0:	4505                	li	a0,1
    1aa2:	00004097          	auipc	ra,0x4
    1aa6:	13a080e7          	jalr	314(ra) # 5bdc <exit>
    close(fds[0]);
    1aaa:	fa842503          	lw	a0,-88(s0)
    1aae:	00004097          	auipc	ra,0x4
    1ab2:	156080e7          	jalr	342(ra) # 5c04 <close>
    wait(&xstatus);
    1ab6:	fa440513          	addi	a0,s0,-92
    1aba:	00004097          	auipc	ra,0x4
    1abe:	12a080e7          	jalr	298(ra) # 5be4 <wait>
    exit(xstatus);
    1ac2:	fa442503          	lw	a0,-92(s0)
    1ac6:	00004097          	auipc	ra,0x4
    1aca:	116080e7          	jalr	278(ra) # 5bdc <exit>
    printf("%s: fork() failed\n", s);
    1ace:	85ca                	mv	a1,s2
    1ad0:	00005517          	auipc	a0,0x5
    1ad4:	09050513          	addi	a0,a0,144 # 6b60 <malloc+0xb3e>
    1ad8:	00004097          	auipc	ra,0x4
    1adc:	48c080e7          	jalr	1164(ra) # 5f64 <printf>
    exit(1);
    1ae0:	4505                	li	a0,1
    1ae2:	00004097          	auipc	ra,0x4
    1ae6:	0fa080e7          	jalr	250(ra) # 5bdc <exit>
...
0000000000001aea <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b06:	0d2080e7          	jalr	210(ra) # 5bd4 <fork>
    1b0a:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    1b1a:	0ce080e7          	jalr	206(ra) # 5be4 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b46:	eae50513          	addi	a0,a0,-338 # 69f0 <malloc+0x9ce>
    1b4a:	00004097          	auipc	ra,0x4
    1b4e:	41a080e7          	jalr	1050(ra) # 5f64 <printf>
      exit(1);
    1b52:	4505                	li	a0,1
    1b54:	00004097          	auipc	ra,0x4
    1b58:	088080e7          	jalr	136(ra) # 5bdc <exit>
        printf("%s: wait wrong pid\n", s);
    1b5c:	85d2                	mv	a1,s4
    1b5e:	00005517          	auipc	a0,0x5
    1b62:	01a50513          	addi	a0,a0,26 # 6b78 <malloc+0xb56>
    1b66:	00004097          	auipc	ra,0x4
    1b6a:	3fe080e7          	jalr	1022(ra) # 5f64 <printf>
        exit(1);
    1b6e:	4505                	li	a0,1
    1b70:	00004097          	auipc	ra,0x4
    1b74:	06c080e7          	jalr	108(ra) # 5bdc <exit>
        printf("%s: wait wrong exit status\n", s);
    1b78:	85d2                	mv	a1,s4
    1b7a:	00005517          	auipc	a0,0x5
    1b7e:	01650513          	addi	a0,a0,22 # 6b90 <malloc+0xb6e>
    1b82:	00004097          	auipc	ra,0x4
    1b86:	3e2080e7          	jalr	994(ra) # 5f64 <printf>
        exit(1);
    1b8a:	4505                	li	a0,1
    1b8c:	00004097          	auipc	ra,0x4
    1b90:	050080e7          	jalr	80(ra) # 5bdc <exit>
      exit(i);
    1b94:	854a                	mv	a0,s2
    1b96:	00004097          	auipc	ra,0x4
    1b9a:	046080e7          	jalr	70(ra) # 5bdc <exit>
...
0000000000001b9e <twochildren>:
{
    ...
    1bb4:	024080e7          	jalr	36(ra) # 5bd4 <fork>
    if(pid1 < 0){
    ...
    1bc2:	016080e7          	jalr	22(ra) # 5bd4 <fork>
      if(pid2 < 0){
    ...
    1bd2:	016080e7          	jalr	22(ra) # 5be4 <wait>
        wait(0);
    1bd6:	4501                	li	a0,0
    1bd8:	00004097          	auipc	ra,0x4
    1bdc:	00c080e7          	jalr	12(ra) # 5be4 <wait>
  for(int i = 0; i < 1000; i++){
    ...
    1bf6:	dfe50513          	addi	a0,a0,-514 # 69f0 <malloc+0x9ce>
    1bfa:	00004097          	auipc	ra,0x4
    1bfe:	36a080e7          	jalr	874(ra) # 5f64 <printf>
      exit(1);
    1c02:	4505                	li	a0,1
    1c04:	00004097          	auipc	ra,0x4
    1c08:	fd8080e7          	jalr	-40(ra) # 5bdc <exit>
      exit(0);
    1c0c:	00004097          	auipc	ra,0x4
    1c10:	fd0080e7          	jalr	-48(ra) # 5bdc <exit>
        printf("%s: fork failed\n", s);
    1c14:	85ca                	mv	a1,s2
    1c16:	00005517          	auipc	a0,0x5
    1c1a:	dda50513          	addi	a0,a0,-550 # 69f0 <malloc+0x9ce>
    1c1e:	00004097          	auipc	ra,0x4
    1c22:	346080e7          	jalr	838(ra) # 5f64 <printf>
        exit(1);
    1c26:	4505                	li	a0,1
    1c28:	00004097          	auipc	ra,0x4
    1c2c:	fb4080e7          	jalr	-76(ra) # 5bdc <exit>
        exit(0);
    1c30:	00004097          	auipc	ra,0x4
    1c34:	fac080e7          	jalr	-84(ra) # 5bdc <exit>
...
0000000000001c38 <forkfork>:
{
    ...
    1c48:	f90080e7          	jalr	-112(ra) # 5bd4 <fork>
    if(pid < 0){
    ...
    1c56:	f82080e7          	jalr	-126(ra) # 5bd4 <fork>
    if(pid < 0){
    ...
    1c68:	f80080e7          	jalr	-128(ra) # 5be4 <wait>
    if(xstatus != 0) {
    ...
    1c7a:	f6e080e7          	jalr	-146(ra) # 5be4 <wait>
    if(xstatus != 0) {
    ...
    1c94:	f2050513          	addi	a0,a0,-224 # 6bb0 <malloc+0xb8e>
    1c98:	00004097          	auipc	ra,0x4
    1c9c:	2cc080e7          	jalr	716(ra) # 5f64 <printf>
      exit(1);
    1ca0:	4505                	li	a0,1
    1ca2:	00004097          	auipc	ra,0x4
    1ca6:	f3a080e7          	jalr	-198(ra) # 5bdc <exit>
{
    1caa:	0c800493          	li	s1,200
        int pid1 = fork();
    1cae:	00004097          	auipc	ra,0x4
    1cb2:	f26080e7          	jalr	-218(ra) # 5bd4 <fork>
        if(pid1 < 0){
    ...
    1cc2:	f26080e7          	jalr	-218(ra) # 5be4 <wait>
      for(int j = 0; j < 200; j++){
    ...
    1cd0:	f10080e7          	jalr	-240(ra) # 5bdc <exit>
          exit(1);
    1cd4:	4505                	li	a0,1
    1cd6:	00004097          	auipc	ra,0x4
    1cda:	f06080e7          	jalr	-250(ra) # 5bdc <exit>
          exit(0);
    1cde:	00004097          	auipc	ra,0x4
    1ce2:	efe080e7          	jalr	-258(ra) # 5bdc <exit>
      printf("%s: fork in child failed", s);
    1ce6:	85a6                	mv	a1,s1
    1ce8:	00005517          	auipc	a0,0x5
    1cec:	ed850513          	addi	a0,a0,-296 # 6bc0 <malloc+0xb9e>
    1cf0:	00004097          	auipc	ra,0x4
    1cf4:	274080e7          	jalr	628(ra) # 5f64 <printf>
      exit(1);
    1cf8:	4505                	li	a0,1
    1cfa:	00004097          	auipc	ra,0x4
    1cfe:	ee2080e7          	jalr	-286(ra) # 5bdc <exit>
...
0000000000001d02 <reparent2>:
{
    ...
    1d14:	ec4080e7          	jalr	-316(ra) # 5bd4 <fork>
    if(pid1 < 0){
    ...
    1d24:	ec4080e7          	jalr	-316(ra) # 5be4 <wait>
  for(int i = 0; i < 800; i++){
  ...
  exit(0);
    ...
    1d32:	eae080e7          	jalr	-338(ra) # 5bdc <exit>
      printf("fork failed\n");
    1d36:	00005517          	auipc	a0,0x5
    1d3a:	0c250513          	addi	a0,a0,194 # 6df8 <malloc+0xdd6>
    1d3e:	00004097          	auipc	ra,0x4
    1d42:	226080e7          	jalr	550(ra) # 5f64 <printf>
      exit(1);
    1d46:	4505                	li	a0,1
    1d48:	00004097          	auipc	ra,0x4
    1d4c:	e94080e7          	jalr	-364(ra) # 5bdc <exit>
      fork();
    1d50:	00004097          	auipc	ra,0x4
    1d54:	e84080e7          	jalr	-380(ra) # 5bd4 <fork>
      fork();
    1d58:	00004097          	auipc	ra,0x4
    1d5c:	e7c080e7          	jalr	-388(ra) # 5bd4 <fork>
      exit(0);
    1d60:	4501                	li	a0,0
    1d62:	00004097          	auipc	ra,0x4
    1d66:	e7a080e7          	jalr	-390(ra) # 5bdc <exit>
...
0000000000001d6a <createdelete>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1d8e:	e4a080e7          	jalr	-438(ra) # 5bd4 <fork>
    1d92:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1daa:	e3e080e7          	jalr	-450(ra) # 5be4 <wait>
    if(xstatus != 0)
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd8:	02450513          	addi	a0,a0,36 # 6df8 <malloc+0xdd6>
    1ddc:	00004097          	auipc	ra,0x4
    1de0:	188080e7          	jalr	392(ra) # 5f64 <printf>
      exit(1);
    1de4:	4505                	li	a0,1
    1de6:	00004097          	auipc	ra,0x4
    1dea:	df6080e7          	jalr	-522(ra) # 5bdc <exit>
      name[0] = 'p' + pi;
    ...
    1e04:	c8850513          	addi	a0,a0,-888 # 6a88 <malloc+0xa66>
    1e08:	00004097          	auipc	ra,0x4
    1e0c:	15c080e7          	jalr	348(ra) # 5f64 <printf>
          exit(1);
    1e10:	4505                	li	a0,1
    1e12:	00004097          	auipc	ra,0x4
    1e16:	dca080e7          	jalr	-566(ra) # 5bdc <exit>
      for(i = 0; i < N; i++){
    ...
    1e34:	dec080e7          	jalr	-532(ra) # 5c1c <open>
        if(fd < 0){
    1e38:	fc0543e3          	bltz	a0,1dfe <createdelete+0x94>
        close(fd);
    1e3c:	00004097          	auipc	ra,0x4
    1e40:	dc8080e7          	jalr	-568(ra) # 5c04 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    1e68:	dc8080e7          	jalr	-568(ra) # 5c2c <unlink>
    1e6c:	fa0557e3          	bgez	a0,1e1a <createdelete+0xb0>
            printf("%s: unlink failed\n", s);
    1e70:	85e6                	mv	a1,s9
    1e72:	00005517          	auipc	a0,0x5
    1e76:	d6e50513          	addi	a0,a0,-658 # 6be0 <malloc+0xbbe>
    1e7a:	00004097          	auipc	ra,0x4
    1e7e:	0ea080e7          	jalr	234(ra) # 5f64 <printf>
            exit(1);
    1e82:	4505                	li	a0,1
    1e84:	00004097          	auipc	ra,0x4
    1e88:	d58080e7          	jalr	-680(ra) # 5bdc <exit>
      exit(0);
    1e8c:	4501                	li	a0,0
    1e8e:	00004097          	auipc	ra,0x4
    1e92:	d4e080e7          	jalr	-690(ra) # 5bdc <exit>
      exit(1);
    1e96:	4505                	li	a0,1
    1e98:	00004097          	auipc	ra,0x4
    1e9c:	d44080e7          	jalr	-700(ra) # 5bdc <exit>
        printf("%s: oops createdelete %s didn't exist\n", s, name);
    1ea0:	f8040613          	addi	a2,s0,-128
    1ea4:	85e6                	mv	a1,s9
    1ea6:	00005517          	auipc	a0,0x5
    1eaa:	d5250513          	addi	a0,a0,-686 # 6bf8 <malloc+0xbd6>
    1eae:	00004097          	auipc	ra,0x4
    1eb2:	0b6080e7          	jalr	182(ra) # 5f64 <printf>
        exit(1);
    1eb6:	4505                	li	a0,1
    1eb8:	00004097          	auipc	ra,0x4
    1ebc:	d24080e7          	jalr	-732(ra) # 5bdc <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1ee4:	d3c080e7          	jalr	-708(ra) # 5c1c <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    1efc:	d0c080e7          	jalr	-756(ra) # 5c04 <close>
    ...
    1f10:	d1450513          	addi	a0,a0,-748 # 6c20 <malloc+0xbfe>
    1f14:	00004097          	auipc	ra,0x4
    1f18:	050080e7          	jalr	80(ra) # 5f64 <printf>
        exit(1);
    1f1c:	4505                	li	a0,1
    1f1e:	00004097          	auipc	ra,0x4
    1f22:	cbe080e7          	jalr	-834(ra) # 5bdc <exit>
  for(i = 0; i < N; i++){
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1f5c:	cd4080e7          	jalr	-812(ra) # 5c2c <unlink>
    for(pi = 0; pi < NCHILD; pi++){
...
0000000000001f90 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb0:	22c50513          	addi	a0,a0,556 # 61d8 <malloc+0x1b6>
    1fb4:	00004097          	auipc	ra,0x4
    1fb8:	c78080e7          	jalr	-904(ra) # 5c2c <unlink>
  pid = fork();
    1fbc:	00004097          	auipc	ra,0x4
    1fc0:	c18080e7          	jalr	-1000(ra) # 5bd4 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fec:	1f0a8a93          	addi	s5,s5,496 # 61d8 <malloc+0x1b6>
      link("cat", "x");
    1ff0:	00005b97          	auipc	s7,0x5
    1ff4:	c58b8b93          	addi	s7,s7,-936 # 6c48 <malloc+0xc26>
    1ff8:	a825                	j	2030 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ffa:	85a6                	mv	a1,s1
    1ffc:	00005517          	auipc	a0,0x5
    2000:	9f450513          	addi	a0,a0,-1548 # 69f0 <malloc+0x9ce>
    2004:	00004097          	auipc	ra,0x4
    2008:	f60080e7          	jalr	-160(ra) # 5f64 <printf>
    exit(1);
    200c:	4505                	li	a0,1
    200e:	00004097          	auipc	ra,0x4
    2012:	bce080e7          	jalr	-1074(ra) # 5bdc <exit>
      close(open("x", O_RDWR | O_CREATE));
    2016:	20200593          	li	a1,514
    201a:	8556                	mv	a0,s5
    201c:	00004097          	auipc	ra,0x4
    2020:	c00080e7          	jalr	-1024(ra) # 5c1c <open>
    2024:	00004097          	auipc	ra,0x4
    2028:	be0080e7          	jalr	-1056(ra) # 5c04 <close>
  for(i = 0; i < 100; i++){
    ...
    204c:	be4080e7          	jalr	-1052(ra) # 5c2c <unlink>
    2050:	bff1                	j	202c <linkunlink+0x9c>
      link("cat", "x");
    2052:	85d6                	mv	a1,s5
    2054:	855e                	mv	a0,s7
    2056:	00004097          	auipc	ra,0x4
    205a:	be6080e7          	jalr	-1050(ra) # 5c3c <link>
  ...
  if(pid)
    ...
    206a:	b7e080e7          	jalr	-1154(ra) # 5be4 <wait>
}
    ...
    208e:	b52080e7          	jalr	-1198(ra) # 5bdc <exit>
...
0000000000002092 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20ac:	b2c080e7          	jalr	-1236(ra) # 5bd4 <fork>
    if(pid < 0)
  ...
  for(n=0; n<N; n++){
    ...
    20c2:	baa50513          	addi	a0,a0,-1110 # 6c68 <malloc+0xc46>
    20c6:	00004097          	auipc	ra,0x4
    20ca:	e9e080e7          	jalr	-354(ra) # 5f64 <printf>
    exit(1);
    20ce:	4505                	li	a0,1
    20d0:	00004097          	auipc	ra,0x4
    20d4:	b0c080e7          	jalr	-1268(ra) # 5bdc <exit>
      exit(0);
    20d8:	00004097          	auipc	ra,0x4
    20dc:	b04080e7          	jalr	-1276(ra) # 5bdc <exit>
  if (n == 0) {
  ...
  for(; n > 0; n--){
    ...
    20f4:	af4080e7          	jalr	-1292(ra) # 5be4 <wait>
  ...
  if(wait(0) != -1){
    ...
    2106:	ae2080e7          	jalr	-1310(ra) # 5be4 <wait>
    210a:	57fd                	li	a5,-1
    ...
    2124:	b3050513          	addi	a0,a0,-1232 # 6c50 <malloc+0xc2e>
    2128:	00004097          	auipc	ra,0x4
    212c:	e3c080e7          	jalr	-452(ra) # 5f64 <printf>
    exit(1);
    2130:	4505                	li	a0,1
    2132:	00004097          	auipc	ra,0x4
    2136:	aaa080e7          	jalr	-1366(ra) # 5bdc <exit>
      printf("%s: wait stopped early\n", s);
    213a:	85ce                	mv	a1,s3
    213c:	00005517          	auipc	a0,0x5
    2140:	b5450513          	addi	a0,a0,-1196 # 6c90 <malloc+0xc6e>
    2144:	00004097          	auipc	ra,0x4
    2148:	e20080e7          	jalr	-480(ra) # 5f64 <printf>
      exit(1);
    214c:	4505                	li	a0,1
    214e:	00004097          	auipc	ra,0x4
    2152:	a8e080e7          	jalr	-1394(ra) # 5bdc <exit>
    printf("%s: wait got too many\n", s);
    2156:	85ce                	mv	a1,s3
    2158:	00005517          	auipc	a0,0x5
    215c:	b5050513          	addi	a0,a0,-1200 # 6ca8 <malloc+0xc86>
    2160:	00004097          	auipc	ra,0x4
    2164:	e04080e7          	jalr	-508(ra) # 5f64 <printf>
    exit(1);
    2168:	4505                	li	a0,1
    216a:	00004097          	auipc	ra,0x4
    216e:	a72080e7          	jalr	-1422(ra) # 5bdc <exit>
...
0000000000002172 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21a0:	a38080e7          	jalr	-1480(ra) # 5bd4 <fork>
    if(pid < 0){
    ...
    21b2:	a36080e7          	jalr	-1482(ra) # 5be4 <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21dc:	81850513          	addi	a0,a0,-2024 # 69f0 <malloc+0x9ce>
    21e0:	00004097          	auipc	ra,0x4
    21e4:	d84080e7          	jalr	-636(ra) # 5f64 <printf>
      exit(1);
    21e8:	4505                	li	a0,1
    21ea:	00004097          	auipc	ra,0x4
    21ee:	9f2080e7          	jalr	-1550(ra) # 5bdc <exit>
      printf("%s: oops could read %x = %x\n", s, a, *a);
    21f2:	0004c683          	lbu	a3,0(s1)
    21f6:	8626                	mv	a2,s1
    21f8:	85d2                	mv	a1,s4
    21fa:	00005517          	auipc	a0,0x5
    21fe:	ac650513          	addi	a0,a0,-1338 # 6cc0 <malloc+0xc9e>
    2202:	00004097          	auipc	ra,0x4
    2206:	d62080e7          	jalr	-670(ra) # 5f64 <printf>
      exit(1);
    220a:	4505                	li	a0,1
    220c:	00004097          	auipc	ra,0x4
    2210:	9d0080e7          	jalr	-1584(ra) # 5bdc <exit>
      exit(1);
    2214:	4505                	li	a0,1
    2216:	00004097          	auipc	ra,0x4
    221a:	9c6080e7          	jalr	-1594(ra) # 5bdc <exit>
...
000000000000221e <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2240:	998080e7          	jalr	-1640(ra) # 5bd4 <fork>
    if(pid < 0){
    ...
    2252:	996080e7          	jalr	-1642(ra) # 5be4 <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for( ; a != 0; a <<= 1){
    ...
    2280:	77450513          	addi	a0,a0,1908 # 69f0 <malloc+0x9ce>
    2284:	00004097          	auipc	ra,0x4
    2288:	ce0080e7          	jalr	-800(ra) # 5f64 <printf>
      exit(1);
    228c:	4505                	li	a0,1
    228e:	00004097          	auipc	ra,0x4
    2292:	94e080e7          	jalr	-1714(ra) # 5bdc <exit>
      *(char*)a = 99;
    ...
    22ac:	a3850513          	addi	a0,a0,-1480 # 6ce0 <malloc+0xcbe>
    22b0:	00004097          	auipc	ra,0x4
    22b4:	cb4080e7          	jalr	-844(ra) # 5f64 <printf>
      exit(1);
    22b8:	4505                	li	a0,1
    22ba:	00004097          	auipc	ra,0x4
    22be:	922080e7          	jalr	-1758(ra) # 5bdc <exit>
      exit(1);
    22c2:	4505                	li	a0,1
    22c4:	00004097          	auipc	ra,0x4
    22c8:	918080e7          	jalr	-1768(ra) # 5bdc <exit>
...
00000000000022cc <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22dc:	a2050513          	addi	a0,a0,-1504 # 6cf8 <malloc+0xcd6>
    22e0:	00004097          	auipc	ra,0x4
    22e4:	94c080e7          	jalr	-1716(ra) # 5c2c <unlink>
  pid = fork();
    22e8:	00004097          	auipc	ra,0x4
    22ec:	8ec080e7          	jalr	-1812(ra) # 5bd4 <fork>
  if(pid == 0){
  ...
  wait(&xstatus);
    ...
    22fe:	8ea080e7          	jalr	-1814(ra) # 5be4 <wait>
  if(xstatus != 0)
  ...
  fd = open("bigarg-ok", 0);
    ...
    230e:	9ee50513          	addi	a0,a0,-1554 # 6cf8 <malloc+0xcd6>
    2312:	00004097          	auipc	ra,0x4
    2316:	90a080e7          	jalr	-1782(ra) # 5c1c <open>
  if(fd < 0){
    231a:	08054e63          	bltz	a0,23b6 <bigargtest+0xea>
  close(fd);
    231e:	00004097          	auipc	ra,0x4
    2322:	8e6080e7          	jalr	-1818(ra) # 5c04 <close>
}
    ...
    2344:	9c870713          	addi	a4,a4,-1592 # 6d08 <malloc+0xce6>
    ...
    2360:	e0c50513          	addi	a0,a0,-500 # 6168 <malloc+0x146>
    2364:	00004097          	auipc	ra,0x4
    2368:	8b0080e7          	jalr	-1872(ra) # 5c14 <exec>
    fd = open("bigarg-ok", O_CREATE);
    236c:	20000593          	li	a1,512
    2370:	00005517          	auipc	a0,0x5
    2374:	98850513          	addi	a0,a0,-1656 # 6cf8 <malloc+0xcd6>
    2378:	00004097          	auipc	ra,0x4
    237c:	8a4080e7          	jalr	-1884(ra) # 5c1c <open>
    close(fd);
    2380:	00004097          	auipc	ra,0x4
    2384:	884080e7          	jalr	-1916(ra) # 5c04 <close>
    exit(0);
    2388:	4501                	li	a0,0
    238a:	00004097          	auipc	ra,0x4
    238e:	852080e7          	jalr	-1966(ra) # 5bdc <exit>
    printf("%s: bigargtest: fork failed\n", s);
    2392:	85a6                	mv	a1,s1
    2394:	00005517          	auipc	a0,0x5
    2398:	a5450513          	addi	a0,a0,-1452 # 6de8 <malloc+0xdc6>
    239c:	00004097          	auipc	ra,0x4
    23a0:	bc8080e7          	jalr	-1080(ra) # 5f64 <printf>
    exit(1);
    23a4:	4505                	li	a0,1
    23a6:	00004097          	auipc	ra,0x4
    23aa:	836080e7          	jalr	-1994(ra) # 5bdc <exit>
    exit(xstatus);
    23ae:	00004097          	auipc	ra,0x4
    23b2:	82e080e7          	jalr	-2002(ra) # 5bdc <exit>
    printf("%s: bigarg test failed!\n", s);
    23b6:	85a6                	mv	a1,s1
    23b8:	00005517          	auipc	a0,0x5
    23bc:	a5050513          	addi	a0,a0,-1456 # 6e08 <malloc+0xde6>
    23c0:	00004097          	auipc	ra,0x4
    23c4:	ba4080e7          	jalr	-1116(ra) # 5f64 <printf>
    exit(1);
    23c8:	4505                	li	a0,1
    23ca:	00004097          	auipc	ra,0x4
    23ce:	812080e7          	jalr	-2030(ra) # 5bdc <exit>
...
00000000000023d2 <stacktest>:
{
  ...
  pid = fork();
    ...
    23e2:	7f6080e7          	jalr	2038(ra) # 5bd4 <fork>
  if(pid == 0) {
  ...
  wait(&xstatus);
    ...
    23f4:	7f4080e7          	jalr	2036(ra) # 5be4 <wait>
  if(xstatus == -1)  // kernel killed child?
    ...
    2406:	7da080e7          	jalr	2010(ra) # 5bdc <exit>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    241a:	a1250513          	addi	a0,a0,-1518 # 6e28 <malloc+0xe06>
    241e:	00004097          	auipc	ra,0x4
    2422:	b46080e7          	jalr	-1210(ra) # 5f64 <printf>
    exit(1);
    2426:	4505                	li	a0,1
    2428:	00003097          	auipc	ra,0x3
    242c:	7b4080e7          	jalr	1972(ra) # 5bdc <exit>
    printf("%s: fork failed\n", s);
    2430:	85a6                	mv	a1,s1
    2432:	00004517          	auipc	a0,0x4
    2436:	5be50513          	addi	a0,a0,1470 # 69f0 <malloc+0x9ce>
    243a:	00004097          	auipc	ra,0x4
    243e:	b2a080e7          	jalr	-1238(ra) # 5f64 <printf>
    exit(1);
    2442:	4505                	li	a0,1
    2444:	00003097          	auipc	ra,0x3
    2448:	798080e7          	jalr	1944(ra) # 5bdc <exit>
    exit(0);
    244c:	4501                	li	a0,0
    244e:	00003097          	auipc	ra,0x3
    2452:	78e080e7          	jalr	1934(ra) # 5bdc <exit>
...
0000000000002456 <textwrite>:
{
  ...
  pid = fork();
    ...
    2466:	772080e7          	jalr	1906(ra) # 5bd4 <fork>
  if(pid == 0) {
  ...
  wait(&xstatus);
    ...
    2478:	770080e7          	jalr	1904(ra) # 5be4 <wait>
  if(xstatus == -1)  // kernel killed child?
    ...
    248a:	756080e7          	jalr	1878(ra) # 5bdc <exit>
    *addr = 10;
    248e:	47a9                	li	a5,10
    ...
    249a:	746080e7          	jalr	1862(ra) # 5bdc <exit>
    printf("%s: fork failed\n", s);
    249e:	85a6                	mv	a1,s1
    24a0:	00004517          	auipc	a0,0x4
    24a4:	55050513          	addi	a0,a0,1360 # 69f0 <malloc+0x9ce>
    24a8:	00004097          	auipc	ra,0x4
    24ac:	abc080e7          	jalr	-1348(ra) # 5f64 <printf>
    exit(1);
    24b0:	4505                	li	a0,1
    24b2:	00003097          	auipc	ra,0x3
    24b6:	72a080e7          	jalr	1834(ra) # 5bdc <exit>
    exit(0);
    24ba:	4501                	li	a0,0
    24bc:	00003097          	auipc	ra,0x3
    24c0:	720080e7          	jalr	1824(ra) # 5bdc <exit>
...
00000000000024c4 <manywrites>:
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    24e4:	6f4080e7          	jalr	1780(ra) # 5bd4 <fork>
    24e8:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    2504:	6e4080e7          	jalr	1764(ra) # 5be4 <wait>
    if(st != 0)
  ...
  exit(0);
    ...
    2518:	6c8080e7          	jalr	1736(ra) # 5bdc <exit>
      printf("fork failed\n");
    251c:	00005517          	auipc	a0,0x5
    2520:	8dc50513          	addi	a0,a0,-1828 # 6df8 <malloc+0xdd6>
    2524:	00004097          	auipc	ra,0x4
    2528:	a40080e7          	jalr	-1472(ra) # 5f64 <printf>
      exit(1);
    252c:	4505                	li	a0,1
    252e:	00003097          	auipc	ra,0x3
    2532:	6ae080e7          	jalr	1710(ra) # 5bdc <exit>
      name[0] = 'b';
    ...
    2552:	6de080e7          	jalr	1758(ra) # 5c2c <unlink>
    2556:	4bf9                	li	s7,30
          int cc = write(fd, buf, sz);
    ...
    2572:	6ae080e7          	jalr	1710(ra) # 5c1c <open>
    2576:	892a                	mv	s2,a0
          if(fd < 0){
    ...
    2584:	67c080e7          	jalr	1660(ra) # 5bfc <write>
          if(cc != sz){
    ...
    2594:	674080e7          	jalr	1652(ra) # 5c04 <close>
        for(int i = 0; i < ci+1; i++){
    ...
    25a6:	68a080e7          	jalr	1674(ra) # 5c2c <unlink>
    ...
    25b8:	678080e7          	jalr	1656(ra) # 5c2c <unlink>
      exit(0);
    25bc:	4501                	li	a0,0
    25be:	00003097          	auipc	ra,0x3
    25c2:	61e080e7          	jalr	1566(ra) # 5bdc <exit>
            printf("%s: cannot create %s\n", s, name);
    25c6:	fa840613          	addi	a2,s0,-88
    25ca:	85d6                	mv	a1,s5
    25cc:	00005517          	auipc	a0,0x5
    25d0:	88450513          	addi	a0,a0,-1916 # 6e50 <malloc+0xe2e>
    25d4:	00004097          	auipc	ra,0x4
    25d8:	990080e7          	jalr	-1648(ra) # 5f64 <printf>
            exit(1);
    25dc:	4505                	li	a0,1
    25de:	00003097          	auipc	ra,0x3
    25e2:	5fe080e7          	jalr	1534(ra) # 5bdc <exit>
            printf("%s: write(%d) ret %d\n", s, sz, cc);
    25e6:	86aa                	mv	a3,a0
    25e8:	660d                	lui	a2,0x3
    25ea:	85d6                	mv	a1,s5
    25ec:	00004517          	auipc	a0,0x4
    25f0:	c4c50513          	addi	a0,a0,-948 # 6238 <malloc+0x216>
    25f4:	00004097          	auipc	ra,0x4
    25f8:	970080e7          	jalr	-1680(ra) # 5f64 <printf>
            exit(1);
    25fc:	4505                	li	a0,1
    25fe:	00003097          	auipc	ra,0x3
    2602:	5de080e7          	jalr	1502(ra) # 5bdc <exit>
      exit(st);
    2606:	00003097          	auipc	ra,0x3
    260a:	5d6080e7          	jalr	1494(ra) # 5bdc <exit>
...
000000000000260e <copyinstr3>:
{
  ...
  sbrk(8192);
    ...
    261e:	64a080e7          	jalr	1610(ra) # 5c64 <sbrk>
  uint64 top = (uint64) sbrk(0);
    2622:	4501                	li	a0,0
    2624:	00003097          	auipc	ra,0x3
    2628:	640080e7          	jalr	1600(ra) # 5c64 <sbrk>
  if((top % PGSIZE) != 0){
  ...
  top = (uint64) sbrk(0);
    ...
    2638:	630080e7          	jalr	1584(ra) # 5c64 <sbrk>
  if(top % PGSIZE){
  ...
  *b = 'x';
  ...
  int ret = unlink(b);
    ...
    2654:	5dc080e7          	jalr	1500(ra) # 5c2c <unlink>
  if(ret != -1){
    2658:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    2668:	5b8080e7          	jalr	1464(ra) # 5c1c <open>
  if(fd != -1){
    266c:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    267a:	5c6080e7          	jalr	1478(ra) # 5c3c <link>
  if(ret != -1){
    267e:	57fd                	li	a5,-1
    2680:	08f51e63          	bne	a0,a5,271c <copyinstr3+0x10e>
  char *args[] = { "xx", 0 };
    2684:	00005797          	auipc	a5,0x5
    2688:	4c478793          	addi	a5,a5,1220 # 7b48 <malloc+0x1b26>
  ...
  ret = exec(b, args);
    ...
    269e:	57a080e7          	jalr	1402(ra) # 5c14 <exec>
  if(ret != -1){
    26a2:	57fd                	li	a5,-1
    ...
    26c0:	5a8080e7          	jalr	1448(ra) # 5c64 <sbrk>
    26c4:	b7bd                	j	2632 <copyinstr3+0x24>
    printf("oops\n");
    26c6:	00004517          	auipc	a0,0x4
    26ca:	7a250513          	addi	a0,a0,1954 # 6e68 <malloc+0xe46>
    26ce:	00004097          	auipc	ra,0x4
    26d2:	896080e7          	jalr	-1898(ra) # 5f64 <printf>
    exit(1);
    26d6:	4505                	li	a0,1
    26d8:	00003097          	auipc	ra,0x3
    26dc:	504080e7          	jalr	1284(ra) # 5bdc <exit>
    printf("unlink(%s) returned %d, not -1\n", b, ret);
    26e0:	862a                	mv	a2,a0
    26e2:	85a6                	mv	a1,s1
    26e4:	00004517          	auipc	a0,0x4
    26e8:	22c50513          	addi	a0,a0,556 # 6910 <malloc+0x8ee>
    26ec:	00004097          	auipc	ra,0x4
    26f0:	878080e7          	jalr	-1928(ra) # 5f64 <printf>
    exit(1);
    26f4:	4505                	li	a0,1
    26f6:	00003097          	auipc	ra,0x3
    26fa:	4e6080e7          	jalr	1254(ra) # 5bdc <exit>
    printf("open(%s) returned %d, not -1\n", b, fd);
    26fe:	862a                	mv	a2,a0
    2700:	85a6                	mv	a1,s1
    2702:	00004517          	auipc	a0,0x4
    2706:	22e50513          	addi	a0,a0,558 # 6930 <malloc+0x90e>
    270a:	00004097          	auipc	ra,0x4
    270e:	85a080e7          	jalr	-1958(ra) # 5f64 <printf>
    exit(1);
    2712:	4505                	li	a0,1
    2714:	00003097          	auipc	ra,0x3
    2718:	4c8080e7          	jalr	1224(ra) # 5bdc <exit>
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
    271c:	86aa                	mv	a3,a0
    271e:	8626                	mv	a2,s1
    2720:	85a6                	mv	a1,s1
    2722:	00004517          	auipc	a0,0x4
    2726:	22e50513          	addi	a0,a0,558 # 6950 <malloc+0x92e>
    272a:	00004097          	auipc	ra,0x4
    272e:	83a080e7          	jalr	-1990(ra) # 5f64 <printf>
    exit(1);
    2732:	4505                	li	a0,1
    2734:	00003097          	auipc	ra,0x3
    2738:	4a8080e7          	jalr	1192(ra) # 5bdc <exit>
    printf("exec(%s) returned %d, not -1\n", b, fd);
    273c:	567d                	li	a2,-1
    273e:	85a6                	mv	a1,s1
    2740:	00004517          	auipc	a0,0x4
    2744:	23850513          	addi	a0,a0,568 # 6978 <malloc+0x956>
    2748:	00004097          	auipc	ra,0x4
    274c:	81c080e7          	jalr	-2020(ra) # 5f64 <printf>
    exit(1);
    2750:	4505                	li	a0,1
    2752:	00003097          	auipc	ra,0x3
    2756:	48a080e7          	jalr	1162(ra) # 5bdc <exit>
...
000000000000275a <rwsbrk>:
{
  ...
  uint64 a = (uint64) sbrk(8192);
    ...
    276c:	4fc080e7          	jalr	1276(ra) # 5c64 <sbrk>
  ...
  n = write(fd, (void*)(a+4096), 1024);
    ...
    27b2:	44e080e7          	jalr	1102(ra) # 5bfc <write>
    27b6:	862a                	mv	a2,a0
  if(n >= 0){
    ...
    27c2:	70a50513          	addi	a0,a0,1802 # 6ec8 <malloc+0xea6>
    27c6:	00003097          	auipc	ra,0x3
    27ca:	79e080e7          	jalr	1950(ra) # 5f64 <printf>
    exit(1);
    27ce:	4505                	li	a0,1
    27d0:	00003097          	auipc	ra,0x3
    27d4:	40c080e7          	jalr	1036(ra) # 5bdc <exit>
    printf("sbrk(rwsbrk) failed\n");
    27d8:	00004517          	auipc	a0,0x4
    27dc:	69850513          	addi	a0,a0,1688 # 6e70 <malloc+0xe4e>
    27e0:	00003097          	auipc	ra,0x3
    27e4:	784080e7          	jalr	1924(ra) # 5f64 <printf>
    exit(1);
    27e8:	4505                	li	a0,1
    27ea:	00003097          	auipc	ra,0x3
    27ee:	3f2080e7          	jalr	1010(ra) # 5bdc <exit>
    printf("sbrk(rwsbrk) shrink failed\n");
    27f2:	00004517          	auipc	a0,0x4
    27f6:	69650513          	addi	a0,a0,1686 # 6e88 <malloc+0xe66>
    27fa:	00003097          	auipc	ra,0x3
    27fe:	76a080e7          	jalr	1898(ra) # 5f64 <printf>
    exit(1);
    2802:	4505                	li	a0,1
    2804:	00003097          	auipc	ra,0x3
    2808:	3d8080e7          	jalr	984(ra) # 5bdc <exit>
    printf("open(rwsbrk) failed\n");
    280c:	00004517          	auipc	a0,0x4
    2810:	6a450513          	addi	a0,a0,1700 # 6eb0 <malloc+0xe8e>
    2814:	00003097          	auipc	ra,0x3
    2818:	750080e7          	jalr	1872(ra) # 5f64 <printf>
    exit(1);
    281c:	4505                	li	a0,1
    281e:	00003097          	auipc	ra,0x3
    2822:	3be080e7          	jalr	958(ra) # 5bdc <exit>
  close(fd);
    2826:	854a                	mv	a0,s2
    2828:	00003097          	auipc	ra,0x3
    282c:	3dc080e7          	jalr	988(ra) # 5c04 <close>
  unlink("rwsbrk");
    2830:	00004517          	auipc	a0,0x4
    2834:	67850513          	addi	a0,a0,1656 # 6ea8 <malloc+0xe86>
    2838:	00003097          	auipc	ra,0x3
    283c:	3f4080e7          	jalr	1012(ra) # 5c2c <unlink>
  fd = open("README", O_RDONLY);
    2840:	4581                	li	a1,0
    2842:	00004517          	auipc	a0,0x4
    2846:	afe50513          	addi	a0,a0,-1282 # 6340 <malloc+0x31e>
    284a:	00003097          	auipc	ra,0x3
    284e:	3d2080e7          	jalr	978(ra) # 5c1c <open>
    2852:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  n = read(fd, (void*)(a+4096), 10);
    ...
    2860:	398080e7          	jalr	920(ra) # 5bf4 <read>
    2864:	862a                	mv	a2,a0
  if(n >= 0){
    ...
    2870:	68c50513          	addi	a0,a0,1676 # 6ef8 <malloc+0xed6>
    2874:	00003097          	auipc	ra,0x3
    2878:	6f0080e7          	jalr	1776(ra) # 5f64 <printf>
    exit(1);
    287c:	4505                	li	a0,1
    287e:	00003097          	auipc	ra,0x3
    2882:	35e080e7          	jalr	862(ra) # 5bdc <exit>
    printf("open(rwsbrk) failed\n");
    2886:	00004517          	auipc	a0,0x4
    288a:	62a50513          	addi	a0,a0,1578 # 6eb0 <malloc+0xe8e>
    288e:	00003097          	auipc	ra,0x3
    2892:	6d6080e7          	jalr	1750(ra) # 5f64 <printf>
    exit(1);
    2896:	4505                	li	a0,1
    2898:	00003097          	auipc	ra,0x3
    289c:	344080e7          	jalr	836(ra) # 5bdc <exit>
  close(fd);
    28a0:	854a                	mv	a0,s2
    28a2:	00003097          	auipc	ra,0x3
    28a6:	362080e7          	jalr	866(ra) # 5c04 <close>
  exit(0);
    28aa:	4501                	li	a0,0
    28ac:	00003097          	auipc	ra,0x3
    28b0:	330080e7          	jalr	816(ra) # 5bdc <exit>
...
00000000000028b4 <sbrkbasic>:
{
  ...
  pid = fork();
    ...
    28ca:	30e080e7          	jalr	782(ra) # 5bd4 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    28dc:	38c080e7          	jalr	908(ra) # 5c64 <sbrk>
    ...
    2902:	2de080e7          	jalr	734(ra) # 5bdc <exit>
    printf("fork failed in sbrkbasic\n");
    2906:	00004517          	auipc	a0,0x4
    290a:	61a50513          	addi	a0,a0,1562 # 6f20 <malloc+0xefe>
    290e:	00003097          	auipc	ra,0x3
    2912:	656080e7          	jalr	1622(ra) # 5f64 <printf>
    exit(1);
    2916:	4505                	li	a0,1
    2918:	00003097          	auipc	ra,0x3
    291c:	2c4080e7          	jalr	708(ra) # 5bdc <exit>
      exit(0);
    2920:	4501                	li	a0,0
    2922:	00003097          	auipc	ra,0x3
    2926:	2ba080e7          	jalr	698(ra) # 5bdc <exit>
  wait(&xstatus);
    292a:	fcc40513          	addi	a0,s0,-52
    292e:	00003097          	auipc	ra,0x3
    2932:	2b6080e7          	jalr	694(ra) # 5be4 <wait>
  if(xstatus == 1){
  ...
  a = sbrk(0);
    ...
    2946:	322080e7          	jalr	802(ra) # 5c64 <sbrk>
    294a:	84aa                	mv	s1,a0
  for(i = 0; i < 5000; i++){
    294c:	4901                	li	s2,0
    ...
    295c:	5e850513          	addi	a0,a0,1512 # 6f40 <malloc+0xf1e>
    2960:	00003097          	auipc	ra,0x3
    2964:	604080e7          	jalr	1540(ra) # 5f64 <printf>
    exit(1);
    2968:	4505                	li	a0,1
    296a:	00003097          	auipc	ra,0x3
    296e:	272080e7          	jalr	626(ra) # 5bdc <exit>
    a = b + 1;
    2972:	84be                	mv	s1,a5
    b = sbrk(1);
    2974:	4505                	li	a0,1
    2976:	00003097          	auipc	ra,0x3
    297a:	2ee080e7          	jalr	750(ra) # 5c64 <sbrk>
    if(b != a){
  ...
  pid = fork();
    ...
    2996:	242080e7          	jalr	578(ra) # 5bd4 <fork>
    299a:	892a                	mv	s2,a0
  if(pid < 0){
  ...
  c = sbrk(1);
    ...
    29a6:	2c2080e7          	jalr	706(ra) # 5c64 <sbrk>
  c = sbrk(1);
    29aa:	4505                	li	a0,1
    29ac:	00003097          	auipc	ra,0x3
    29b0:	2b8080e7          	jalr	696(ra) # 5c64 <sbrk>
  if(c != a + 1){
    ...
    29c0:	5e450513          	addi	a0,a0,1508 # 6fa0 <malloc+0xf7e>
    29c4:	00003097          	auipc	ra,0x3
    29c8:	5a0080e7          	jalr	1440(ra) # 5f64 <printf>
    exit(1);
    29cc:	4505                	li	a0,1
    29ce:	00003097          	auipc	ra,0x3
    29d2:	20e080e7          	jalr	526(ra) # 5bdc <exit>
    ...
    29e2:	58250513          	addi	a0,a0,1410 # 6f60 <malloc+0xf3e>
    29e6:	00003097          	auipc	ra,0x3
    29ea:	57e080e7          	jalr	1406(ra) # 5f64 <printf>
      exit(1);
    29ee:	4505                	li	a0,1
    29f0:	00003097          	auipc	ra,0x3
    29f4:	1ec080e7          	jalr	492(ra) # 5bdc <exit>
    printf("%s: sbrk test fork failed\n", s);
    29f8:	85d2                	mv	a1,s4
    29fa:	00004517          	auipc	a0,0x4
    29fe:	58650513          	addi	a0,a0,1414 # 6f80 <malloc+0xf5e>
    2a02:	00003097          	auipc	ra,0x3
    2a06:	562080e7          	jalr	1378(ra) # 5f64 <printf>
    exit(1);
    2a0a:	4505                	li	a0,1
    2a0c:	00003097          	auipc	ra,0x3
    2a10:	1d0080e7          	jalr	464(ra) # 5bdc <exit>
  if(pid == 0)
    2a14:	00091763          	bnez	s2,2a22 <sbrkbasic+0x16e>
    exit(0);
    2a18:	4501                	li	a0,0
    2a1a:	00003097          	auipc	ra,0x3
    2a1e:	1c2080e7          	jalr	450(ra) # 5bdc <exit>
  wait(&xstatus);
    2a22:	fcc40513          	addi	a0,s0,-52
    2a26:	00003097          	auipc	ra,0x3
    2a2a:	1be080e7          	jalr	446(ra) # 5be4 <wait>
  exit(xstatus);
    2a2e:	fcc42503          	lw	a0,-52(s0)
    2a32:	00003097          	auipc	ra,0x3
    2a36:	1aa080e7          	jalr	426(ra) # 5bdc <exit>
...
0000000000002a3a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    ...
    2aa6:	1c2080e7          	jalr	450(ra) # 5c64 <sbrk>
    2aaa:	84aa                	mv	s1,a0
  c = sbrk(-PGSIZE);
    2aac:	757d                	lui	a0,0xfffff
    2aae:	00003097          	auipc	ra,0x3
    2ab2:	1b6080e7          	jalr	438(ra) # 5c64 <sbrk>
  ...
  c = sbrk(0);
    ...
    2ac2:	1a6080e7          	jalr	422(ra) # 5c64 <sbrk>
  if(c != a - PGSIZE){
  ...
  a = sbrk(0);
    ...
    2b12:	156080e7          	jalr	342(ra) # 5c64 <sbrk>
    2b16:	84aa                	mv	s1,a0
  c = sbrk(-(sbrk(0) - oldbrk));
    2b18:	4501                	li	a0,0
    2b1a:	00003097          	auipc	ra,0x3
    2b1e:	14a080e7          	jalr	330(ra) # 5c64 <sbrk>
    2b22:	40a9053b          	subw	a0,s2,a0
    2b26:	00003097          	auipc	ra,0x3
    2b2a:	13e080e7          	jalr	318(ra) # 5c64 <sbrk>
  if(c != a){
    ...
    2b48:	47c50513          	addi	a0,a0,1148 # 6fc0 <malloc+0xf9e>
    2b4c:	00003097          	auipc	ra,0x3
    2b50:	418080e7          	jalr	1048(ra) # 5f64 <printf>
    exit(1);
    2b54:	4505                	li	a0,1
    2b56:	00003097          	auipc	ra,0x3
    2b5a:	086080e7          	jalr	134(ra) # 5bdc <exit>
    printf("%s: sbrk could not deallocate\n", s);
    2b5e:	85ce                	mv	a1,s3
    2b60:	00004517          	auipc	a0,0x4
    2b64:	4a850513          	addi	a0,a0,1192 # 7008 <malloc+0xfe6>
    2b68:	00003097          	auipc	ra,0x3
    2b6c:	3fc080e7          	jalr	1020(ra) # 5f64 <printf>
    exit(1);
    2b70:	4505                	li	a0,1
    2b72:	00003097          	auipc	ra,0x3
    2b76:	06a080e7          	jalr	106(ra) # 5bdc <exit>
    printf("%s: sbrk deallocation produced wrong address, a %x c %x\n", s, a, c);
    2b7a:	86aa                	mv	a3,a0
    2b7c:	8626                	mv	a2,s1
    2b7e:	85ce                	mv	a1,s3
    2b80:	00004517          	auipc	a0,0x4
    2b84:	4a850513          	addi	a0,a0,1192 # 7028 <malloc+0x1006>
    2b88:	00003097          	auipc	ra,0x3
    2b8c:	3dc080e7          	jalr	988(ra) # 5f64 <printf>
    exit(1);
    2b90:	4505                	li	a0,1
    2b92:	00003097          	auipc	ra,0x3
    2b96:	04a080e7          	jalr	74(ra) # 5bdc <exit>
    printf("%s: sbrk re-allocation failed, a %x c %x\n", s, a, c);
    2b9a:	86d2                	mv	a3,s4
    2b9c:	8626                	mv	a2,s1
    2b9e:	85ce                	mv	a1,s3
    2ba0:	00004517          	auipc	a0,0x4
    2ba4:	4c850513          	addi	a0,a0,1224 # 7068 <malloc+0x1046>
    2ba8:	00003097          	auipc	ra,0x3
    2bac:	3bc080e7          	jalr	956(ra) # 5f64 <printf>
    exit(1);
    2bb0:	4505                	li	a0,1
    2bb2:	00003097          	auipc	ra,0x3
    2bb6:	02a080e7          	jalr	42(ra) # 5bdc <exit>
    printf("%s: sbrk de-allocation didn't really deallocate\n", s);
    2bba:	85ce                	mv	a1,s3
    2bbc:	00004517          	auipc	a0,0x4
    2bc0:	4dc50513          	addi	a0,a0,1244 # 7098 <malloc+0x1076>
    2bc4:	00003097          	auipc	ra,0x3
    2bc8:	3a0080e7          	jalr	928(ra) # 5f64 <printf>
    exit(1);
    2bcc:	4505                	li	a0,1
    2bce:	00003097          	auipc	ra,0x3
    2bd2:	00e080e7          	jalr	14(ra) # 5bdc <exit>
    printf("%s: sbrk downsize failed, a %x c %x\n", s, a, c);
    2bd6:	86aa                	mv	a3,a0
    2bd8:	8626                	mv	a2,s1
    2bda:	85ce                	mv	a1,s3
    2bdc:	00004517          	auipc	a0,0x4
    2be0:	4f450513          	addi	a0,a0,1268 # 70d0 <malloc+0x10ae>
    2be4:	00003097          	auipc	ra,0x3
    2be8:	380080e7          	jalr	896(ra) # 5f64 <printf>
    exit(1);
    2bec:	4505                	li	a0,1
    2bee:	00003097          	auipc	ra,0x3
    2bf2:	fee080e7          	jalr	-18(ra) # 5bdc <exit>
...
0000000000002bf6 <sbrkarg>:
{
  ...
  a = sbrk(PGSIZE);
    ...
    2c0c:	05c080e7          	jalr	92(ra) # 5c64 <sbrk>
    2c10:	892a                	mv	s2,a0
  fd = open("sbrk", O_CREATE|O_WRONLY);
    2c12:	20100593          	li	a1,513
    2c16:	00004517          	auipc	a0,0x4
    2c1a:	4e250513          	addi	a0,a0,1250 # 70f8 <malloc+0x10d6>
    2c1e:	00003097          	auipc	ra,0x3
    2c22:	ffe080e7          	jalr	-2(ra) # 5c1c <open>
    2c26:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c28:	00004517          	auipc	a0,0x4
    2c2c:	4d050513          	addi	a0,a0,1232 # 70f8 <malloc+0x10d6>
    2c30:	00003097          	auipc	ra,0x3
    2c34:	ffc080e7          	jalr	-4(ra) # 5c2c <unlink>
  if(fd < 0)  {
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    2c46:	fba080e7          	jalr	-70(ra) # 5bfc <write>
    2c4a:	04054663          	bltz	a0,2c96 <sbrkarg+0xa0>
  close(fd);
    2c4e:	8526                	mv	a0,s1
    2c50:	00003097          	auipc	ra,0x3
    2c54:	fb4080e7          	jalr	-76(ra) # 5c04 <close>
  a = sbrk(PGSIZE);
    2c58:	6505                	lui	a0,0x1
    2c5a:	00003097          	auipc	ra,0x3
    2c5e:	00a080e7          	jalr	10(ra) # 5c64 <sbrk>
  if(pipe((int *) a) != 0){
    2c62:	00003097          	auipc	ra,0x3
    2c66:	f8a080e7          	jalr	-118(ra) # 5bec <pipe>
    ...
    2c80:	48450513          	addi	a0,a0,1156 # 7100 <malloc+0x10de>
    2c84:	00003097          	auipc	ra,0x3
    2c88:	2e0080e7          	jalr	736(ra) # 5f64 <printf>
    exit(1);
    2c8c:	4505                	li	a0,1
    2c8e:	00003097          	auipc	ra,0x3
    2c92:	f4e080e7          	jalr	-178(ra) # 5bdc <exit>
    printf("%s: write sbrk failed\n", s);
    2c96:	85ce                	mv	a1,s3
    2c98:	00004517          	auipc	a0,0x4
    2c9c:	48050513          	addi	a0,a0,1152 # 7118 <malloc+0x10f6>
    2ca0:	00003097          	auipc	ra,0x3
    2ca4:	2c4080e7          	jalr	708(ra) # 5f64 <printf>
    exit(1);
    2ca8:	4505                	li	a0,1
    2caa:	00003097          	auipc	ra,0x3
    2cae:	f32080e7          	jalr	-206(ra) # 5bdc <exit>
    printf("%s: pipe() failed\n", s);
    2cb2:	85ce                	mv	a1,s3
    2cb4:	00004517          	auipc	a0,0x4
    2cb8:	e4450513          	addi	a0,a0,-444 # 6af8 <malloc+0xad6>
    2cbc:	00003097          	auipc	ra,0x3
    2cc0:	2a8080e7          	jalr	680(ra) # 5f64 <printf>
    exit(1);
    2cc4:	4505                	li	a0,1
    2cc6:	00003097          	auipc	ra,0x3
    2cca:	f16080e7          	jalr	-234(ra) # 5bdc <exit>
...
0000000000002cce <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2ce2:	45250513          	addi	a0,a0,1106 # 7130 <malloc+0x110e>
    2ce6:	00003097          	auipc	ra,0x3
    2cea:	f36080e7          	jalr	-202(ra) # 5c1c <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    2cfa:	f6e080e7          	jalr	-146(ra) # 5c64 <sbrk>
    2cfe:	567d                	li	a2,-1
    2d00:	fff50593          	addi	a1,a0,-1
    2d04:	8526                	mv	a0,s1
    2d06:	00003097          	auipc	ra,0x3
    2d0a:	eee080e7          	jalr	-274(ra) # 5bf4 <read>
  close(fd);
    2d0e:	8526                	mv	a0,s1
    2d10:	00003097          	auipc	ra,0x3
    2d14:	ef4080e7          	jalr	-268(ra) # 5c04 <close>
}
    ...
    2d2a:	ce250513          	addi	a0,a0,-798 # 6a08 <malloc+0x9e6>
    2d2e:	00003097          	auipc	ra,0x3
    2d32:	236080e7          	jalr	566(ra) # 5f64 <printf>
    exit(1);
    2d36:	4505                	li	a0,1
    2d38:	00003097          	auipc	ra,0x3
    2d3c:	ea4080e7          	jalr	-348(ra) # 5bdc <exit>
...
0000000000002d40 <sbrkbugs>:
{
  ...
  int pid = fork();
    ...
    2d4c:	e8c080e7          	jalr	-372(ra) # 5bd4 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2d5a:	f0e080e7          	jalr	-242(ra) # 5c64 <sbrk>
    sbrk(-sz);
    2d5e:	40a0053b          	negw	a0,a0
    2d62:	00003097          	auipc	ra,0x3
    2d66:	f02080e7          	jalr	-254(ra) # 5c64 <sbrk>
    exit(0);
    2d6a:	4501                	li	a0,0
    2d6c:	00003097          	auipc	ra,0x3
    2d70:	e70080e7          	jalr	-400(ra) # 5bdc <exit>
    printf("fork failed\n");
    2d74:	00004517          	auipc	a0,0x4
    2d78:	08450513          	addi	a0,a0,132 # 6df8 <malloc+0xdd6>
    2d7c:	00003097          	auipc	ra,0x3
    2d80:	1e8080e7          	jalr	488(ra) # 5f64 <printf>
    exit(1);
    2d84:	4505                	li	a0,1
    2d86:	00003097          	auipc	ra,0x3
    2d8a:	e56080e7          	jalr	-426(ra) # 5bdc <exit>
  wait(0);
    2d8e:	4501                	li	a0,0
    2d90:	00003097          	auipc	ra,0x3
    2d94:	e54080e7          	jalr	-428(ra) # 5be4 <wait>
  pid = fork();
    2d98:	00003097          	auipc	ra,0x3
    2d9c:	e3c080e7          	jalr	-452(ra) # 5bd4 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2daa:	ebe080e7          	jalr	-322(ra) # 5c64 <sbrk>
    sbrk(-(sz - 3500));
    2dae:	6785                	lui	a5,0x1
    2db0:	dac7879b          	addiw	a5,a5,-596
    2db4:	40a7853b          	subw	a0,a5,a0
    2db8:	00003097          	auipc	ra,0x3
    2dbc:	eac080e7          	jalr	-340(ra) # 5c64 <sbrk>
    exit(0);
    2dc0:	4501                	li	a0,0
    2dc2:	00003097          	auipc	ra,0x3
    2dc6:	e1a080e7          	jalr	-486(ra) # 5bdc <exit>
    printf("fork failed\n");
    2dca:	00004517          	auipc	a0,0x4
    2dce:	02e50513          	addi	a0,a0,46 # 6df8 <malloc+0xdd6>
    2dd2:	00003097          	auipc	ra,0x3
    2dd6:	192080e7          	jalr	402(ra) # 5f64 <printf>
    exit(1);
    2dda:	4505                	li	a0,1
    2ddc:	00003097          	auipc	ra,0x3
    2de0:	e00080e7          	jalr	-512(ra) # 5bdc <exit>
  wait(0);
    2de4:	4501                	li	a0,0
    2de6:	00003097          	auipc	ra,0x3
    2dea:	dfe080e7          	jalr	-514(ra) # 5be4 <wait>
  pid = fork();
    2dee:	00003097          	auipc	ra,0x3
    2df2:	de6080e7          	jalr	-538(ra) # 5bd4 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2e00:	e68080e7          	jalr	-408(ra) # 5c64 <sbrk>
    2e04:	67ad                	lui	a5,0xb
    2e06:	8007879b          	addiw	a5,a5,-2048
    2e0a:	40a7853b          	subw	a0,a5,a0
    2e0e:	00003097          	auipc	ra,0x3
    2e12:	e56080e7          	jalr	-426(ra) # 5c64 <sbrk>
    sbrk(-10);
    2e16:	5559                	li	a0,-10
    2e18:	00003097          	auipc	ra,0x3
    2e1c:	e4c080e7          	jalr	-436(ra) # 5c64 <sbrk>
    exit(0);
    2e20:	4501                	li	a0,0
    2e22:	00003097          	auipc	ra,0x3
    2e26:	dba080e7          	jalr	-582(ra) # 5bdc <exit>
    printf("fork failed\n");
    2e2a:	00004517          	auipc	a0,0x4
    2e2e:	fce50513          	addi	a0,a0,-50 # 6df8 <malloc+0xdd6>
    2e32:	00003097          	auipc	ra,0x3
    2e36:	132080e7          	jalr	306(ra) # 5f64 <printf>
    exit(1);
    2e3a:	4505                	li	a0,1
    2e3c:	00003097          	auipc	ra,0x3
    2e40:	da0080e7          	jalr	-608(ra) # 5bdc <exit>
  wait(0);
    2e44:	4501                	li	a0,0
    2e46:	00003097          	auipc	ra,0x3
    2e4a:	d9e080e7          	jalr	-610(ra) # 5be4 <wait>
  exit(0);
    2e4e:	4501                	li	a0,0
    2e50:	00003097          	auipc	ra,0x3
    2e54:	d8c080e7          	jalr	-628(ra) # 5bdc <exit>
...
0000000000002e58 <sbrklast>:
{
  ...
  uint64 top = (uint64) sbrk(0);
    ...
    2e6e:	dfa080e7          	jalr	-518(ra) # 5c64 <sbrk>
  if((top % 4096) != 0)
  ...
  sbrk(4096);
    ...
    2e7e:	dea080e7          	jalr	-534(ra) # 5c64 <sbrk>
  sbrk(10);
    2e82:	4529                	li	a0,10
    2e84:	00003097          	auipc	ra,0x3
    2e88:	de0080e7          	jalr	-544(ra) # 5c64 <sbrk>
  sbrk(-20);
    2e8c:	5531                	li	a0,-20
    2e8e:	00003097          	auipc	ra,0x3
    2e92:	dd6080e7          	jalr	-554(ra) # 5c64 <sbrk>
  top = (uint64) sbrk(0);
    2e96:	4501                	li	a0,0
    2e98:	00003097          	auipc	ra,0x3
    2e9c:	dcc080e7          	jalr	-564(ra) # 5c64 <sbrk>
    2ea0:	84aa                	mv	s1,a0
  char *p = (char *) (top - 64);
  ...
  int fd = open(p, O_RDWR|O_CREATE);
    ...
    2ebc:	d64080e7          	jalr	-668(ra) # 5c1c <open>
    2ec0:	89aa                	mv	s3,a0
  write(fd, p, 1);
    2ec2:	4605                	li	a2,1
    2ec4:	85ca                	mv	a1,s2
    2ec6:	00003097          	auipc	ra,0x3
    2eca:	d36080e7          	jalr	-714(ra) # 5bfc <write>
  close(fd);
    2ece:	854e                	mv	a0,s3
    2ed0:	00003097          	auipc	ra,0x3
    2ed4:	d34080e7          	jalr	-716(ra) # 5c04 <close>
  fd = open(p, O_RDWR);
    2ed8:	4589                	li	a1,2
    2eda:	854a                	mv	a0,s2
    2edc:	00003097          	auipc	ra,0x3
    2ee0:	d40080e7          	jalr	-704(ra) # 5c1c <open>
  p[0] = '\0';
  ...
  read(fd, p, 1);
    ...
    2ef0:	d08080e7          	jalr	-760(ra) # 5bf4 <read>
  if(p[0] != 'x')
    ...
    2f1a:	d4e080e7          	jalr	-690(ra) # 5c64 <sbrk>
    2f1e:	bfa9                	j	2e78 <sbrklast+0x20>
    exit(1);
    2f20:	4505                	li	a0,1
    2f22:	00003097          	auipc	ra,0x3
    2f26:	cba080e7          	jalr	-838(ra) # 5bdc <exit>
...
0000000000002f2a <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2f3c:	d2c080e7          	jalr	-724(ra) # 5c64 <sbrk>
  volatile char *top = sbrk(0);
    2f40:	4501                	li	a0,0
    2f42:	00003097          	auipc	ra,0x3
    2f46:	d22080e7          	jalr	-734(ra) # 5c64 <sbrk>
  *(top-1) = *(top-1) + 1;
...
0000000000002f60 <execout>:
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    2f78:	c60080e7          	jalr	-928(ra) # 5bd4 <fork>
    2f7c:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    2f8a:	c5e080e7          	jalr	-930(ra) # 5be4 <wait>
  for(int avail = 0; avail < 15; avail++){
  ...
  exit(0);
    ...
    2f9a:	c46080e7          	jalr	-954(ra) # 5bdc <exit>
      printf("fork failed\n");
    2f9e:	00004517          	auipc	a0,0x4
    2fa2:	e5a50513          	addi	a0,a0,-422 # 6df8 <malloc+0xdd6>
    2fa6:	00003097          	auipc	ra,0x3
    2faa:	fbe080e7          	jalr	-66(ra) # 5f64 <printf>
      exit(1);
    2fae:	4505                	li	a0,1
    2fb0:	00003097          	auipc	ra,0x3
    2fb4:	c2c080e7          	jalr	-980(ra) # 5bdc <exit>
        if(a == 0xffffffffffffffffLL)
    2fb8:	59fd                	li	s3,-1
        *(char*)(a + 4096 - 1) = 1;
    2fba:	4a05                	li	s4,1
    ...
    2fc2:	ca6080e7          	jalr	-858(ra) # 5c64 <sbrk>
        if(a == 0xffffffffffffffffLL)
    ...
    2fde:	c8a080e7          	jalr	-886(ra) # 5c64 <sbrk>
      for(int i = 0; i < avail; i++)
...
0000000000003024 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3034:	2d850513          	addi	a0,a0,728 # 7308 <malloc+0x12e6>
    3038:	00003097          	auipc	ra,0x3
    303c:	c0c080e7          	jalr	-1012(ra) # 5c44 <mkdir>
    3040:	e165                	bnez	a0,3120 <fourteen+0xfc>
  if(mkdir("12345678901234/123456789012345") != 0){
    3042:	00004517          	auipc	a0,0x4
    3046:	11e50513          	addi	a0,a0,286 # 7160 <malloc+0x113e>
    304a:	00003097          	auipc	ra,0x3
    304e:	bfa080e7          	jalr	-1030(ra) # 5c44 <mkdir>
    3052:	e56d                	bnez	a0,313c <fourteen+0x118>
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    3054:	20000593          	li	a1,512
    3058:	00004517          	auipc	a0,0x4
    305c:	16050513          	addi	a0,a0,352 # 71b8 <malloc+0x1196>
    3060:	00003097          	auipc	ra,0x3
    3064:	bbc080e7          	jalr	-1092(ra) # 5c1c <open>
  if(fd < 0){
    3068:	0e054863          	bltz	a0,3158 <fourteen+0x134>
  close(fd);
    306c:	00003097          	auipc	ra,0x3
    3070:	b98080e7          	jalr	-1128(ra) # 5c04 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    3074:	4581                	li	a1,0
    3076:	00004517          	auipc	a0,0x4
    307a:	1ba50513          	addi	a0,a0,442 # 7230 <malloc+0x120e>
    307e:	00003097          	auipc	ra,0x3
    3082:	b9e080e7          	jalr	-1122(ra) # 5c1c <open>
  if(fd < 0){
    3086:	0e054763          	bltz	a0,3174 <fourteen+0x150>
  close(fd);
    308a:	00003097          	auipc	ra,0x3
    308e:	b7a080e7          	jalr	-1158(ra) # 5c04 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    3092:	00004517          	auipc	a0,0x4
    3096:	20e50513          	addi	a0,a0,526 # 72a0 <malloc+0x127e>
    309a:	00003097          	auipc	ra,0x3
    309e:	baa080e7          	jalr	-1110(ra) # 5c44 <mkdir>
    30a2:	c57d                	beqz	a0,3190 <fourteen+0x16c>
  if(mkdir("123456789012345/12345678901234") == 0){
    30a4:	00004517          	auipc	a0,0x4
    30a8:	25450513          	addi	a0,a0,596 # 72f8 <malloc+0x12d6>
    30ac:	00003097          	auipc	ra,0x3
    30b0:	b98080e7          	jalr	-1128(ra) # 5c44 <mkdir>
    30b4:	cd65                	beqz	a0,31ac <fourteen+0x188>
  unlink("123456789012345/12345678901234");
    30b6:	00004517          	auipc	a0,0x4
    30ba:	24250513          	addi	a0,a0,578 # 72f8 <malloc+0x12d6>
    30be:	00003097          	auipc	ra,0x3
    30c2:	b6e080e7          	jalr	-1170(ra) # 5c2c <unlink>
  unlink("12345678901234/12345678901234");
    30c6:	00004517          	auipc	a0,0x4
    30ca:	1da50513          	addi	a0,a0,474 # 72a0 <malloc+0x127e>
    30ce:	00003097          	auipc	ra,0x3
    30d2:	b5e080e7          	jalr	-1186(ra) # 5c2c <unlink>
  unlink("12345678901234/12345678901234/12345678901234");
    30d6:	00004517          	auipc	a0,0x4
    30da:	15a50513          	addi	a0,a0,346 # 7230 <malloc+0x120e>
    30de:	00003097          	auipc	ra,0x3
    30e2:	b4e080e7          	jalr	-1202(ra) # 5c2c <unlink>
  unlink("123456789012345/123456789012345/123456789012345");
    30e6:	00004517          	auipc	a0,0x4
    30ea:	0d250513          	addi	a0,a0,210 # 71b8 <malloc+0x1196>
    30ee:	00003097          	auipc	ra,0x3
    30f2:	b3e080e7          	jalr	-1218(ra) # 5c2c <unlink>
  unlink("12345678901234/123456789012345");
    30f6:	00004517          	auipc	a0,0x4
    30fa:	06a50513          	addi	a0,a0,106 # 7160 <malloc+0x113e>
    30fe:	00003097          	auipc	ra,0x3
    3102:	b2e080e7          	jalr	-1234(ra) # 5c2c <unlink>
  unlink("12345678901234");
    3106:	00004517          	auipc	a0,0x4
    310a:	20250513          	addi	a0,a0,514 # 7308 <malloc+0x12e6>
    310e:	00003097          	auipc	ra,0x3
    3112:	b1e080e7          	jalr	-1250(ra) # 5c2c <unlink>
}
    ...
    3126:	01650513          	addi	a0,a0,22 # 7138 <malloc+0x1116>
    312a:	00003097          	auipc	ra,0x3
    312e:	e3a080e7          	jalr	-454(ra) # 5f64 <printf>
    exit(1);
    3132:	4505                	li	a0,1
    3134:	00003097          	auipc	ra,0x3
    3138:	aa8080e7          	jalr	-1368(ra) # 5bdc <exit>
    printf("%s: mkdir 12345678901234/123456789012345 failed\n", s);
    313c:	85a6                	mv	a1,s1
    313e:	00004517          	auipc	a0,0x4
    3142:	04250513          	addi	a0,a0,66 # 7180 <malloc+0x115e>
    3146:	00003097          	auipc	ra,0x3
    314a:	e1e080e7          	jalr	-482(ra) # 5f64 <printf>
    exit(1);
    314e:	4505                	li	a0,1
    3150:	00003097          	auipc	ra,0x3
    3154:	a8c080e7          	jalr	-1396(ra) # 5bdc <exit>
    printf("%s: create 123456789012345/123456789012345/123456789012345 failed\n", s);
    3158:	85a6                	mv	a1,s1
    315a:	00004517          	auipc	a0,0x4
    315e:	08e50513          	addi	a0,a0,142 # 71e8 <malloc+0x11c6>
    3162:	00003097          	auipc	ra,0x3
    3166:	e02080e7          	jalr	-510(ra) # 5f64 <printf>
    exit(1);
    316a:	4505                	li	a0,1
    316c:	00003097          	auipc	ra,0x3
    3170:	a70080e7          	jalr	-1424(ra) # 5bdc <exit>
    printf("%s: open 12345678901234/12345678901234/12345678901234 failed\n", s);
    3174:	85a6                	mv	a1,s1
    3176:	00004517          	auipc	a0,0x4
    317a:	0ea50513          	addi	a0,a0,234 # 7260 <malloc+0x123e>
    317e:	00003097          	auipc	ra,0x3
    3182:	de6080e7          	jalr	-538(ra) # 5f64 <printf>
    exit(1);
    3186:	4505                	li	a0,1
    3188:	00003097          	auipc	ra,0x3
    318c:	a54080e7          	jalr	-1452(ra) # 5bdc <exit>
    printf("%s: mkdir 12345678901234/12345678901234 succeeded!\n", s);
    3190:	85a6                	mv	a1,s1
    3192:	00004517          	auipc	a0,0x4
    3196:	12e50513          	addi	a0,a0,302 # 72c0 <malloc+0x129e>
    319a:	00003097          	auipc	ra,0x3
    319e:	dca080e7          	jalr	-566(ra) # 5f64 <printf>
    exit(1);
    31a2:	4505                	li	a0,1
    31a4:	00003097          	auipc	ra,0x3
    31a8:	a38080e7          	jalr	-1480(ra) # 5bdc <exit>
    printf("%s: mkdir 12345678901234/123456789012345 succeeded!\n", s);
    31ac:	85a6                	mv	a1,s1
    31ae:	00004517          	auipc	a0,0x4
    31b2:	16a50513          	addi	a0,a0,362 # 7318 <malloc+0x12f6>
    31b6:	00003097          	auipc	ra,0x3
    31ba:	dae080e7          	jalr	-594(ra) # 5f64 <printf>
    exit(1);
    31be:	4505                	li	a0,1
    31c0:	00003097          	auipc	ra,0x3
    31c4:	a1c080e7          	jalr	-1508(ra) # 5bdc <exit>
...
00000000000031c8 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31fe:	15650513          	addi	a0,a0,342 # 7350 <malloc+0x132e>
    3202:	00003097          	auipc	ra,0x3
    3206:	a2a080e7          	jalr	-1494(ra) # 5c2c <unlink>
  for(fi = 0; done == 0; fi++){
    320a:	4a01                	li	s4,0
    name[0] = 'b';
    ...
    3228:	13c50513          	addi	a0,a0,316 # 7360 <malloc+0x133e>
    322c:	00003097          	auipc	ra,0x3
    3230:	d38080e7          	jalr	-712(ra) # 5f64 <printf>
      break;
    3234:	a821                	j	324c <diskfull+0x84>
        close(fd);
    3236:	854a                	mv	a0,s2
    3238:	00003097          	auipc	ra,0x3
    323c:	9cc080e7          	jalr	-1588(ra) # 5c04 <close>
    close(fd);
    3240:	854a                	mv	a0,s2
    3242:	00003097          	auipc	ra,0x3
    3246:	9c2080e7          	jalr	-1598(ra) # 5c04 <close>
  for(fi = 0; done == 0; fi++){
  ...
  for(int i = 0; i < nzz; i++){
    ...
    331a:	916080e7          	jalr	-1770(ra) # 5c2c <unlink>
  for(int i = 0; i < nzz; i++){
  ...
  for(int i = 0; i < fi; i++){
    ...
    3356:	8da080e7          	jalr	-1830(ra) # 5c2c <unlink>
  for(int i = 0; i < fi; i++){
    ...
    3394:	874080e7          	jalr	-1932(ra) # 5c04 <close>
  for(fi = 0; done == 0; fi++){
    ...
    33e4:	81c080e7          	jalr	-2020(ra) # 5bfc <write>
    ...
    33fa:	f8a50513          	addi	a0,a0,-118 # 7380 <malloc+0x135e>
    33fe:	00003097          	auipc	ra,0x3
    3402:	b66080e7          	jalr	-1178(ra) # 5f64 <printf>
...
0000000000003408 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3418:	f9c50513          	addi	a0,a0,-100 # 73b0 <malloc+0x138e>
    341c:	00003097          	auipc	ra,0x3
    3420:	828080e7          	jalr	-2008(ra) # 5c44 <mkdir>
    3424:	04054563          	bltz	a0,346e <iputtest+0x66>
  if(chdir("iputdir") < 0){
    3428:	00004517          	auipc	a0,0x4
    342c:	f8850513          	addi	a0,a0,-120 # 73b0 <malloc+0x138e>
    3430:	00003097          	auipc	ra,0x3
    3434:	81c080e7          	jalr	-2020(ra) # 5c4c <chdir>
    3438:	04054963          	bltz	a0,348a <iputtest+0x82>
  if(unlink("../iputdir") < 0){
    343c:	00004517          	auipc	a0,0x4
    3440:	fb450513          	addi	a0,a0,-76 # 73f0 <malloc+0x13ce>
    3444:	00002097          	auipc	ra,0x2
    3448:	7e8080e7          	jalr	2024(ra) # 5c2c <unlink>
    344c:	04054d63          	bltz	a0,34a6 <iputtest+0x9e>
  if(chdir("/") < 0){
    3450:	00004517          	auipc	a0,0x4
    3454:	fd050513          	addi	a0,a0,-48 # 7420 <malloc+0x13fe>
    3458:	00002097          	auipc	ra,0x2
    345c:	7f4080e7          	jalr	2036(ra) # 5c4c <chdir>
    ...
    3474:	f4850513          	addi	a0,a0,-184 # 73b8 <malloc+0x1396>
    3478:	00003097          	auipc	ra,0x3
    347c:	aec080e7          	jalr	-1300(ra) # 5f64 <printf>
    exit(1);
    3480:	4505                	li	a0,1
    3482:	00002097          	auipc	ra,0x2
    3486:	75a080e7          	jalr	1882(ra) # 5bdc <exit>
    printf("%s: chdir iputdir failed\n", s);
    348a:	85a6                	mv	a1,s1
    348c:	00004517          	auipc	a0,0x4
    3490:	f4450513          	addi	a0,a0,-188 # 73d0 <malloc+0x13ae>
    3494:	00003097          	auipc	ra,0x3
    3498:	ad0080e7          	jalr	-1328(ra) # 5f64 <printf>
    exit(1);
    349c:	4505                	li	a0,1
    349e:	00002097          	auipc	ra,0x2
    34a2:	73e080e7          	jalr	1854(ra) # 5bdc <exit>
    printf("%s: unlink ../iputdir failed\n", s);
    34a6:	85a6                	mv	a1,s1
    34a8:	00004517          	auipc	a0,0x4
    34ac:	f5850513          	addi	a0,a0,-168 # 7400 <malloc+0x13de>
    34b0:	00003097          	auipc	ra,0x3
    34b4:	ab4080e7          	jalr	-1356(ra) # 5f64 <printf>
    exit(1);
    34b8:	4505                	li	a0,1
    34ba:	00002097          	auipc	ra,0x2
    34be:	722080e7          	jalr	1826(ra) # 5bdc <exit>
    printf("%s: chdir / failed\n", s);
    34c2:	85a6                	mv	a1,s1
    34c4:	00004517          	auipc	a0,0x4
    34c8:	f6450513          	addi	a0,a0,-156 # 7428 <malloc+0x1406>
    34cc:	00003097          	auipc	ra,0x3
    34d0:	a98080e7          	jalr	-1384(ra) # 5f64 <printf>
    exit(1);
    34d4:	4505                	li	a0,1
    34d6:	00002097          	auipc	ra,0x2
    34da:	706080e7          	jalr	1798(ra) # 5bdc <exit>
...
00000000000034de <exitiputtest>:
{
  ...
  pid = fork();
    ...
    34ee:	6ea080e7          	jalr	1770(ra) # 5bd4 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    34fc:	eb850513          	addi	a0,a0,-328 # 73b0 <malloc+0x138e>
    3500:	00002097          	auipc	ra,0x2
    3504:	744080e7          	jalr	1860(ra) # 5c44 <mkdir>
    3508:	04054963          	bltz	a0,355a <exitiputtest+0x7c>
    if(chdir("iputdir") < 0){
    350c:	00004517          	auipc	a0,0x4
    3510:	ea450513          	addi	a0,a0,-348 # 73b0 <malloc+0x138e>
    3514:	00002097          	auipc	ra,0x2
    3518:	738080e7          	jalr	1848(ra) # 5c4c <chdir>
    351c:	04054d63          	bltz	a0,3576 <exitiputtest+0x98>
    if(unlink("../iputdir") < 0){
    3520:	00004517          	auipc	a0,0x4
    3524:	ed050513          	addi	a0,a0,-304 # 73f0 <malloc+0x13ce>
    3528:	00002097          	auipc	ra,0x2
    352c:	704080e7          	jalr	1796(ra) # 5c2c <unlink>
    3530:	06054163          	bltz	a0,3592 <exitiputtest+0xb4>
    exit(0);
    3534:	4501                	li	a0,0
    3536:	00002097          	auipc	ra,0x2
    353a:	6a6080e7          	jalr	1702(ra) # 5bdc <exit>
    printf("%s: fork failed\n", s);
    353e:	85a6                	mv	a1,s1
    3540:	00003517          	auipc	a0,0x3
    3544:	4b050513          	addi	a0,a0,1200 # 69f0 <malloc+0x9ce>
    3548:	00003097          	auipc	ra,0x3
    354c:	a1c080e7          	jalr	-1508(ra) # 5f64 <printf>
    exit(1);
    3550:	4505                	li	a0,1
    3552:	00002097          	auipc	ra,0x2
    3556:	68a080e7          	jalr	1674(ra) # 5bdc <exit>
      printf("%s: mkdir failed\n", s);
    355a:	85a6                	mv	a1,s1
    355c:	00004517          	auipc	a0,0x4
    3560:	e5c50513          	addi	a0,a0,-420 # 73b8 <malloc+0x1396>
    3564:	00003097          	auipc	ra,0x3
    3568:	a00080e7          	jalr	-1536(ra) # 5f64 <printf>
      exit(1);
    356c:	4505                	li	a0,1
    356e:	00002097          	auipc	ra,0x2
    3572:	66e080e7          	jalr	1646(ra) # 5bdc <exit>
      printf("%s: child chdir failed\n", s);
    3576:	85a6                	mv	a1,s1
    3578:	00004517          	auipc	a0,0x4
    357c:	ec850513          	addi	a0,a0,-312 # 7440 <malloc+0x141e>
    3580:	00003097          	auipc	ra,0x3
    3584:	9e4080e7          	jalr	-1564(ra) # 5f64 <printf>
      exit(1);
    3588:	4505                	li	a0,1
    358a:	00002097          	auipc	ra,0x2
    358e:	652080e7          	jalr	1618(ra) # 5bdc <exit>
      printf("%s: unlink ../iputdir failed\n", s);
    3592:	85a6                	mv	a1,s1
    3594:	00004517          	auipc	a0,0x4
    3598:	e6c50513          	addi	a0,a0,-404 # 7400 <malloc+0x13de>
    359c:	00003097          	auipc	ra,0x3
    35a0:	9c8080e7          	jalr	-1592(ra) # 5f64 <printf>
      exit(1);
    35a4:	4505                	li	a0,1
    35a6:	00002097          	auipc	ra,0x2
    35aa:	636080e7          	jalr	1590(ra) # 5bdc <exit>
  wait(&xstatus);
    35ae:	fdc40513          	addi	a0,s0,-36
    35b2:	00002097          	auipc	ra,0x2
    35b6:	632080e7          	jalr	1586(ra) # 5be4 <wait>
  exit(xstatus);
    35ba:	fdc42503          	lw	a0,-36(s0)
    35be:	00002097          	auipc	ra,0x2
    35c2:	61e080e7          	jalr	1566(ra) # 5bdc <exit>
...
00000000000035c6 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d6:	e8650513          	addi	a0,a0,-378 # 7458 <malloc+0x1436>
    35da:	00002097          	auipc	ra,0x2
    35de:	66a080e7          	jalr	1642(ra) # 5c44 <mkdir>
    35e2:	04054563          	bltz	a0,362c <dirtest+0x66>
  if(chdir("dir0") < 0){
    35e6:	00004517          	auipc	a0,0x4
    35ea:	e7250513          	addi	a0,a0,-398 # 7458 <malloc+0x1436>
    35ee:	00002097          	auipc	ra,0x2
    35f2:	65e080e7          	jalr	1630(ra) # 5c4c <chdir>
    35f6:	04054963          	bltz	a0,3648 <dirtest+0x82>
  if(chdir("..") < 0){
    35fa:	00004517          	auipc	a0,0x4
    35fe:	e7e50513          	addi	a0,a0,-386 # 7478 <malloc+0x1456>
    3602:	00002097          	auipc	ra,0x2
    3606:	64a080e7          	jalr	1610(ra) # 5c4c <chdir>
    360a:	04054d63          	bltz	a0,3664 <dirtest+0x9e>
  if(unlink("dir0") < 0){
    360e:	00004517          	auipc	a0,0x4
    3612:	e4a50513          	addi	a0,a0,-438 # 7458 <malloc+0x1436>
    3616:	00002097          	auipc	ra,0x2
    361a:	616080e7          	jalr	1558(ra) # 5c2c <unlink>
    ...
    3632:	d8a50513          	addi	a0,a0,-630 # 73b8 <malloc+0x1396>
    3636:	00003097          	auipc	ra,0x3
    363a:	92e080e7          	jalr	-1746(ra) # 5f64 <printf>
    exit(1);
    363e:	4505                	li	a0,1
    3640:	00002097          	auipc	ra,0x2
    3644:	59c080e7          	jalr	1436(ra) # 5bdc <exit>
    printf("%s: chdir dir0 failed\n", s);
    3648:	85a6                	mv	a1,s1
    364a:	00004517          	auipc	a0,0x4
    364e:	e1650513          	addi	a0,a0,-490 # 7460 <malloc+0x143e>
    3652:	00003097          	auipc	ra,0x3
    3656:	912080e7          	jalr	-1774(ra) # 5f64 <printf>
    exit(1);
    365a:	4505                	li	a0,1
    365c:	00002097          	auipc	ra,0x2
    3660:	580080e7          	jalr	1408(ra) # 5bdc <exit>
    printf("%s: chdir .. failed\n", s);
    3664:	85a6                	mv	a1,s1
    3666:	00004517          	auipc	a0,0x4
    366a:	e1a50513          	addi	a0,a0,-486 # 7480 <malloc+0x145e>
    366e:	00003097          	auipc	ra,0x3
    3672:	8f6080e7          	jalr	-1802(ra) # 5f64 <printf>
    exit(1);
    3676:	4505                	li	a0,1
    3678:	00002097          	auipc	ra,0x2
    367c:	564080e7          	jalr	1380(ra) # 5bdc <exit>
    printf("%s: unlink dir0 failed\n", s);
    3680:	85a6                	mv	a1,s1
    3682:	00004517          	auipc	a0,0x4
    3686:	e1650513          	addi	a0,a0,-490 # 7498 <malloc+0x1476>
    368a:	00003097          	auipc	ra,0x3
    368e:	8da080e7          	jalr	-1830(ra) # 5f64 <printf>
    exit(1);
    3692:	4505                	li	a0,1
    3694:	00002097          	auipc	ra,0x2
    3698:	548080e7          	jalr	1352(ra) # 5bdc <exit>
...
000000000000369c <subdir>:
{
  ...
  unlink("ff");
    ...
    36ae:	f3650513          	addi	a0,a0,-202 # 75e0 <malloc+0x15be>
    36b2:	00002097          	auipc	ra,0x2
    36b6:	57a080e7          	jalr	1402(ra) # 5c2c <unlink>
  if(mkdir("dd") != 0){
    36ba:	00004517          	auipc	a0,0x4
    36be:	df650513          	addi	a0,a0,-522 # 74b0 <malloc+0x148e>
    36c2:	00002097          	auipc	ra,0x2
    36c6:	582080e7          	jalr	1410(ra) # 5c44 <mkdir>
    36ca:	38051663          	bnez	a0,3a56 <subdir+0x3ba>
  fd = open("dd/ff", O_CREATE | O_RDWR);
    36ce:	20200593          	li	a1,514
    36d2:	00004517          	auipc	a0,0x4
    36d6:	dfe50513          	addi	a0,a0,-514 # 74d0 <malloc+0x14ae>
    36da:	00002097          	auipc	ra,0x2
    36de:	542080e7          	jalr	1346(ra) # 5c1c <open>
    36e2:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    36ee:	ef658593          	addi	a1,a1,-266 # 75e0 <malloc+0x15be>
    36f2:	00002097          	auipc	ra,0x2
    36f6:	50a080e7          	jalr	1290(ra) # 5bfc <write>
  close(fd);
    36fa:	8526                	mv	a0,s1
    36fc:	00002097          	auipc	ra,0x2
    3700:	508080e7          	jalr	1288(ra) # 5c04 <close>
  if(unlink("dd") >= 0){
    3704:	00004517          	auipc	a0,0x4
    3708:	dac50513          	addi	a0,a0,-596 # 74b0 <malloc+0x148e>
    370c:	00002097          	auipc	ra,0x2
    3710:	520080e7          	jalr	1312(ra) # 5c2c <unlink>
    3714:	36055d63          	bgez	a0,3a8e <subdir+0x3f2>
  if(mkdir("/dd/dd") != 0){
    3718:	00004517          	auipc	a0,0x4
    371c:	e1050513          	addi	a0,a0,-496 # 7528 <malloc+0x1506>
    3720:	00002097          	auipc	ra,0x2
    3724:	524080e7          	jalr	1316(ra) # 5c44 <mkdir>
    3728:	38051163          	bnez	a0,3aaa <subdir+0x40e>
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    372c:	20200593          	li	a1,514
    3730:	00004517          	auipc	a0,0x4
    3734:	e2050513          	addi	a0,a0,-480 # 7550 <malloc+0x152e>
    3738:	00002097          	auipc	ra,0x2
    373c:	4e4080e7          	jalr	1252(ra) # 5c1c <open>
    3740:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    374c:	e3858593          	addi	a1,a1,-456 # 7580 <malloc+0x155e>
    3750:	00002097          	auipc	ra,0x2
    3754:	4ac080e7          	jalr	1196(ra) # 5bfc <write>
  close(fd);
    3758:	8526                	mv	a0,s1
    375a:	00002097          	auipc	ra,0x2
    375e:	4aa080e7          	jalr	1194(ra) # 5c04 <close>
  fd = open("dd/dd/../ff", 0);
    3762:	4581                	li	a1,0
    3764:	00004517          	auipc	a0,0x4
    3768:	e2450513          	addi	a0,a0,-476 # 7588 <malloc+0x1566>
    376c:	00002097          	auipc	ra,0x2
    3770:	4b0080e7          	jalr	1200(ra) # 5c1c <open>
    3774:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3788:	470080e7          	jalr	1136(ra) # 5bf4 <read>
  if(cc != 2 || buf[0] != 'f'){
    378c:	4789                	li	a5,2
  ...
  close(fd);
    ...
    37a8:	460080e7          	jalr	1120(ra) # 5c04 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    37ac:	00004597          	auipc	a1,0x4
    37b0:	e2c58593          	addi	a1,a1,-468 # 75d8 <malloc+0x15b6>
    37b4:	00004517          	auipc	a0,0x4
    37b8:	d9c50513          	addi	a0,a0,-612 # 7550 <malloc+0x152e>
    37bc:	00002097          	auipc	ra,0x2
    37c0:	480080e7          	jalr	1152(ra) # 5c3c <link>
    37c4:	34051b63          	bnez	a0,3b1a <subdir+0x47e>
  if(unlink("dd/dd/ff") != 0){
    37c8:	00004517          	auipc	a0,0x4
    37cc:	d8850513          	addi	a0,a0,-632 # 7550 <malloc+0x152e>
    37d0:	00002097          	auipc	ra,0x2
    37d4:	45c080e7          	jalr	1116(ra) # 5c2c <unlink>
    37d8:	34051f63          	bnez	a0,3b36 <subdir+0x49a>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    37dc:	4581                	li	a1,0
    37de:	00004517          	auipc	a0,0x4
    37e2:	d7250513          	addi	a0,a0,-654 # 7550 <malloc+0x152e>
    37e6:	00002097          	auipc	ra,0x2
    37ea:	436080e7          	jalr	1078(ra) # 5c1c <open>
    37ee:	36055263          	bgez	a0,3b52 <subdir+0x4b6>
  if(chdir("dd") != 0){
    37f2:	00004517          	auipc	a0,0x4
    37f6:	cbe50513          	addi	a0,a0,-834 # 74b0 <malloc+0x148e>
    37fa:	00002097          	auipc	ra,0x2
    37fe:	452080e7          	jalr	1106(ra) # 5c4c <chdir>
    3802:	36051663          	bnez	a0,3b6e <subdir+0x4d2>
  if(chdir("dd/../../dd") != 0){
    3806:	00004517          	auipc	a0,0x4
    380a:	e6a50513          	addi	a0,a0,-406 # 7670 <malloc+0x164e>
    380e:	00002097          	auipc	ra,0x2
    3812:	43e080e7          	jalr	1086(ra) # 5c4c <chdir>
    3816:	36051a63          	bnez	a0,3b8a <subdir+0x4ee>
  if(chdir("dd/../../../dd") != 0){
    381a:	00004517          	auipc	a0,0x4
    381e:	e8650513          	addi	a0,a0,-378 # 76a0 <malloc+0x167e>
    3822:	00002097          	auipc	ra,0x2
    3826:	42a080e7          	jalr	1066(ra) # 5c4c <chdir>
    382a:	36051e63          	bnez	a0,3ba6 <subdir+0x50a>
  if(chdir("./..") != 0){
    382e:	00004517          	auipc	a0,0x4
    3832:	ea250513          	addi	a0,a0,-350 # 76d0 <malloc+0x16ae>
    3836:	00002097          	auipc	ra,0x2
    383a:	416080e7          	jalr	1046(ra) # 5c4c <chdir>
    383e:	38051263          	bnez	a0,3bc2 <subdir+0x526>
  fd = open("dd/dd/ffff", 0);
    3842:	4581                	li	a1,0
    3844:	00004517          	auipc	a0,0x4
    3848:	d9450513          	addi	a0,a0,-620 # 75d8 <malloc+0x15b6>
    384c:	00002097          	auipc	ra,0x2
    3850:	3d0080e7          	jalr	976(ra) # 5c1c <open>
    3854:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(unlink("dd") < 0){
    ...
    3a5c:	a6050513          	addi	a0,a0,-1440 # 74b8 <malloc+0x1496>
    3a60:	00002097          	auipc	ra,0x2
    3a64:	504080e7          	jalr	1284(ra) # 5f64 <printf>
    exit(1);
    3a68:	4505                	li	a0,1
    3a6a:	00002097          	auipc	ra,0x2
    3a6e:	172080e7          	jalr	370(ra) # 5bdc <exit>
    printf("%s: create dd/ff failed\n", s);
    3a72:	85ca                	mv	a1,s2
    3a74:	00004517          	auipc	a0,0x4
    3a78:	a6450513          	addi	a0,a0,-1436 # 74d8 <malloc+0x14b6>
    3a7c:	00002097          	auipc	ra,0x2
    3a80:	4e8080e7          	jalr	1256(ra) # 5f64 <printf>
    exit(1);
    3a84:	4505                	li	a0,1
    3a86:	00002097          	auipc	ra,0x2
    3a8a:	156080e7          	jalr	342(ra) # 5bdc <exit>
    printf("%s: unlink dd (non-empty dir) succeeded!\n", s);
    3a8e:	85ca                	mv	a1,s2
    3a90:	00004517          	auipc	a0,0x4
    3a94:	a6850513          	addi	a0,a0,-1432 # 74f8 <malloc+0x14d6>
    3a98:	00002097          	auipc	ra,0x2
    3a9c:	4cc080e7          	jalr	1228(ra) # 5f64 <printf>
    exit(1);
    3aa0:	4505                	li	a0,1
    3aa2:	00002097          	auipc	ra,0x2
    3aa6:	13a080e7          	jalr	314(ra) # 5bdc <exit>
    printf("subdir mkdir dd/dd failed\n", s);
    3aaa:	85ca                	mv	a1,s2
    3aac:	00004517          	auipc	a0,0x4
    3ab0:	a8450513          	addi	a0,a0,-1404 # 7530 <malloc+0x150e>
    3ab4:	00002097          	auipc	ra,0x2
    3ab8:	4b0080e7          	jalr	1200(ra) # 5f64 <printf>
    exit(1);
    3abc:	4505                	li	a0,1
    3abe:	00002097          	auipc	ra,0x2
    3ac2:	11e080e7          	jalr	286(ra) # 5bdc <exit>
    printf("%s: create dd/dd/ff failed\n", s);
    3ac6:	85ca                	mv	a1,s2
    3ac8:	00004517          	auipc	a0,0x4
    3acc:	a9850513          	addi	a0,a0,-1384 # 7560 <malloc+0x153e>
    3ad0:	00002097          	auipc	ra,0x2
    3ad4:	494080e7          	jalr	1172(ra) # 5f64 <printf>
    exit(1);
    3ad8:	4505                	li	a0,1
    3ada:	00002097          	auipc	ra,0x2
    3ade:	102080e7          	jalr	258(ra) # 5bdc <exit>
    printf("%s: open dd/dd/../ff failed\n", s);
    3ae2:	85ca                	mv	a1,s2
    3ae4:	00004517          	auipc	a0,0x4
    3ae8:	ab450513          	addi	a0,a0,-1356 # 7598 <malloc+0x1576>
    3aec:	00002097          	auipc	ra,0x2
    3af0:	478080e7          	jalr	1144(ra) # 5f64 <printf>
    exit(1);
    3af4:	4505                	li	a0,1
    3af6:	00002097          	auipc	ra,0x2
    3afa:	0e6080e7          	jalr	230(ra) # 5bdc <exit>
    printf("%s: dd/dd/../ff wrong content\n", s);
    3afe:	85ca                	mv	a1,s2
    3b00:	00004517          	auipc	a0,0x4
    3b04:	ab850513          	addi	a0,a0,-1352 # 75b8 <malloc+0x1596>
    3b08:	00002097          	auipc	ra,0x2
    3b0c:	45c080e7          	jalr	1116(ra) # 5f64 <printf>
    exit(1);
    3b10:	4505                	li	a0,1
    3b12:	00002097          	auipc	ra,0x2
    3b16:	0ca080e7          	jalr	202(ra) # 5bdc <exit>
    printf("link dd/dd/ff dd/dd/ffff failed\n", s);
    3b1a:	85ca                	mv	a1,s2
    3b1c:	00004517          	auipc	a0,0x4
    3b20:	acc50513          	addi	a0,a0,-1332 # 75e8 <malloc+0x15c6>
    3b24:	00002097          	auipc	ra,0x2
    3b28:	440080e7          	jalr	1088(ra) # 5f64 <printf>
    exit(1);
    3b2c:	4505                	li	a0,1
    3b2e:	00002097          	auipc	ra,0x2
    3b32:	0ae080e7          	jalr	174(ra) # 5bdc <exit>
    printf("%s: unlink dd/dd/ff failed\n", s);
    3b36:	85ca                	mv	a1,s2
    3b38:	00004517          	auipc	a0,0x4
    3b3c:	ad850513          	addi	a0,a0,-1320 # 7610 <malloc+0x15ee>
    3b40:	00002097          	auipc	ra,0x2
    3b44:	424080e7          	jalr	1060(ra) # 5f64 <printf>
    exit(1);
    3b48:	4505                	li	a0,1
    3b4a:	00002097          	auipc	ra,0x2
    3b4e:	092080e7          	jalr	146(ra) # 5bdc <exit>
    printf("%s: open (unlinked) dd/dd/ff succeeded\n", s);
    3b52:	85ca                	mv	a1,s2
    3b54:	00004517          	auipc	a0,0x4
    3b58:	adc50513          	addi	a0,a0,-1316 # 7630 <malloc+0x160e>
    3b5c:	00002097          	auipc	ra,0x2
    3b60:	408080e7          	jalr	1032(ra) # 5f64 <printf>
    exit(1);
    3b64:	4505                	li	a0,1
    3b66:	00002097          	auipc	ra,0x2
    3b6a:	076080e7          	jalr	118(ra) # 5bdc <exit>
    printf("%s: chdir dd failed\n", s);
    3b6e:	85ca                	mv	a1,s2
    3b70:	00004517          	auipc	a0,0x4
    3b74:	ae850513          	addi	a0,a0,-1304 # 7658 <malloc+0x1636>
    3b78:	00002097          	auipc	ra,0x2
    3b7c:	3ec080e7          	jalr	1004(ra) # 5f64 <printf>
    exit(1);
    3b80:	4505                	li	a0,1
    3b82:	00002097          	auipc	ra,0x2
    3b86:	05a080e7          	jalr	90(ra) # 5bdc <exit>
    printf("%s: chdir dd/../../dd failed\n", s);
    3b8a:	85ca                	mv	a1,s2
    3b8c:	00004517          	auipc	a0,0x4
    3b90:	af450513          	addi	a0,a0,-1292 # 7680 <malloc+0x165e>
    3b94:	00002097          	auipc	ra,0x2
    3b98:	3d0080e7          	jalr	976(ra) # 5f64 <printf>
    exit(1);
    3b9c:	4505                	li	a0,1
    3b9e:	00002097          	auipc	ra,0x2
    3ba2:	03e080e7          	jalr	62(ra) # 5bdc <exit>
    printf("chdir dd/../../dd failed\n", s);
    3ba6:	85ca                	mv	a1,s2
    3ba8:	00004517          	auipc	a0,0x4
    3bac:	b0850513          	addi	a0,a0,-1272 # 76b0 <malloc+0x168e>
    3bb0:	00002097          	auipc	ra,0x2
    3bb4:	3b4080e7          	jalr	948(ra) # 5f64 <printf>
    exit(1);
    3bb8:	4505                	li	a0,1
    3bba:	00002097          	auipc	ra,0x2
    3bbe:	022080e7          	jalr	34(ra) # 5bdc <exit>
    printf("%s: chdir ./.. failed\n", s);
    3bc2:	85ca                	mv	a1,s2
    3bc4:	00004517          	auipc	a0,0x4
    3bc8:	b1450513          	addi	a0,a0,-1260 # 76d8 <malloc+0x16b6>
    3bcc:	00002097          	auipc	ra,0x2
    3bd0:	398080e7          	jalr	920(ra) # 5f64 <printf>
    exit(1);
    3bd4:	4505                	li	a0,1
    3bd6:	00002097          	auipc	ra,0x2
    3bda:	006080e7          	jalr	6(ra) # 5bdc <exit>
    printf("%s: open dd/dd/ffff failed\n", s);
    3bde:	85ca                	mv	a1,s2
    3be0:	00004517          	auipc	a0,0x4
    3be4:	b1050513          	addi	a0,a0,-1264 # 76f0 <malloc+0x16ce>
    3be8:	00002097          	auipc	ra,0x2
    3bec:	37c080e7          	jalr	892(ra) # 5f64 <printf>
    exit(1);
    3bf0:	4505                	li	a0,1
    3bf2:	00002097          	auipc	ra,0x2
    3bf6:	fea080e7          	jalr	-22(ra) # 5bdc <exit>
    printf("%s: read dd/dd/ffff wrong len\n", s);
    3bfa:	85ca                	mv	a1,s2
    3bfc:	00004517          	auipc	a0,0x4
    3c00:	b1450513          	addi	a0,a0,-1260 # 7710 <malloc+0x16ee>
    3c04:	00002097          	auipc	ra,0x2
    3c08:	360080e7          	jalr	864(ra) # 5f64 <printf>
    exit(1);
    3c0c:	4505                	li	a0,1
    3c0e:	00002097          	auipc	ra,0x2
    3c12:	fce080e7          	jalr	-50(ra) # 5bdc <exit>
    printf("%s: open (unlinked) dd/dd/ff succeeded!\n", s);
    3c16:	85ca                	mv	a1,s2
    3c18:	00004517          	auipc	a0,0x4
    3c1c:	b1850513          	addi	a0,a0,-1256 # 7730 <malloc+0x170e>
    3c20:	00002097          	auipc	ra,0x2
    3c24:	344080e7          	jalr	836(ra) # 5f64 <printf>
    exit(1);
    3c28:	4505                	li	a0,1
    3c2a:	00002097          	auipc	ra,0x2
    3c2e:	fb2080e7          	jalr	-78(ra) # 5bdc <exit>
    printf("%s: create dd/ff/ff succeeded!\n", s);
    3c32:	85ca                	mv	a1,s2
    3c34:	00004517          	auipc	a0,0x4
    3c38:	b3c50513          	addi	a0,a0,-1220 # 7770 <malloc+0x174e>
    3c3c:	00002097          	auipc	ra,0x2
    3c40:	328080e7          	jalr	808(ra) # 5f64 <printf>
    exit(1);
    3c44:	4505                	li	a0,1
    3c46:	00002097          	auipc	ra,0x2
    3c4a:	f96080e7          	jalr	-106(ra) # 5bdc <exit>
    printf("%s: create dd/xx/ff succeeded!\n", s);
    3c4e:	85ca                	mv	a1,s2
    3c50:	00004517          	auipc	a0,0x4
    3c54:	b5050513          	addi	a0,a0,-1200 # 77a0 <malloc+0x177e>
    3c58:	00002097          	auipc	ra,0x2
    3c5c:	30c080e7          	jalr	780(ra) # 5f64 <printf>
    exit(1);
    3c60:	4505                	li	a0,1
    3c62:	00002097          	auipc	ra,0x2
    3c66:	f7a080e7          	jalr	-134(ra) # 5bdc <exit>
    printf("%s: create dd succeeded!\n", s);
    3c6a:	85ca                	mv	a1,s2
    3c6c:	00004517          	auipc	a0,0x4
    3c70:	b5450513          	addi	a0,a0,-1196 # 77c0 <malloc+0x179e>
    3c74:	00002097          	auipc	ra,0x2
    3c78:	2f0080e7          	jalr	752(ra) # 5f64 <printf>
    exit(1);
    3c7c:	4505                	li	a0,1
    3c7e:	00002097          	auipc	ra,0x2
    3c82:	f5e080e7          	jalr	-162(ra) # 5bdc <exit>
    printf("%s: open dd rdwr succeeded!\n", s);
    3c86:	85ca                	mv	a1,s2
    3c88:	00004517          	auipc	a0,0x4
    3c8c:	b5850513          	addi	a0,a0,-1192 # 77e0 <malloc+0x17be>
    3c90:	00002097          	auipc	ra,0x2
    3c94:	2d4080e7          	jalr	724(ra) # 5f64 <printf>
    exit(1);
    3c98:	4505                	li	a0,1
    3c9a:	00002097          	auipc	ra,0x2
    3c9e:	f42080e7          	jalr	-190(ra) # 5bdc <exit>
    printf("%s: open dd wronly succeeded!\n", s);
    3ca2:	85ca                	mv	a1,s2
    3ca4:	00004517          	auipc	a0,0x4
    3ca8:	b5c50513          	addi	a0,a0,-1188 # 7800 <malloc+0x17de>
    3cac:	00002097          	auipc	ra,0x2
    3cb0:	2b8080e7          	jalr	696(ra) # 5f64 <printf>
    exit(1);
    3cb4:	4505                	li	a0,1
    3cb6:	00002097          	auipc	ra,0x2
    3cba:	f26080e7          	jalr	-218(ra) # 5bdc <exit>
    printf("%s: link dd/ff/ff dd/dd/xx succeeded!\n", s);
    3cbe:	85ca                	mv	a1,s2
    3cc0:	00004517          	auipc	a0,0x4
    3cc4:	b7050513          	addi	a0,a0,-1168 # 7830 <malloc+0x180e>
    3cc8:	00002097          	auipc	ra,0x2
    3ccc:	29c080e7          	jalr	668(ra) # 5f64 <printf>
    exit(1);
    3cd0:	4505                	li	a0,1
    3cd2:	00002097          	auipc	ra,0x2
    3cd6:	f0a080e7          	jalr	-246(ra) # 5bdc <exit>
    printf("%s: link dd/xx/ff dd/dd/xx succeeded!\n", s);
    3cda:	85ca                	mv	a1,s2
    3cdc:	00004517          	auipc	a0,0x4
    3ce0:	b7c50513          	addi	a0,a0,-1156 # 7858 <malloc+0x1836>
    3ce4:	00002097          	auipc	ra,0x2
    3ce8:	280080e7          	jalr	640(ra) # 5f64 <printf>
    exit(1);
    3cec:	4505                	li	a0,1
    3cee:	00002097          	auipc	ra,0x2
    3cf2:	eee080e7          	jalr	-274(ra) # 5bdc <exit>
    printf("%s: link dd/ff dd/dd/ffff succeeded!\n", s);
    3cf6:	85ca                	mv	a1,s2
    3cf8:	00004517          	auipc	a0,0x4
    3cfc:	b8850513          	addi	a0,a0,-1144 # 7880 <malloc+0x185e>
    3d00:	00002097          	auipc	ra,0x2
    3d04:	264080e7          	jalr	612(ra) # 5f64 <printf>
    exit(1);
    3d08:	4505                	li	a0,1
    3d0a:	00002097          	auipc	ra,0x2
    3d0e:	ed2080e7          	jalr	-302(ra) # 5bdc <exit>
    printf("%s: mkdir dd/ff/ff succeeded!\n", s);
    3d12:	85ca                	mv	a1,s2
    3d14:	00004517          	auipc	a0,0x4
    3d18:	b9450513          	addi	a0,a0,-1132 # 78a8 <malloc+0x1886>
    3d1c:	00002097          	auipc	ra,0x2
    3d20:	248080e7          	jalr	584(ra) # 5f64 <printf>
    exit(1);
    3d24:	4505                	li	a0,1
    3d26:	00002097          	auipc	ra,0x2
    3d2a:	eb6080e7          	jalr	-330(ra) # 5bdc <exit>
    printf("%s: mkdir dd/xx/ff succeeded!\n", s);
    3d2e:	85ca                	mv	a1,s2
    3d30:	00004517          	auipc	a0,0x4
    3d34:	b9850513          	addi	a0,a0,-1128 # 78c8 <malloc+0x18a6>
    3d38:	00002097          	auipc	ra,0x2
    3d3c:	22c080e7          	jalr	556(ra) # 5f64 <printf>
    exit(1);
    3d40:	4505                	li	a0,1
    3d42:	00002097          	auipc	ra,0x2
    3d46:	e9a080e7          	jalr	-358(ra) # 5bdc <exit>
    printf("%s: mkdir dd/dd/ffff succeeded!\n", s);
    3d4a:	85ca                	mv	a1,s2
    3d4c:	00004517          	auipc	a0,0x4
    3d50:	b9c50513          	addi	a0,a0,-1124 # 78e8 <malloc+0x18c6>
    3d54:	00002097          	auipc	ra,0x2
    3d58:	210080e7          	jalr	528(ra) # 5f64 <printf>
    exit(1);
    3d5c:	4505                	li	a0,1
    3d5e:	00002097          	auipc	ra,0x2
    3d62:	e7e080e7          	jalr	-386(ra) # 5bdc <exit>
    printf("%s: unlink dd/xx/ff succeeded!\n", s);
    3d66:	85ca                	mv	a1,s2
    3d68:	00004517          	auipc	a0,0x4
    3d6c:	ba850513          	addi	a0,a0,-1112 # 7910 <malloc+0x18ee>
    3d70:	00002097          	auipc	ra,0x2
    3d74:	1f4080e7          	jalr	500(ra) # 5f64 <printf>
    exit(1);
    3d78:	4505                	li	a0,1
    3d7a:	00002097          	auipc	ra,0x2
    3d7e:	e62080e7          	jalr	-414(ra) # 5bdc <exit>
    printf("%s: unlink dd/ff/ff succeeded!\n", s);
    3d82:	85ca                	mv	a1,s2
    3d84:	00004517          	auipc	a0,0x4
    3d88:	bac50513          	addi	a0,a0,-1108 # 7930 <malloc+0x190e>
    3d8c:	00002097          	auipc	ra,0x2
    3d90:	1d8080e7          	jalr	472(ra) # 5f64 <printf>
    exit(1);
    3d94:	4505                	li	a0,1
    3d96:	00002097          	auipc	ra,0x2
    3d9a:	e46080e7          	jalr	-442(ra) # 5bdc <exit>
    printf("%s: chdir dd/ff succeeded!\n", s);
    3d9e:	85ca                	mv	a1,s2
    3da0:	00004517          	auipc	a0,0x4
    3da4:	bb050513          	addi	a0,a0,-1104 # 7950 <malloc+0x192e>
    3da8:	00002097          	auipc	ra,0x2
    3dac:	1bc080e7          	jalr	444(ra) # 5f64 <printf>
    exit(1);
    3db0:	4505                	li	a0,1
    3db2:	00002097          	auipc	ra,0x2
    3db6:	e2a080e7          	jalr	-470(ra) # 5bdc <exit>
    printf("%s: chdir dd/xx succeeded!\n", s);
    3dba:	85ca                	mv	a1,s2
    3dbc:	00004517          	auipc	a0,0x4
    3dc0:	bbc50513          	addi	a0,a0,-1092 # 7978 <malloc+0x1956>
    3dc4:	00002097          	auipc	ra,0x2
    3dc8:	1a0080e7          	jalr	416(ra) # 5f64 <printf>
    exit(1);
    3dcc:	4505                	li	a0,1
    3dce:	00002097          	auipc	ra,0x2
    3dd2:	e0e080e7          	jalr	-498(ra) # 5bdc <exit>
    printf("%s: unlink dd/dd/ff failed\n", s);
    3dd6:	85ca                	mv	a1,s2
    3dd8:	00004517          	auipc	a0,0x4
    3ddc:	83850513          	addi	a0,a0,-1992 # 7610 <malloc+0x15ee>
    3de0:	00002097          	auipc	ra,0x2
    3de4:	184080e7          	jalr	388(ra) # 5f64 <printf>
    exit(1);
    3de8:	4505                	li	a0,1
    3dea:	00002097          	auipc	ra,0x2
    3dee:	df2080e7          	jalr	-526(ra) # 5bdc <exit>
    printf("%s: unlink dd/ff failed\n", s);
    3df2:	85ca                	mv	a1,s2
    3df4:	00004517          	auipc	a0,0x4
    3df8:	ba450513          	addi	a0,a0,-1116 # 7998 <malloc+0x1976>
    3dfc:	00002097          	auipc	ra,0x2
    3e00:	168080e7          	jalr	360(ra) # 5f64 <printf>
    exit(1);
    3e04:	4505                	li	a0,1
    3e06:	00002097          	auipc	ra,0x2
    3e0a:	dd6080e7          	jalr	-554(ra) # 5bdc <exit>
    printf("%s: unlink non-empty dd succeeded!\n", s);
    3e0e:	85ca                	mv	a1,s2
    3e10:	00004517          	auipc	a0,0x4
    3e14:	ba850513          	addi	a0,a0,-1112 # 79b8 <malloc+0x1996>
    3e18:	00002097          	auipc	ra,0x2
    3e1c:	14c080e7          	jalr	332(ra) # 5f64 <printf>
    exit(1);
    3e20:	4505                	li	a0,1
    3e22:	00002097          	auipc	ra,0x2
    3e26:	dba080e7          	jalr	-582(ra) # 5bdc <exit>
    printf("%s: unlink dd/dd failed\n", s);
    3e2a:	85ca                	mv	a1,s2
    3e2c:	00004517          	auipc	a0,0x4
    3e30:	bbc50513          	addi	a0,a0,-1092 # 79e8 <malloc+0x19c6>
    3e34:	00002097          	auipc	ra,0x2
    3e38:	130080e7          	jalr	304(ra) # 5f64 <printf>
    exit(1);
    3e3c:	4505                	li	a0,1
    3e3e:	00002097          	auipc	ra,0x2
    3e42:	d9e080e7          	jalr	-610(ra) # 5bdc <exit>
    printf("%s: unlink dd failed\n", s);
    3e46:	85ca                	mv	a1,s2
    3e48:	00004517          	auipc	a0,0x4
    3e4c:	bc050513          	addi	a0,a0,-1088 # 7a08 <malloc+0x19e6>
    3e50:	00002097          	auipc	ra,0x2
    3e54:	114080e7          	jalr	276(ra) # 5f64 <printf>
    exit(1);
    3e58:	4505                	li	a0,1
    3e5a:	00002097          	auipc	ra,0x2
    3e5e:	d82080e7          	jalr	-638(ra) # 5bdc <exit>
...
0000000000003e62 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e72:	bb250513          	addi	a0,a0,-1102 # 7a20 <malloc+0x19fe>
    3e76:	00002097          	auipc	ra,0x2
    3e7a:	dce080e7          	jalr	-562(ra) # 5c44 <mkdir>
    3e7e:	e549                	bnez	a0,3f08 <rmdot+0xa6>
  if(chdir("dots") != 0){
    3e80:	00004517          	auipc	a0,0x4
    3e84:	ba050513          	addi	a0,a0,-1120 # 7a20 <malloc+0x19fe>
    3e88:	00002097          	auipc	ra,0x2
    3e8c:	dc4080e7          	jalr	-572(ra) # 5c4c <chdir>
    3e90:	e951                	bnez	a0,3f24 <rmdot+0xc2>
  if(unlink(".") == 0){
    3e92:	00003517          	auipc	a0,0x3
    3e96:	9be50513          	addi	a0,a0,-1602 # 6850 <malloc+0x82e>
    3e9a:	00002097          	auipc	ra,0x2
    3e9e:	d92080e7          	jalr	-622(ra) # 5c2c <unlink>
    3ea2:	cd59                	beqz	a0,3f40 <rmdot+0xde>
  if(unlink("..") == 0){
    3ea4:	00003517          	auipc	a0,0x3
    3ea8:	5d450513          	addi	a0,a0,1492 # 7478 <malloc+0x1456>
    3eac:	00002097          	auipc	ra,0x2
    3eb0:	d80080e7          	jalr	-640(ra) # 5c2c <unlink>
    3eb4:	c545                	beqz	a0,3f5c <rmdot+0xfa>
  if(chdir("/") != 0){
    3eb6:	00003517          	auipc	a0,0x3
    3eba:	56a50513          	addi	a0,a0,1386 # 7420 <malloc+0x13fe>
    3ebe:	00002097          	auipc	ra,0x2
    3ec2:	d8e080e7          	jalr	-626(ra) # 5c4c <chdir>
    3ec6:	e94d                	bnez	a0,3f78 <rmdot+0x116>
  if(unlink("dots/.") == 0){
    3ec8:	00004517          	auipc	a0,0x4
    3ecc:	bc050513          	addi	a0,a0,-1088 # 7a88 <malloc+0x1a66>
    3ed0:	00002097          	auipc	ra,0x2
    3ed4:	d5c080e7          	jalr	-676(ra) # 5c2c <unlink>
    3ed8:	cd55                	beqz	a0,3f94 <rmdot+0x132>
  if(unlink("dots/..") == 0){
    3eda:	00004517          	auipc	a0,0x4
    3ede:	bd650513          	addi	a0,a0,-1066 # 7ab0 <malloc+0x1a8e>
    3ee2:	00002097          	auipc	ra,0x2
    3ee6:	d4a080e7          	jalr	-694(ra) # 5c2c <unlink>
    3eea:	c179                	beqz	a0,3fb0 <rmdot+0x14e>
  if(unlink("dots") != 0){
    3eec:	00004517          	auipc	a0,0x4
    3ef0:	b3450513          	addi	a0,a0,-1228 # 7a20 <malloc+0x19fe>
    3ef4:	00002097          	auipc	ra,0x2
    3ef8:	d38080e7          	jalr	-712(ra) # 5c2c <unlink>
    ...
    3f0e:	b1e50513          	addi	a0,a0,-1250 # 7a28 <malloc+0x1a06>
    3f12:	00002097          	auipc	ra,0x2
    3f16:	052080e7          	jalr	82(ra) # 5f64 <printf>
    exit(1);
    3f1a:	4505                	li	a0,1
    3f1c:	00002097          	auipc	ra,0x2
    3f20:	cc0080e7          	jalr	-832(ra) # 5bdc <exit>
    printf("%s: chdir dots failed\n", s);
    3f24:	85a6                	mv	a1,s1
    3f26:	00004517          	auipc	a0,0x4
    3f2a:	b1a50513          	addi	a0,a0,-1254 # 7a40 <malloc+0x1a1e>
    3f2e:	00002097          	auipc	ra,0x2
    3f32:	036080e7          	jalr	54(ra) # 5f64 <printf>
    exit(1);
    3f36:	4505                	li	a0,1
    3f38:	00002097          	auipc	ra,0x2
    3f3c:	ca4080e7          	jalr	-860(ra) # 5bdc <exit>
    printf("%s: rm . worked!\n", s);
    3f40:	85a6                	mv	a1,s1
    3f42:	00004517          	auipc	a0,0x4
    3f46:	b1650513          	addi	a0,a0,-1258 # 7a58 <malloc+0x1a36>
    3f4a:	00002097          	auipc	ra,0x2
    3f4e:	01a080e7          	jalr	26(ra) # 5f64 <printf>
    exit(1);
    3f52:	4505                	li	a0,1
    3f54:	00002097          	auipc	ra,0x2
    3f58:	c88080e7          	jalr	-888(ra) # 5bdc <exit>
    printf("%s: rm .. worked!\n", s);
    3f5c:	85a6                	mv	a1,s1
    3f5e:	00004517          	auipc	a0,0x4
    3f62:	b1250513          	addi	a0,a0,-1262 # 7a70 <malloc+0x1a4e>
    3f66:	00002097          	auipc	ra,0x2
    3f6a:	ffe080e7          	jalr	-2(ra) # 5f64 <printf>
    exit(1);
    3f6e:	4505                	li	a0,1
    3f70:	00002097          	auipc	ra,0x2
    3f74:	c6c080e7          	jalr	-916(ra) # 5bdc <exit>
    printf("%s: chdir / failed\n", s);
    3f78:	85a6                	mv	a1,s1
    3f7a:	00003517          	auipc	a0,0x3
    3f7e:	4ae50513          	addi	a0,a0,1198 # 7428 <malloc+0x1406>
    3f82:	00002097          	auipc	ra,0x2
    3f86:	fe2080e7          	jalr	-30(ra) # 5f64 <printf>
    exit(1);
    3f8a:	4505                	li	a0,1
    3f8c:	00002097          	auipc	ra,0x2
    3f90:	c50080e7          	jalr	-944(ra) # 5bdc <exit>
    printf("%s: unlink dots/. worked!\n", s);
    3f94:	85a6                	mv	a1,s1
    3f96:	00004517          	auipc	a0,0x4
    3f9a:	afa50513          	addi	a0,a0,-1286 # 7a90 <malloc+0x1a6e>
    3f9e:	00002097          	auipc	ra,0x2
    3fa2:	fc6080e7          	jalr	-58(ra) # 5f64 <printf>
    exit(1);
    3fa6:	4505                	li	a0,1
    3fa8:	00002097          	auipc	ra,0x2
    3fac:	c34080e7          	jalr	-972(ra) # 5bdc <exit>
    printf("%s: unlink dots/.. worked!\n", s);
    3fb0:	85a6                	mv	a1,s1
    3fb2:	00004517          	auipc	a0,0x4
    3fb6:	b0650513          	addi	a0,a0,-1274 # 7ab8 <malloc+0x1a96>
    3fba:	00002097          	auipc	ra,0x2
    3fbe:	faa080e7          	jalr	-86(ra) # 5f64 <printf>
    exit(1);
    3fc2:	4505                	li	a0,1
    3fc4:	00002097          	auipc	ra,0x2
    3fc8:	c18080e7          	jalr	-1000(ra) # 5bdc <exit>
    printf("%s: unlink dots failed!\n", s);
    3fcc:	85a6                	mv	a1,s1
    3fce:	00004517          	auipc	a0,0x4
    3fd2:	b0a50513          	addi	a0,a0,-1270 # 7ad8 <malloc+0x1ab6>
    3fd6:	00002097          	auipc	ra,0x2
    3fda:	f8e080e7          	jalr	-114(ra) # 5f64 <printf>
    exit(1);
    3fde:	4505                	li	a0,1
    3fe0:	00002097          	auipc	ra,0x2
    3fe4:	bfc080e7          	jalr	-1028(ra) # 5bdc <exit>
...
0000000000003fe8 <dirfile>:
{
  ...
  close(fd);
    ...
    410a:	9fa50513          	addi	a0,a0,-1542 # 7b00 <malloc+0x1ade>
    410e:	00002097          	auipc	ra,0x2
    4112:	e56080e7          	jalr	-426(ra) # 5f64 <printf>
    exit(1);
    4116:	4505                	li	a0,1
    4118:	00002097          	auipc	ra,0x2
    411c:	ac4080e7          	jalr	-1340(ra) # 5bdc <exit>
    printf("%s: chdir dirfile succeeded!\n", s);
    4120:	85ca                	mv	a1,s2
    4122:	00004517          	auipc	a0,0x4
    4126:	9fe50513          	addi	a0,a0,-1538 # 7b20 <malloc+0x1afe>
    412a:	00002097          	auipc	ra,0x2
    412e:	e3a080e7          	jalr	-454(ra) # 5f64 <printf>
    exit(1);
    4132:	4505                	li	a0,1
    4134:	00002097          	auipc	ra,0x2
    4138:	aa8080e7          	jalr	-1368(ra) # 5bdc <exit>
    printf("%s: create dirfile/xx succeeded!\n", s);
    413c:	85ca                	mv	a1,s2
    413e:	00004517          	auipc	a0,0x4
    4142:	a1250513          	addi	a0,a0,-1518 # 7b50 <malloc+0x1b2e>
    4146:	00002097          	auipc	ra,0x2
    414a:	e1e080e7          	jalr	-482(ra) # 5f64 <printf>
    exit(1);
    414e:	4505                	li	a0,1
    4150:	00002097          	auipc	ra,0x2
    4154:	a8c080e7          	jalr	-1396(ra) # 5bdc <exit>
    printf("%s: create dirfile/xx succeeded!\n", s);
    4158:	85ca                	mv	a1,s2
    415a:	00004517          	auipc	a0,0x4
    415e:	9f650513          	addi	a0,a0,-1546 # 7b50 <malloc+0x1b2e>
    4162:	00002097          	auipc	ra,0x2
    4166:	e02080e7          	jalr	-510(ra) # 5f64 <printf>
    exit(1);
    416a:	4505                	li	a0,1
    416c:	00002097          	auipc	ra,0x2
    4170:	a70080e7          	jalr	-1424(ra) # 5bdc <exit>
    printf("%s: mkdir dirfile/xx succeeded!\n", s);
    4174:	85ca                	mv	a1,s2
    4176:	00004517          	auipc	a0,0x4
    417a:	a0250513          	addi	a0,a0,-1534 # 7b78 <malloc+0x1b56>
    417e:	00002097          	auipc	ra,0x2
    4182:	de6080e7          	jalr	-538(ra) # 5f64 <printf>
    exit(1);
    4186:	4505                	li	a0,1
    4188:	00002097          	auipc	ra,0x2
    418c:	a54080e7          	jalr	-1452(ra) # 5bdc <exit>
    printf("%s: unlink dirfile/xx succeeded!\n", s);
    4190:	85ca                	mv	a1,s2
    4192:	00004517          	auipc	a0,0x4
    4196:	a0e50513          	addi	a0,a0,-1522 # 7ba0 <malloc+0x1b7e>
    419a:	00002097          	auipc	ra,0x2
    419e:	dca080e7          	jalr	-566(ra) # 5f64 <printf>
    exit(1);
    41a2:	4505                	li	a0,1
    41a4:	00002097          	auipc	ra,0x2
    41a8:	a38080e7          	jalr	-1480(ra) # 5bdc <exit>
    printf("%s: link to dirfile/xx succeeded!\n", s);
    41ac:	85ca                	mv	a1,s2
    41ae:	00004517          	auipc	a0,0x4
    41b2:	a1a50513          	addi	a0,a0,-1510 # 7bc8 <malloc+0x1ba6>
    41b6:	00002097          	auipc	ra,0x2
    41ba:	dae080e7          	jalr	-594(ra) # 5f64 <printf>
    exit(1);
    41be:	4505                	li	a0,1
    41c0:	00002097          	auipc	ra,0x2
    41c4:	a1c080e7          	jalr	-1508(ra) # 5bdc <exit>
    printf("%s: unlink dirfile failed!\n", s);
    41c8:	85ca                	mv	a1,s2
    41ca:	00004517          	auipc	a0,0x4
    41ce:	a2650513          	addi	a0,a0,-1498 # 7bf0 <malloc+0x1bce>
    41d2:	00002097          	auipc	ra,0x2
    41d6:	d92080e7          	jalr	-622(ra) # 5f64 <printf>
    exit(1);
    41da:	4505                	li	a0,1
    41dc:	00002097          	auipc	ra,0x2
    41e0:	a00080e7          	jalr	-1536(ra) # 5bdc <exit>
    printf("%s: open . for writing succeeded!\n", s);
    41e4:	85ca                	mv	a1,s2
    41e6:	00004517          	auipc	a0,0x4
    41ea:	a2a50513          	addi	a0,a0,-1494 # 7c10 <malloc+0x1bee>
    41ee:	00002097          	auipc	ra,0x2
    41f2:	d76080e7          	jalr	-650(ra) # 5f64 <printf>
    exit(1);
    41f6:	4505                	li	a0,1
    41f8:	00002097          	auipc	ra,0x2
    41fc:	9e4080e7          	jalr	-1564(ra) # 5bdc <exit>
    printf("%s: write . succeeded!\n", s);
    4200:	85ca                	mv	a1,s2
    4202:	00004517          	auipc	a0,0x4
    4206:	a3650513          	addi	a0,a0,-1482 # 7c38 <malloc+0x1c16>
    420a:	00002097          	auipc	ra,0x2
    420e:	d5a080e7          	jalr	-678(ra) # 5f64 <printf>
    exit(1);
    4212:	4505                	li	a0,1
    4214:	00002097          	auipc	ra,0x2
    4218:	9c8080e7          	jalr	-1592(ra) # 5bdc <exit>
...
000000000000421c <iref>:
{
    ...
    423a:	a1aa0a13          	addi	s4,s4,-1510 # 7c50 <malloc+0x1c2e>
    mkdir("");
    423e:	00003497          	auipc	s1,0x3
    4242:	51a48493          	addi	s1,s1,1306 # 7758 <malloc+0x1736>
    link("README", "");
    4246:	00002a97          	auipc	s5,0x2
    424a:	0faa8a93          	addi	s5,s5,250 # 6340 <malloc+0x31e>
    fd = open("xx", O_CREATE);
    424e:	00004997          	auipc	s3,0x4
    4252:	8fa98993          	addi	s3,s3,-1798 # 7b48 <malloc+0x1b26>
    4256:	a891                	j	42aa <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4258:	85da                	mv	a1,s6
    425a:	00004517          	auipc	a0,0x4
    425e:	9fe50513          	addi	a0,a0,-1538 # 7c58 <malloc+0x1c36>
    4262:	00002097          	auipc	ra,0x2
    4266:	d02080e7          	jalr	-766(ra) # 5f64 <printf>
      exit(1);
    426a:	4505                	li	a0,1
    426c:	00002097          	auipc	ra,0x2
    4270:	970080e7          	jalr	-1680(ra) # 5bdc <exit>
      printf("%s: chdir irefd failed\n", s);
    4274:	85da                	mv	a1,s6
    4276:	00004517          	auipc	a0,0x4
    427a:	9fa50513          	addi	a0,a0,-1542 # 7c70 <malloc+0x1c4e>
    427e:	00002097          	auipc	ra,0x2
    4282:	ce6080e7          	jalr	-794(ra) # 5f64 <printf>
      exit(1);
    4286:	4505                	li	a0,1
    4288:	00002097          	auipc	ra,0x2
    428c:	954080e7          	jalr	-1708(ra) # 5bdc <exit>
      close(fd);
    4290:	00002097          	auipc	ra,0x2
    4294:	974080e7          	jalr	-1676(ra) # 5c04 <close>
    4298:	a889                	j	42ea <iref+0xce>
    unlink("xx");
    429a:	854e                	mv	a0,s3
    429c:	00002097          	auipc	ra,0x2
    42a0:	990080e7          	jalr	-1648(ra) # 5c2c <unlink>
  for(i = 0; i < NINODE + 1; i++){
    ...
    42f4:	92c080e7          	jalr	-1748(ra) # 5c1c <open>
    if(fd >= 0)
    42f8:	fa0541e3          	bltz	a0,429a <iref+0x7e>
      close(fd);
    42fc:	00002097          	auipc	ra,0x2
    4300:	908080e7          	jalr	-1784(ra) # 5c04 <close>
    4304:	bf59                	j	429a <iref+0x7e>
    4306:	03300493          	li	s1,51
    chdir("..");
    430a:	00003997          	auipc	s3,0x3
    430e:	16e98993          	addi	s3,s3,366 # 7478 <malloc+0x1456>
    unlink("irefd");
    4312:	00004917          	auipc	s2,0x4
    4316:	93e90913          	addi	s2,s2,-1730 # 7c50 <malloc+0x1c2e>
    chdir("..");
    431a:	854e                	mv	a0,s3
    431c:	00002097          	auipc	ra,0x2
    4320:	930080e7          	jalr	-1744(ra) # 5c4c <chdir>
    unlink("irefd");
    4324:	854a                	mv	a0,s2
    4326:	00002097          	auipc	ra,0x2
    432a:	906080e7          	jalr	-1786(ra) # 5c2c <unlink>
  for(i = 0; i < NINODE + 1; i++){
    432e:	34fd                	addiw	s1,s1,-1
    4330:	f4ed                	bnez	s1,431a <iref+0xfe>
  chdir("/");
    4332:	00003517          	auipc	a0,0x3
    4336:	0ee50513          	addi	a0,a0,238 # 7420 <malloc+0x13fe>
    433a:	00002097          	auipc	ra,0x2
    433e:	912080e7          	jalr	-1774(ra) # 5c4c <chdir>
}
...
0000000000004356 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4366:	92650513          	addi	a0,a0,-1754 # 7c88 <malloc+0x1c66>
    436a:	00002097          	auipc	ra,0x2
    436e:	8da080e7          	jalr	-1830(ra) # 5c44 <mkdir>
    4372:	04054263          	bltz	a0,43b6 <openiputtest+0x60>
  pid = fork();
    4376:	00002097          	auipc	ra,0x2
    437a:	85e080e7          	jalr	-1954(ra) # 5bd4 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    438a:	90250513          	addi	a0,a0,-1790 # 7c88 <malloc+0x1c66>
    438e:	00002097          	auipc	ra,0x2
    4392:	88e080e7          	jalr	-1906(ra) # 5c1c <open>
    if(fd >= 0){
    4396:	04054c63          	bltz	a0,43ee <openiputtest+0x98>
      printf("%s: open directory for write succeeded\n", s);
    439a:	85a6                	mv	a1,s1
    439c:	00004517          	auipc	a0,0x4
    43a0:	90c50513          	addi	a0,a0,-1780 # 7ca8 <malloc+0x1c86>
    43a4:	00002097          	auipc	ra,0x2
    43a8:	bc0080e7          	jalr	-1088(ra) # 5f64 <printf>
      exit(1);
    43ac:	4505                	li	a0,1
    43ae:	00002097          	auipc	ra,0x2
    43b2:	82e080e7          	jalr	-2002(ra) # 5bdc <exit>
    printf("%s: mkdir oidir failed\n", s);
    43b6:	85a6                	mv	a1,s1
    43b8:	00004517          	auipc	a0,0x4
    43bc:	8d850513          	addi	a0,a0,-1832 # 7c90 <malloc+0x1c6e>
    43c0:	00002097          	auipc	ra,0x2
    43c4:	ba4080e7          	jalr	-1116(ra) # 5f64 <printf>
    exit(1);
    43c8:	4505                	li	a0,1
    43ca:	00002097          	auipc	ra,0x2
    43ce:	812080e7          	jalr	-2030(ra) # 5bdc <exit>
    printf("%s: fork failed\n", s);
    43d2:	85a6                	mv	a1,s1
    43d4:	00002517          	auipc	a0,0x2
    43d8:	61c50513          	addi	a0,a0,1564 # 69f0 <malloc+0x9ce>
    43dc:	00002097          	auipc	ra,0x2
    43e0:	b88080e7          	jalr	-1144(ra) # 5f64 <printf>
    exit(1);
    43e4:	4505                	li	a0,1
    43e6:	00001097          	auipc	ra,0x1
    43ea:	7f6080e7          	jalr	2038(ra) # 5bdc <exit>
    exit(0);
    43ee:	4501                	li	a0,0
    43f0:	00001097          	auipc	ra,0x1
    43f4:	7ec080e7          	jalr	2028(ra) # 5bdc <exit>
  sleep(1);
    43f8:	4505                	li	a0,1
    43fa:	00002097          	auipc	ra,0x2
    43fe:	872080e7          	jalr	-1934(ra) # 5c6c <sleep>
  if(unlink("oidir") != 0){
    4402:	00004517          	auipc	a0,0x4
    4406:	88650513          	addi	a0,a0,-1914 # 7c88 <malloc+0x1c66>
    440a:	00002097          	auipc	ra,0x2
    440e:	822080e7          	jalr	-2014(ra) # 5c2c <unlink>
    4412:	cd19                	beqz	a0,4430 <openiputtest+0xda>
    printf("%s: unlink failed\n", s);
    4414:	85a6                	mv	a1,s1
    4416:	00002517          	auipc	a0,0x2
    441a:	7ca50513          	addi	a0,a0,1994 # 6be0 <malloc+0xbbe>
    441e:	00002097          	auipc	ra,0x2
    4422:	b46080e7          	jalr	-1210(ra) # 5f64 <printf>
    exit(1);
    4426:	4505                	li	a0,1
    4428:	00001097          	auipc	ra,0x1
    442c:	7b4080e7          	jalr	1972(ra) # 5bdc <exit>
  wait(&xstatus);
    4430:	fdc40513          	addi	a0,s0,-36
    4434:	00001097          	auipc	ra,0x1
    4438:	7b0080e7          	jalr	1968(ra) # 5be4 <wait>
  exit(xstatus);
    443c:	fdc42503          	lw	a0,-36(s0)
    4440:	00001097          	auipc	ra,0x1
    4444:	79c080e7          	jalr	1948(ra) # 5bdc <exit>
...
0000000000004448 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4458:	87c50513          	addi	a0,a0,-1924 # 7cd0 <malloc+0x1cae>
    445c:	00001097          	auipc	ra,0x1
    4460:	7d0080e7          	jalr	2000(ra) # 5c2c <unlink>
  int pid = fork();
    4464:	00001097          	auipc	ra,0x1
    4468:	770080e7          	jalr	1904(ra) # 5bd4 <fork>
  if(pid < 0){
  ...
  sleep(20); // two seconds
    ...
    4478:	7f8080e7          	jalr	2040(ra) # 5c6c <sleep>
  close(open("stopforking", O_CREATE|O_RDWR));
    447c:	20200593          	li	a1,514
    4480:	00004517          	auipc	a0,0x4
    4484:	85050513          	addi	a0,a0,-1968 # 7cd0 <malloc+0x1cae>
    4488:	00001097          	auipc	ra,0x1
    448c:	794080e7          	jalr	1940(ra) # 5c1c <open>
    4490:	00001097          	auipc	ra,0x1
    4494:	774080e7          	jalr	1908(ra) # 5c04 <close>
  wait(0);
    4498:	4501                	li	a0,0
    449a:	00001097          	auipc	ra,0x1
    449e:	74a080e7          	jalr	1866(ra) # 5be4 <wait>
  sleep(10); // one second
    44a2:	4529                	li	a0,10
    44a4:	00001097          	auipc	ra,0x1
    44a8:	7c8080e7          	jalr	1992(ra) # 5c6c <sleep>
}
...
0000000000004518 <killstatus>:
{
    ...
    4534:	6a4080e7          	jalr	1700(ra) # 5bd4 <fork>
    4538:	84aa                	mv	s1,a0
    if(pid1 < 0){
    ...
    4546:	72a080e7          	jalr	1834(ra) # 5c6c <sleep>
    kill(pid1);
    454a:	8526                	mv	a0,s1
    454c:	00001097          	auipc	ra,0x1
    4550:	6c0080e7          	jalr	1728(ra) # 5c0c <kill>
    wait(&xst);
    4554:	fcc40513          	addi	a0,s0,-52
    4558:	00001097          	auipc	ra,0x1
    455c:	68c080e7          	jalr	1676(ra) # 5be4 <wait>
    if(xst != -1) {
  ...
  exit(0);
    ...
    4574:	66c080e7          	jalr	1644(ra) # 5bdc <exit>
      printf("%s: fork failed\n", s);
    4578:	85d2                	mv	a1,s4
    457a:	00002517          	auipc	a0,0x2
    457e:	47650513          	addi	a0,a0,1142 # 69f0 <malloc+0x9ce>
    4582:	00002097          	auipc	ra,0x2
    4586:	9e2080e7          	jalr	-1566(ra) # 5f64 <printf>
      exit(1);
    458a:	4505                	li	a0,1
    458c:	00001097          	auipc	ra,0x1
    4590:	650080e7          	jalr	1616(ra) # 5bdc <exit>
        getpid();
    4594:	00001097          	auipc	ra,0x1
    4598:	6c8080e7          	jalr	1736(ra) # 5c5c <getpid>
      while(1) {
    459c:	bfe5                	j	4594 <killstatus+0x7c>
       printf("%s: status should be -1\n", s);
    459e:	85d2                	mv	a1,s4
    45a0:	00003517          	auipc	a0,0x3
    45a4:	74050513          	addi	a0,a0,1856 # 7ce0 <malloc+0x1cbe>
    45a8:	00002097          	auipc	ra,0x2
    45ac:	9bc080e7          	jalr	-1604(ra) # 5f64 <printf>
       exit(1);
    45b0:	4505                	li	a0,1
    45b2:	00001097          	auipc	ra,0x1
    45b6:	62a080e7          	jalr	1578(ra) # 5bdc <exit>
...
00000000000045ba <preempt>:
{
  ...
  pid1 = fork();
    ...
    45d0:	608080e7          	jalr	1544(ra) # 5bd4 <fork>
  if(pid1 < 0) {
  ...
  if(pid1 == 0)
    ...
    45e4:	5d050513          	addi	a0,a0,1488 # 6bb0 <malloc+0xb8e>
    45e8:	00002097          	auipc	ra,0x2
    45ec:	97c080e7          	jalr	-1668(ra) # 5f64 <printf>
    exit(1);
    45f0:	4505                	li	a0,1
    45f2:	00001097          	auipc	ra,0x1
    45f6:	5ea080e7          	jalr	1514(ra) # 5bdc <exit>
  pid2 = fork();
    45fa:	00001097          	auipc	ra,0x1
    45fe:	5da080e7          	jalr	1498(ra) # 5bd4 <fork>
    4602:	89aa                	mv	s3,a0
  if(pid2 < 0) {
  ...
  if(pid2 == 0)
    ...
    4612:	3e250513          	addi	a0,a0,994 # 69f0 <malloc+0x9ce>
    4616:	00002097          	auipc	ra,0x2
    461a:	94e080e7          	jalr	-1714(ra) # 5f64 <printf>
    exit(1);
    461e:	4505                	li	a0,1
    4620:	00001097          	auipc	ra,0x1
    4624:	5bc080e7          	jalr	1468(ra) # 5bdc <exit>
  pipe(pfds);
    4628:	fc840513          	addi	a0,s0,-56
    462c:	00001097          	auipc	ra,0x1
    4630:	5c0080e7          	jalr	1472(ra) # 5bec <pipe>
  pid3 = fork();
    4634:	00001097          	auipc	ra,0x1
    4638:	5a0080e7          	jalr	1440(ra) # 5bd4 <fork>
    463c:	8a2a                	mv	s4,a0
  if(pid3 < 0) {
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46c8:	530080e7          	jalr	1328(ra) # 5bf4 <read>
    46cc:	4785                	li	a5,1
    46ce:	02f50363          	beq	a0,a5,46f4 <preempt+0x13a>
    printf("%s: preempt read error", s);
    46d2:	85ca                	mv	a1,s2
    46d4:	00003517          	auipc	a0,0x3
    46d8:	64450513          	addi	a0,a0,1604 # 7d18 <malloc+0x1cf6>
    46dc:	00002097          	auipc	ra,0x2
    46e0:	888080e7          	jalr	-1912(ra) # 5f64 <printf>
}
  ...
  close(pfds[0]);
    ...
    46fc:	50c080e7          	jalr	1292(ra) # 5c04 <close>
  printf("kill... ");
    4700:	00003517          	auipc	a0,0x3
    4704:	63050513          	addi	a0,a0,1584 # 7d30 <malloc+0x1d0e>
    4708:	00002097          	auipc	ra,0x2
    470c:	85c080e7          	jalr	-1956(ra) # 5f64 <printf>
  kill(pid1);
    4710:	8526                	mv	a0,s1
    4712:	00001097          	auipc	ra,0x1
    4716:	4fa080e7          	jalr	1274(ra) # 5c0c <kill>
  kill(pid2);
    471a:	854e                	mv	a0,s3
    471c:	00001097          	auipc	ra,0x1
    4720:	4f0080e7          	jalr	1264(ra) # 5c0c <kill>
  kill(pid3);
    4724:	8552                	mv	a0,s4
    4726:	00001097          	auipc	ra,0x1
    472a:	4e6080e7          	jalr	1254(ra) # 5c0c <kill>
  printf("wait... ");
    472e:	00003517          	auipc	a0,0x3
    4732:	61250513          	addi	a0,a0,1554 # 7d40 <malloc+0x1d1e>
    4736:	00002097          	auipc	ra,0x2
    473a:	82e080e7          	jalr	-2002(ra) # 5f64 <printf>
  wait(0);
    473e:	4501                	li	a0,0
    4740:	00001097          	auipc	ra,0x1
    4744:	4a4080e7          	jalr	1188(ra) # 5be4 <wait>
  wait(0);
    4748:	4501                	li	a0,0
    474a:	00001097          	auipc	ra,0x1
    474e:	49a080e7          	jalr	1178(ra) # 5be4 <wait>
  wait(0);
    4752:	4501                	li	a0,0
    4754:	00001097          	auipc	ra,0x1
    4758:	490080e7          	jalr	1168(ra) # 5be4 <wait>
...
000000000000475e <reparent>:
{
  ...
  int master_pid = getpid();
    ...
    4774:	4ec080e7          	jalr	1260(ra) # 5c5c <getpid>
    4778:	8a2a                	mv	s4,a0
    477a:	0c800913          	li	s2,200
    int pid = fork();
    477e:	00001097          	auipc	ra,0x1
    4782:	456080e7          	jalr	1110(ra) # 5bd4 <fork>
    4786:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    4794:	454080e7          	jalr	1108(ra) # 5be4 <wait>
  ...
  exit(0);
    ...
    47a8:	438080e7          	jalr	1080(ra) # 5bdc <exit>
      printf("%s: fork failed\n", s);
    47ac:	85ce                	mv	a1,s3
    47ae:	00002517          	auipc	a0,0x2
    47b2:	24250513          	addi	a0,a0,578 # 69f0 <malloc+0x9ce>
    47b6:	00001097          	auipc	ra,0x1
    47ba:	7ae080e7          	jalr	1966(ra) # 5f64 <printf>
      exit(1);
    47be:	4505                	li	a0,1
    47c0:	00001097          	auipc	ra,0x1
    47c4:	41c080e7          	jalr	1052(ra) # 5bdc <exit>
        printf("%s: wait wrong pid\n", s);
    47c8:	85ce                	mv	a1,s3
    47ca:	00002517          	auipc	a0,0x2
    47ce:	3ae50513          	addi	a0,a0,942 # 6b78 <malloc+0xb56>
    47d2:	00001097          	auipc	ra,0x1
    47d6:	792080e7          	jalr	1938(ra) # 5f64 <printf>
        exit(1);
    47da:	4505                	li	a0,1
    47dc:	00001097          	auipc	ra,0x1
    47e0:	400080e7          	jalr	1024(ra) # 5bdc <exit>
      int pid2 = fork();
    47e4:	00001097          	auipc	ra,0x1
    47e8:	3f0080e7          	jalr	1008(ra) # 5bd4 <fork>
      if(pid2 < 0){
    47ec:	00054763          	bltz	a0,47fa <reparent+0x9c>
      exit(0);
    47f0:	4501                	li	a0,0
    47f2:	00001097          	auipc	ra,0x1
    47f6:	3ea080e7          	jalr	1002(ra) # 5bdc <exit>
        kill(master_pid);
    47fa:	8552                	mv	a0,s4
    47fc:	00001097          	auipc	ra,0x1
    4800:	410080e7          	jalr	1040(ra) # 5c0c <kill>
        exit(1);
    4804:	4505                	li	a0,1
    4806:	00001097          	auipc	ra,0x1
    480a:	3d6080e7          	jalr	982(ra) # 5bdc <exit>
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    482a:	3c6080e7          	jalr	966(ra) # 5bec <pipe>
    ...
    4844:	2b850513          	addi	a0,a0,696 # 6af8 <malloc+0xad6>
    4848:	00001097          	auipc	ra,0x1
    484c:	71c080e7          	jalr	1820(ra) # 5f64 <printf>
    exit(1);
    4850:	4505                	li	a0,1
    4852:	00001097          	auipc	ra,0x1
    4856:	38a080e7          	jalr	906(ra) # 5bdc <exit>
      sbrk(BIG - (uint64)sbrk(0));
    485a:	00001097          	auipc	ra,0x1
    485e:	40a080e7          	jalr	1034(ra) # 5c64 <sbrk>
    4862:	064007b7          	lui	a5,0x6400
    4866:	40a7853b          	subw	a0,a5,a0
    486a:	00001097          	auipc	ra,0x1
    486e:	3fa080e7          	jalr	1018(ra) # 5c64 <sbrk>
      write(fds[1], "x", 1);
    4872:	4605                	li	a2,1
    4874:	00002597          	auipc	a1,0x2
    4878:	96458593          	addi	a1,a1,-1692 # 61d8 <malloc+0x1b6>
    487c:	fb442503          	lw	a0,-76(s0)
    4880:	00001097          	auipc	ra,0x1
    4884:	37c080e7          	jalr	892(ra) # 5bfc <write>
      for(;;) sleep(1000);
    4888:	3e800513          	li	a0,1000
    488c:	00001097          	auipc	ra,0x1
    4890:	3e0080e7          	jalr	992(ra) # 5c6c <sleep>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    48a0:	338080e7          	jalr	824(ra) # 5bd4 <fork>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    48e2:	32e080e7          	jalr	814(ra) # 5c0c <kill>
    wait(0);
    48e6:	4501                	li	a0,0
    48e8:	00001097          	auipc	ra,0x1
    48ec:	2fc080e7          	jalr	764(ra) # 5be4 <wait>
  ...
  pid = fork();
    ...
    48fc:	2dc080e7          	jalr	732(ra) # 5bd4 <fork>
    4900:	84aa                	mv	s1,a0
  if(pid < 0){
  ...
  wait(&xstatus);
    ...
    4910:	2d8080e7          	jalr	728(ra) # 5be4 <wait>
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	41850513          	addi	a0,a0,1048 # 7d50 <malloc+0x1d2e>
    4940:	00001097          	auipc	ra,0x1
    4944:	624080e7          	jalr	1572(ra) # 5f64 <printf>
    exit(1);
    4948:	4505                	li	a0,1
    494a:	00001097          	auipc	ra,0x1
    494e:	292080e7          	jalr	658(ra) # 5bdc <exit>
    printf("%s: fork failed\n", s);
    4952:	85d6                	mv	a1,s5
    4954:	00002517          	auipc	a0,0x2
    4958:	09c50513          	addi	a0,a0,156 # 69f0 <malloc+0x9ce>
    495c:	00001097          	auipc	ra,0x1
    4960:	608080e7          	jalr	1544(ra) # 5f64 <printf>
    exit(1);
    4964:	4505                	li	a0,1
    4966:	00001097          	auipc	ra,0x1
    496a:	276080e7          	jalr	630(ra) # 5bdc <exit>
    a = sbrk(0);
    496e:	4501                	li	a0,0
    4970:	00001097          	auipc	ra,0x1
    4974:	2f4080e7          	jalr	756(ra) # 5c64 <sbrk>
    4978:	892a                	mv	s2,a0
    sbrk(10*BIG);
    497a:	3e800537          	lui	a0,0x3e800
    497e:	00001097          	auipc	ra,0x1
    4982:	2e6080e7          	jalr	742(ra) # 5c64 <sbrk>
    ...
    49a4:	3d050513          	addi	a0,a0,976 # 7d70 <malloc+0x1d4e>
    49a8:	00001097          	auipc	ra,0x1
    49ac:	5bc080e7          	jalr	1468(ra) # 5f64 <printf>
    exit(1);
    49b0:	4505                	li	a0,1
    49b2:	00001097          	auipc	ra,0x1
    49b6:	22a080e7          	jalr	554(ra) # 5bdc <exit>
    exit(1);
    49ba:	4505                	li	a0,1
    49bc:	00001097          	auipc	ra,0x1
    49c0:	220080e7          	jalr	544(ra) # 5bdc <exit>
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    49d8:	200080e7          	jalr	512(ra) # 5bd4 <fork>
    m1 = 0;
    49dc:	4481                	li	s1,0
  ...
  if((pid = fork()) == 0){
    ...
    49ee:	1fa080e7          	jalr	506(ra) # 5be4 <wait>
    if(xstatus == -1){
    ...
    4a00:	1e0080e7          	jalr	480(ra) # 5bdc <exit>
      *(char**)m2 = m1;
    ...
    4a0e:	618080e7          	jalr	1560(ra) # 6022 <malloc>
    ...
    4a1e:	580080e7          	jalr	1408(ra) # 5f9a <free>
    while(m1){
    4a22:	f8f5                	bnez	s1,4a16 <mem+0x52>
    m1 = malloc(1024*20);
    4a24:	6515                	lui	a0,0x5
    4a26:	00001097          	auipc	ra,0x1
    4a2a:	5fc080e7          	jalr	1532(ra) # 6022 <malloc>
    if(m1 == 0){
    4a2e:	c911                	beqz	a0,4a42 <mem+0x7e>
    free(m1);
    4a30:	00001097          	auipc	ra,0x1
    4a34:	56a080e7          	jalr	1386(ra) # 5f9a <free>
    exit(0);
    4a38:	4501                	li	a0,0
    4a3a:	00001097          	auipc	ra,0x1
    4a3e:	1a2080e7          	jalr	418(ra) # 5bdc <exit>
      printf("couldn't allocate mem?!!\n", s);
    4a42:	85ce                	mv	a1,s3
    4a44:	00003517          	auipc	a0,0x3
    4a48:	35c50513          	addi	a0,a0,860 # 7da0 <malloc+0x1d7e>
    4a4c:	00001097          	auipc	ra,0x1
    4a50:	518080e7          	jalr	1304(ra) # 5f64 <printf>
      exit(1);
    4a54:	4505                	li	a0,1
    4a56:	00001097          	auipc	ra,0x1
    4a5a:	186080e7          	jalr	390(ra) # 5bdc <exit>
      exit(0);
    4a5e:	4501                	li	a0,0
    4a60:	00001097          	auipc	ra,0x1
    4a64:	17c080e7          	jalr	380(ra) # 5bdc <exit>
...
0000000000004a68 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    4a84:	34050513          	addi	a0,a0,832 # 7dc0 <malloc+0x1d9e>
    4a88:	00001097          	auipc	ra,0x1
    4a8c:	1a4080e7          	jalr	420(ra) # 5c2c <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    4a90:	20200593          	li	a1,514
    4a94:	00003517          	auipc	a0,0x3
    4a98:	32c50513          	addi	a0,a0,812 # 7dc0 <malloc+0x1d9e>
    4a9c:	00001097          	auipc	ra,0x1
    4aa0:	180080e7          	jalr	384(ra) # 5c1c <open>
  if(fd < 0){
    4aa4:	04054a63          	bltz	a0,4af8 <sharedfd+0x90>
    4aa8:	892a                	mv	s2,a0
  pid = fork();
    4aaa:	00001097          	auipc	ra,0x1
    4aae:	12a080e7          	jalr	298(ra) # 5bd4 <fork>
    4ab2:	89aa                	mv	s3,a0
  memset(buf, pid==0?'c':'p', sizeof(buf));
    ...
    4adc:	124080e7          	jalr	292(ra) # 5bfc <write>
    4ae0:	47a9                	li	a5,10
  ...
  if(pid == 0) {
    ...
    4af4:	0ec080e7          	jalr	236(ra) # 5bdc <exit>
    printf("%s: cannot open sharedfd for writing", s);
    4af8:	85d2                	mv	a1,s4
    4afa:	00003517          	auipc	a0,0x3
    4afe:	2d650513          	addi	a0,a0,726 # 7dd0 <malloc+0x1dae>
    4b02:	00001097          	auipc	ra,0x1
    4b06:	462080e7          	jalr	1122(ra) # 5f64 <printf>
    exit(1);
    4b0a:	4505                	li	a0,1
    4b0c:	00001097          	auipc	ra,0x1
    4b10:	0d0080e7          	jalr	208(ra) # 5bdc <exit>
      printf("%s: write sharedfd failed\n", s);
    4b14:	85d2                	mv	a1,s4
    4b16:	00003517          	auipc	a0,0x3
    4b1a:	2e250513          	addi	a0,a0,738 # 7df8 <malloc+0x1dd6>
    4b1e:	00001097          	auipc	ra,0x1
    4b22:	446080e7          	jalr	1094(ra) # 5f64 <printf>
      exit(1);
    4b26:	4505                	li	a0,1
    4b28:	00001097          	auipc	ra,0x1
    4b2c:	0b4080e7          	jalr	180(ra) # 5bdc <exit>
    wait(&xstatus);
    4b30:	f9c40513          	addi	a0,s0,-100
    4b34:	00001097          	auipc	ra,0x1
    4b38:	0b0080e7          	jalr	176(ra) # 5be4 <wait>
    if(xstatus != 0)
    ...
    4b4a:	096080e7          	jalr	150(ra) # 5bdc <exit>
  close(fd);
    4b4e:	854a                	mv	a0,s2
    4b50:	00001097          	auipc	ra,0x1
    4b54:	0b4080e7          	jalr	180(ra) # 5c04 <close>
  fd = open("sharedfd", 0);
    4b58:	4581                	li	a1,0
    4b5a:	00003517          	auipc	a0,0x3
    4b5e:	26650513          	addi	a0,a0,614 # 7dc0 <malloc+0x1d9e>
    4b62:	00001097          	auipc	ra,0x1
    4b66:	0ba080e7          	jalr	186(ra) # 5c1c <open>
    4b6a:	8baa                	mv	s7,a0
  nc = np = 0;
    4b6c:	8ace                	mv	s5,s3
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b8a:	06e080e7          	jalr	110(ra) # 5bf4 <read>
    ...
    4b9e:	27e50513          	addi	a0,a0,638 # 7e18 <malloc+0x1df6>
    4ba2:	00001097          	auipc	ra,0x1
    4ba6:	3c2080e7          	jalr	962(ra) # 5f64 <printf>
    exit(1);
    4baa:	4505                	li	a0,1
    4bac:	00001097          	auipc	ra,0x1
    4bb0:	030080e7          	jalr	48(ra) # 5bdc <exit>
        nc++;
  ...
  close(fd);
    ...
    4bd2:	036080e7          	jalr	54(ra) # 5c04 <close>
  unlink("sharedfd");
    4bd6:	00003517          	auipc	a0,0x3
    4bda:	1ea50513          	addi	a0,a0,490 # 7dc0 <malloc+0x1d9e>
    4bde:	00001097          	auipc	ra,0x1
    4be2:	04e080e7          	jalr	78(ra) # 5c2c <unlink>
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	24450513          	addi	a0,a0,580 # 7e40 <malloc+0x1e1e>
    4c04:	00001097          	auipc	ra,0x1
    4c08:	360080e7          	jalr	864(ra) # 5f64 <printf>
    exit(1);
    4c0c:	4505                	li	a0,1
    4c0e:	00001097          	auipc	ra,0x1
    4c12:	fce080e7          	jalr	-50(ra) # 5bdc <exit>
    exit(0);
    4c16:	4501                	li	a0,0
    4c18:	00001097          	auipc	ra,0x1
    4c1c:	fc4080e7          	jalr	-60(ra) # 5bdc <exit>
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c46:	4ce78793          	addi	a5,a5,1230 # 6110 <malloc+0xee>
    4c4a:	f6f43823          	sd	a5,-144(s0)
    4c4e:	00001797          	auipc	a5,0x1
    4c52:	4ca78793          	addi	a5,a5,1226 # 6118 <malloc+0xf6>
    4c56:	f6f43c23          	sd	a5,-136(s0)
    4c5a:	00001797          	auipc	a5,0x1
    4c5e:	4c678793          	addi	a5,a5,1222 # 6120 <malloc+0xfe>
    4c62:	f8f43023          	sd	a5,-128(s0)
    4c66:	00001797          	auipc	a5,0x1
    4c6a:	4c278793          	addi	a5,a5,1218 # 6128 <malloc+0x106>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4c86:	faa080e7          	jalr	-86(ra) # 5c2c <unlink>
    pid = fork();
    4c8a:	00001097          	auipc	ra,0x1
    4c8e:	f4a080e7          	jalr	-182(ra) # 5bd4 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4caa:	f3e080e7          	jalr	-194(ra) # 5be4 <wait>
    if(xstatus != 0)
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4ce2:	11a50513          	addi	a0,a0,282 # 6df8 <malloc+0xdd6>
    4ce6:	00001097          	auipc	ra,0x1
    4cea:	27e080e7          	jalr	638(ra) # 5f64 <printf>
      exit(1);
    4cee:	4505                	li	a0,1
    4cf0:	00001097          	auipc	ra,0x1
    4cf4:	eec080e7          	jalr	-276(ra) # 5bdc <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    4cf8:	20200593          	li	a1,514
    4cfc:	854e                	mv	a0,s3
    4cfe:	00001097          	auipc	ra,0x1
    4d02:	f1e080e7          	jalr	-226(ra) # 5c1c <open>
    4d06:	892a                	mv	s2,a0
      if(fd < 0){
    ...
    4d3a:	ec6080e7          	jalr	-314(ra) # 5bfc <write>
    4d3e:	85aa                	mv	a1,a0
    ...
    4d52:	e8e080e7          	jalr	-370(ra) # 5bdc <exit>
        printf("create failed\n", s);
    4d56:	f5843583          	ld	a1,-168(s0)
    4d5a:	00003517          	auipc	a0,0x3
    4d5e:	0fe50513          	addi	a0,a0,254 # 7e58 <malloc+0x1e36>
    4d62:	00001097          	auipc	ra,0x1
    4d66:	202080e7          	jalr	514(ra) # 5f64 <printf>
        exit(1);
    4d6a:	4505                	li	a0,1
    4d6c:	00001097          	auipc	ra,0x1
    4d70:	e70080e7          	jalr	-400(ra) # 5bdc <exit>
          printf("write failed %d\n", n);
    4d74:	00003517          	auipc	a0,0x3
    4d78:	0f450513          	addi	a0,a0,244 # 7e68 <malloc+0x1e46>
    4d7c:	00001097          	auipc	ra,0x1
    4d80:	1e8080e7          	jalr	488(ra) # 5f64 <printf>
          exit(1);
    4d84:	4505                	li	a0,1
    4d86:	00001097          	auipc	ra,0x1
    4d8a:	e56080e7          	jalr	-426(ra) # 5bdc <exit>
      exit(xstatus);
    4d8e:	855a                	mv	a0,s6
    4d90:	00001097          	auipc	ra,0x1
    4d94:	e4c080e7          	jalr	-436(ra) # 5bdc <exit>
          printf("wrong char\n", s);
    4d98:	f5843583          	ld	a1,-168(s0)
    4d9c:	00003517          	auipc	a0,0x3
    4da0:	0e450513          	addi	a0,a0,228 # 7e80 <malloc+0x1e5e>
    4da4:	00001097          	auipc	ra,0x1
    4da8:	1c0080e7          	jalr	448(ra) # 5f64 <printf>
          exit(1);
    4dac:	4505                	li	a0,1
    4dae:	00001097          	auipc	ra,0x1
    4db2:	e2e080e7          	jalr	-466(ra) # 5bdc <exit>
      total += n;
    ...
    4dc4:	e34080e7          	jalr	-460(ra) # 5bf4 <read>
    ...
    4df4:	e14080e7          	jalr	-492(ra) # 5c04 <close>
    if(total != N*SZ){
    4df8:	03b91863          	bne	s2,s11,4e28 <fourfiles+0x208>
    unlink(fname);
    4dfc:	8566                	mv	a0,s9
    4dfe:	00001097          	auipc	ra,0x1
    4e02:	e2e080e7          	jalr	-466(ra) # 5c2c <unlink>
  for(i = 0; i < NCHILD; i++){
    ...
    4e1a:	e06080e7          	jalr	-506(ra) # 5c1c <open>
    4e1e:	89aa                	mv	s3,a0
    total = 0;
    4e20:	895a                	mv	s2,s6
        if(buf[j] != '0'+i){
    ...
    4e2e:	06650513          	addi	a0,a0,102 # 7e90 <malloc+0x1e6e>
    4e32:	00001097          	auipc	ra,0x1
    4e36:	132080e7          	jalr	306(ra) # 5f64 <printf>
      exit(1);
    4e3a:	4505                	li	a0,1
    4e3c:	00001097          	auipc	ra,0x1
    4e40:	da0080e7          	jalr	-608(ra) # 5bdc <exit>
}
...
0000000000004e62 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e90:	01cb8b93          	addi	s7,s7,28 # 7ea8 <malloc+0x1e86>
  for(i = 0; i < N; i++){
    ...
    4ea4:	d9c080e7          	jalr	-612(ra) # 5c3c <link>
    if(pid == 0) {
    ...
    4ec2:	d5e080e7          	jalr	-674(ra) # 5c1c <open>
      if(fd < 0){
    4ec6:	26055b63          	bgez	a0,513c <concreate+0x2da>
        printf("concreate create %s failed\n", file);
    4eca:	fa840593          	addi	a1,s0,-88
    4ece:	00003517          	auipc	a0,0x3
    4ed2:	fe250513          	addi	a0,a0,-30 # 7eb0 <malloc+0x1e8e>
    4ed6:	00001097          	auipc	ra,0x1
    4eda:	08e080e7          	jalr	142(ra) # 5f64 <printf>
        exit(1);
    4ede:	4505                	li	a0,1
    4ee0:	00001097          	auipc	ra,0x1
    4ee4:	cfc080e7          	jalr	-772(ra) # 5bdc <exit>
      link("C0", file);
    4ee8:	fa840593          	addi	a1,s0,-88
    4eec:	00003517          	auipc	a0,0x3
    4ef0:	fbc50513          	addi	a0,a0,-68 # 7ea8 <malloc+0x1e86>
    4ef4:	00001097          	auipc	ra,0x1
    4ef8:	d48080e7          	jalr	-696(ra) # 5c3c <link>
      exit(0);
    4efc:	4501                	li	a0,0
    4efe:	00001097          	auipc	ra,0x1
    4f02:	cde080e7          	jalr	-802(ra) # 5bdc <exit>
        exit(1);
    4f06:	4505                	li	a0,1
    4f08:	00001097          	auipc	ra,0x1
    4f0c:	cd4080e7          	jalr	-812(ra) # 5bdc <exit>
  ...
  fd = open(".", 0);
    ...
    4f28:	92c50513          	addi	a0,a0,-1748 # 6850 <malloc+0x82e>
    4f2c:	00001097          	auipc	ra,0x1
    4f30:	cf0080e7          	jalr	-784(ra) # 5c1c <open>
    4f34:	892a                	mv	s2,a0
  n = 0;
    4f36:	8aa6                	mv	s5,s1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f4e:	caa080e7          	jalr	-854(ra) # 5bf4 <read>
    ...
    4f9e:	f3650513          	addi	a0,a0,-202 # 7ed0 <malloc+0x1eae>
    4fa2:	00001097          	auipc	ra,0x1
    4fa6:	fc2080e7          	jalr	-62(ra) # 5f64 <printf>
        exit(1);
    4faa:	4505                	li	a0,1
    4fac:	00001097          	auipc	ra,0x1
    4fb0:	c30080e7          	jalr	-976(ra) # 5bdc <exit>
        printf("%s: concreate duplicate file %s\n", s, de.name);
    4fb4:	f7240613          	addi	a2,s0,-142
    4fb8:	85ce                	mv	a1,s3
    4fba:	00003517          	auipc	a0,0x3
    4fbe:	f3650513          	addi	a0,a0,-202 # 7ef0 <malloc+0x1ece>
    4fc2:	00001097          	auipc	ra,0x1
    4fc6:	fa2080e7          	jalr	-94(ra) # 5f64 <printf>
        exit(1);
    4fca:	4505                	li	a0,1
    4fcc:	00001097          	auipc	ra,0x1
    4fd0:	c10080e7          	jalr	-1008(ra) # 5bdc <exit>
  close(fd);
    4fd4:	854a                	mv	a0,s2
    4fd6:	00001097          	auipc	ra,0x1
    4fda:	c2e080e7          	jalr	-978(ra) # 5c04 <close>
  if(n != N){
  ...
  for(i = 0; i < N; i++){
    ...
    4ff6:	f2650513          	addi	a0,a0,-218 # 7f18 <malloc+0x1ef6>
    4ffa:	00001097          	auipc	ra,0x1
    4ffe:	f6a080e7          	jalr	-150(ra) # 5f64 <printf>
    exit(1);
    5002:	4505                	li	a0,1
    5004:	00001097          	auipc	ra,0x1
    5008:	bd8080e7          	jalr	-1064(ra) # 5bdc <exit>
      printf("%s: fork failed\n", s);
    500c:	85ce                	mv	a1,s3
    500e:	00002517          	auipc	a0,0x2
    5012:	9e250513          	addi	a0,a0,-1566 # 69f0 <malloc+0x9ce>
    5016:	00001097          	auipc	ra,0x1
    501a:	f4e080e7          	jalr	-178(ra) # 5f64 <printf>
      exit(1);
    501e:	4505                	li	a0,1
    5020:	00001097          	auipc	ra,0x1
    5024:	bbc080e7          	jalr	-1092(ra) # 5bdc <exit>
      close(open(file, 0));
    5028:	4581                	li	a1,0
    502a:	fa840513          	addi	a0,s0,-88
    502e:	00001097          	auipc	ra,0x1
    5032:	bee080e7          	jalr	-1042(ra) # 5c1c <open>
    5036:	00001097          	auipc	ra,0x1
    503a:	bce080e7          	jalr	-1074(ra) # 5c04 <close>
      close(open(file, 0));
    503e:	4581                	li	a1,0
    5040:	fa840513          	addi	a0,s0,-88
    5044:	00001097          	auipc	ra,0x1
    5048:	bd8080e7          	jalr	-1064(ra) # 5c1c <open>
    504c:	00001097          	auipc	ra,0x1
    5050:	bb8080e7          	jalr	-1096(ra) # 5c04 <close>
      close(open(file, 0));
    5054:	4581                	li	a1,0
    5056:	fa840513          	addi	a0,s0,-88
    505a:	00001097          	auipc	ra,0x1
    505e:	bc2080e7          	jalr	-1086(ra) # 5c1c <open>
    5062:	00001097          	auipc	ra,0x1
    5066:	ba2080e7          	jalr	-1118(ra) # 5c04 <close>
      close(open(file, 0));
    506a:	4581                	li	a1,0
    506c:	fa840513          	addi	a0,s0,-88
    5070:	00001097          	auipc	ra,0x1
    5074:	bac080e7          	jalr	-1108(ra) # 5c1c <open>
    5078:	00001097          	auipc	ra,0x1
    507c:	b8c080e7          	jalr	-1140(ra) # 5c04 <close>
      close(open(file, 0));
    5080:	4581                	li	a1,0
    5082:	fa840513          	addi	a0,s0,-88
    5086:	00001097          	auipc	ra,0x1
    508a:	b96080e7          	jalr	-1130(ra) # 5c1c <open>
    508e:	00001097          	auipc	ra,0x1
    5092:	b76080e7          	jalr	-1162(ra) # 5c04 <close>
      close(open(file, 0));
    5096:	4581                	li	a1,0
    5098:	fa840513          	addi	a0,s0,-88
    509c:	00001097          	auipc	ra,0x1
    50a0:	b80080e7          	jalr	-1152(ra) # 5c1c <open>
    50a4:	00001097          	auipc	ra,0x1
    50a8:	b60080e7          	jalr	-1184(ra) # 5c04 <close>
    if(pid == 0)
    50ac:	08090363          	beqz	s2,5132 <concreate+0x2d0>
      wait(0);
    50b0:	4501                	li	a0,0
    50b2:	00001097          	auipc	ra,0x1
    50b6:	b32080e7          	jalr	-1230(ra) # 5be4 <wait>
  for(i = 0; i < N; i++){
    ...
    50cc:	b0c080e7          	jalr	-1268(ra) # 5bd4 <fork>
    50d0:	892a                	mv	s2,a0
    if(pid < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    5178:	ab8080e7          	jalr	-1352(ra) # 5c2c <unlink>
    pid = fork();
    517c:	00001097          	auipc	ra,0x1
    5180:	a58080e7          	jalr	-1448(ra) # 5bd4 <fork>
    if(pid && (i % 3) == 1){
    ...
    519c:	a84080e7          	jalr	-1404(ra) # 5c1c <open>
      if(fd < 0){
...
00000000000051bc <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    51d4:	d8050513          	addi	a0,a0,-640 # 7f50 <malloc+0x1f2e>
    51d8:	00001097          	auipc	ra,0x1
    51dc:	a54080e7          	jalr	-1452(ra) # 5c2c <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    51e0:	20200593          	li	a1,514
    51e4:	00003517          	auipc	a0,0x3
    51e8:	d6c50513          	addi	a0,a0,-660 # 7f50 <malloc+0x1f2e>
    51ec:	00001097          	auipc	ra,0x1
    51f0:	a30080e7          	jalr	-1488(ra) # 5c1c <open>
    51f4:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    51f6:	4481                	li	s1,0
    memset(buf, i, SZ);
  ...
  if(fd < 0){
    ...
    5222:	9de080e7          	jalr	-1570(ra) # 5bfc <write>
  ...
  close(fd);
    ...
    523a:	9ce080e7          	jalr	-1586(ra) # 5c04 <close>
  fd = open("bigfile.dat", 0);
    523e:	4581                	li	a1,0
    5240:	00003517          	auipc	a0,0x3
    5244:	d1050513          	addi	a0,a0,-752 # 7f50 <malloc+0x1f2e>
    5248:	00001097          	auipc	ra,0x1
    524c:	9d4080e7          	jalr	-1580(ra) # 5c1c <open>
    5250:	8a2a                	mv	s4,a0
  total = 0;
    5252:	4981                	li	s3,0
  for(i = 0; ; i++){
  ...
  if(fd < 0){
    ...
    526e:	98a080e7          	jalr	-1654(ra) # 5bf4 <read>
    if(cc < 0){
  ...
  for(i = 0; ; i++){
    ...
    52a8:	cbc50513          	addi	a0,a0,-836 # 7f60 <malloc+0x1f3e>
    52ac:	00001097          	auipc	ra,0x1
    52b0:	cb8080e7          	jalr	-840(ra) # 5f64 <printf>
    exit(1);
    52b4:	4505                	li	a0,1
    52b6:	00001097          	auipc	ra,0x1
    52ba:	926080e7          	jalr	-1754(ra) # 5bdc <exit>
      printf("%s: write bigfile failed\n", s);
    52be:	85d6                	mv	a1,s5
    52c0:	00003517          	auipc	a0,0x3
    52c4:	cc050513          	addi	a0,a0,-832 # 7f80 <malloc+0x1f5e>
    52c8:	00001097          	auipc	ra,0x1
    52cc:	c9c080e7          	jalr	-868(ra) # 5f64 <printf>
      exit(1);
    52d0:	4505                	li	a0,1
    52d2:	00001097          	auipc	ra,0x1
    52d6:	90a080e7          	jalr	-1782(ra) # 5bdc <exit>
    printf("%s: cannot open bigfile\n", s);
    52da:	85d6                	mv	a1,s5
    52dc:	00003517          	auipc	a0,0x3
    52e0:	cc450513          	addi	a0,a0,-828 # 7fa0 <malloc+0x1f7e>
    52e4:	00001097          	auipc	ra,0x1
    52e8:	c80080e7          	jalr	-896(ra) # 5f64 <printf>
    exit(1);
    52ec:	4505                	li	a0,1
    52ee:	00001097          	auipc	ra,0x1
    52f2:	8ee080e7          	jalr	-1810(ra) # 5bdc <exit>
      printf("%s: read bigfile failed\n", s);
    52f6:	85d6                	mv	a1,s5
    52f8:	00003517          	auipc	a0,0x3
    52fc:	cc850513          	addi	a0,a0,-824 # 7fc0 <malloc+0x1f9e>
    5300:	00001097          	auipc	ra,0x1
    5304:	c64080e7          	jalr	-924(ra) # 5f64 <printf>
      exit(1);
    5308:	4505                	li	a0,1
    530a:	00001097          	auipc	ra,0x1
    530e:	8d2080e7          	jalr	-1838(ra) # 5bdc <exit>
      printf("%s: short read bigfile\n", s);
    5312:	85d6                	mv	a1,s5
    5314:	00003517          	auipc	a0,0x3
    5318:	ccc50513          	addi	a0,a0,-820 # 7fe0 <malloc+0x1fbe>
    531c:	00001097          	auipc	ra,0x1
    5320:	c48080e7          	jalr	-952(ra) # 5f64 <printf>
      exit(1);
    5324:	4505                	li	a0,1
    5326:	00001097          	auipc	ra,0x1
    532a:	8b6080e7          	jalr	-1866(ra) # 5bdc <exit>
      printf("%s: read bigfile wrong data\n", s);
    532e:	85d6                	mv	a1,s5
    5330:	00003517          	auipc	a0,0x3
    5334:	cc850513          	addi	a0,a0,-824 # 7ff8 <malloc+0x1fd6>
    5338:	00001097          	auipc	ra,0x1
    533c:	c2c080e7          	jalr	-980(ra) # 5f64 <printf>
      exit(1);
    5340:	4505                	li	a0,1
    5342:	00001097          	auipc	ra,0x1
    5346:	89a080e7          	jalr	-1894(ra) # 5bdc <exit>
  close(fd);
    534a:	8552                	mv	a0,s4
    534c:	00001097          	auipc	ra,0x1
    5350:	8b8080e7          	jalr	-1864(ra) # 5c04 <close>
  if(total != N*SZ){
  ...
  unlink("bigfile.dat");
    ...
    5362:	bf250513          	addi	a0,a0,-1038 # 7f50 <malloc+0x1f2e>
    5366:	00001097          	auipc	ra,0x1
    536a:	8c6080e7          	jalr	-1850(ra) # 5c2c <unlink>
}
    ...
    5386:	c9650513          	addi	a0,a0,-874 # 8018 <malloc+0x1ff6>
    538a:	00001097          	auipc	ra,0x1
    538e:	bda080e7          	jalr	-1062(ra) # 5f64 <printf>
    exit(1);
    5392:	4505                	li	a0,1
    5394:	00001097          	auipc	ra,0x1
    5398:	848080e7          	jalr	-1976(ra) # 5bdc <exit>
...
000000000000539c <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53be:	c7e50513          	addi	a0,a0,-898 # 8038 <malloc+0x2016>
    53c2:	00001097          	auipc	ra,0x1
    53c6:	ba2080e7          	jalr	-1118(ra) # 5f64 <printf>
  for(nfiles = 0; ; nfiles++){
    53ca:	4481                	li	s1,0
    name[0] = 'f';
    ...
    53de:	c6ec8c93          	addi	s9,s9,-914 # 8048 <malloc+0x2026>
    int total = 0;
    53e2:	4d81                	li	s11,0
    ...
    5458:	c0450513          	addi	a0,a0,-1020 # 8058 <malloc+0x2036>
    545c:	00001097          	auipc	ra,0x1
    5460:	b08080e7          	jalr	-1272(ra) # 5f64 <printf>
  while(nfiles >= 0){
  ...
  while(nfiles >= 0){
    ...
    54c0:	770080e7          	jalr	1904(ra) # 5c2c <unlink>
    nfiles--;
  ...
  printf("fsfull test finished\n");
    ...
    54ce:	bae50513          	addi	a0,a0,-1106 # 8078 <malloc+0x2056>
    54d2:	00001097          	auipc	ra,0x1
    54d6:	a92080e7          	jalr	-1390(ra) # 5f64 <printf>
}
    ...
    550a:	6f6080e7          	jalr	1782(ra) # 5bfc <write>
      if(cc < BSIZE)
    ...
    551e:	b4e50513          	addi	a0,a0,-1202 # 8068 <malloc+0x2046>
    5522:	00001097          	auipc	ra,0x1
    5526:	a42080e7          	jalr	-1470(ra) # 5f64 <printf>
    close(fd);
    552a:	854a                	mv	a0,s2
    552c:	00000097          	auipc	ra,0x0
    5530:	6d8080e7          	jalr	1752(ra) # 5c04 <close>
    if(total == 0)
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5550:	b4450513          	addi	a0,a0,-1212 # 8090 <malloc+0x206e>
    5554:	00001097          	auipc	ra,0x1
    5558:	a10080e7          	jalr	-1520(ra) # 5f64 <printf>
  if((pid = fork()) < 0) {
    555c:	00000097          	auipc	ra,0x0
    5560:	678080e7          	jalr	1656(ra) # 5bd4 <fork>
  ...
  if(pid == 0) {
    ...
    5572:	676080e7          	jalr	1654(ra) # 5be4 <wait>
    if(xstatus != 0) 
    5576:	fdc42783          	lw	a5,-36(s0)
    557a:	c7b9                	beqz	a5,55c8 <run+0x8c>
      printf("FAILED\n");
    557c:	00003517          	auipc	a0,0x3
    5580:	b3c50513          	addi	a0,a0,-1220 # 80b8 <malloc+0x2096>
    5584:	00001097          	auipc	ra,0x1
    5588:	9e0080e7          	jalr	-1568(ra) # 5f64 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    55a4:	b0050513          	addi	a0,a0,-1280 # 80a0 <malloc+0x207e>
    55a8:	00001097          	auipc	ra,0x1
    55ac:	9bc080e7          	jalr	-1604(ra) # 5f64 <printf>
    exit(1);
    55b0:	4505                	li	a0,1
    55b2:	00000097          	auipc	ra,0x0
    55b6:	62a080e7          	jalr	1578(ra) # 5bdc <exit>
    f(s);
    55ba:	854a                	mv	a0,s2
    55bc:	9482                	jalr	s1
    exit(0);
    ...
    55c4:	61c080e7          	jalr	1564(ra) # 5bdc <exit>
      printf("OK\n");
    55c8:	00003517          	auipc	a0,0x3
    55cc:	af850513          	addi	a0,a0,-1288 # 80c0 <malloc+0x209e>
    55d0:	00001097          	auipc	ra,0x1
    55d4:	994080e7          	jalr	-1644(ra) # 5f64 <printf>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    561c:	ab050513          	addi	a0,a0,-1360 # 80c8 <malloc+0x20a6>
    5620:	00001097          	auipc	ra,0x1
    5624:	944080e7          	jalr	-1724(ra) # 5f64 <printf>
        return 1;
    5628:	4505                	li	a0,1
}
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    564c:	5a4080e7          	jalr	1444(ra) # 5bec <pipe>
  ...
  int pid = fork();
    ...
    5658:	580080e7          	jalr	1408(ra) # 5bd4 <fork>
  ...
  if(pid == 0){
    ...
    566a:	59e080e7          	jalr	1438(ra) # 5c04 <close>
    ...
    5676:	b6698993          	addi	s3,s3,-1178 # 61d8 <malloc+0x1b6>
      uint64 a = (uint64) sbrk(4096);
    567a:	6505                	lui	a0,0x1
    567c:	00000097          	auipc	ra,0x0
    5680:	5e8080e7          	jalr	1512(ra) # 5c64 <sbrk>
      if(a == 0xffffffffffffffff){
    ...
    569c:	564080e7          	jalr	1380(ra) # 5bfc <write>
    56a0:	fc950de3          	beq	a0,s1,567a <countfree+0x44>
        printf("write() failed in countfree()\n");
    56a4:	00003517          	auipc	a0,0x3
    56a8:	a7c50513          	addi	a0,a0,-1412 # 8120 <malloc+0x20fe>
    56ac:	00001097          	auipc	ra,0x1
    56b0:	8b8080e7          	jalr	-1864(ra) # 5f64 <printf>
        exit(1);
    56b4:	4505                	li	a0,1
    56b6:	00000097          	auipc	ra,0x0
    56ba:	526080e7          	jalr	1318(ra) # 5bdc <exit>
    printf("pipe() failed in countfree()\n");
    56be:	00003517          	auipc	a0,0x3
    56c2:	a2250513          	addi	a0,a0,-1502 # 80e0 <malloc+0x20be>
    56c6:	00001097          	auipc	ra,0x1
    56ca:	89e080e7          	jalr	-1890(ra) # 5f64 <printf>
    exit(1);
    56ce:	4505                	li	a0,1
    56d0:	00000097          	auipc	ra,0x0
    56d4:	50c080e7          	jalr	1292(ra) # 5bdc <exit>
    printf("fork failed in countfree()\n");
    56d8:	00003517          	auipc	a0,0x3
    56dc:	a2850513          	addi	a0,a0,-1496 # 8100 <malloc+0x20de>
    56e0:	00001097          	auipc	ra,0x1
    56e4:	884080e7          	jalr	-1916(ra) # 5f64 <printf>
    exit(1);
    56e8:	4505                	li	a0,1
    56ea:	00000097          	auipc	ra,0x0
    56ee:	4f2080e7          	jalr	1266(ra) # 5bdc <exit>
      }
    }
    ...
    56f8:	4e8080e7          	jalr	1256(ra) # 5bdc <exit>
  }

  close(fds[1]);
    56fc:	fcc42503          	lw	a0,-52(s0)
    5700:	00000097          	auipc	ra,0x0
    5704:	504080e7          	jalr	1284(ra) # 5c04 <close>
  ...
  while(1){
    ...
    5718:	4e0080e7          	jalr	1248(ra) # 5bf4 <read>
    if(cc < 0){
  ...
  while(1){
    ...
    572a:	a1a50513          	addi	a0,a0,-1510 # 8140 <malloc+0x211e>
    572e:	00001097          	auipc	ra,0x1
    5732:	836080e7          	jalr	-1994(ra) # 5f64 <printf>
      exit(1);
    5736:	4505                	li	a0,1
    5738:	00000097          	auipc	ra,0x0
    573c:	4a4080e7          	jalr	1188(ra) # 5bdc <exit>
  }

  close(fds[0]);
    5740:	fc842503          	lw	a0,-56(s0)
    5744:	00000097          	auipc	ra,0x0
    5748:	4c0080e7          	jalr	1216(ra) # 5c04 <close>
  wait((int*)0);
    574c:	4501                	li	a0,0
    574e:	00000097          	auipc	ra,0x0
    5752:	496080e7          	jalr	1174(ra) # 5be4 <wait>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    578c:	9d8b8b93          	addi	s7,s7,-1576 # 8160 <malloc+0x213e>
    int free0 = countfree();
    int free1 = 0;
    ...
    57d6:	792080e7          	jalr	1938(ra) # 5f64 <printf>
    int free0 = countfree();
    ...
    5826:	742080e7          	jalr	1858(ra) # 5f64 <printf>
      if(continuous != 2) {
    ...
    5836:	732080e7          	jalr	1842(ra) # 5f64 <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if (drivetests(quick, continuous, justone)) {
    ...
    589a:	346080e7          	jalr	838(ra) # 5bdc <exit>
    589e:	892e                	mv	s2,a1
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    58a0:	00003597          	auipc	a1,0x3
    58a4:	92858593          	addi	a1,a1,-1752 # 81c8 <malloc+0x21a6>
    ...
    58ba:	96a58593          	addi	a1,a1,-1686 # 8220 <malloc+0x21fe>
    ...
    58d0:	94c58593          	addi	a1,a1,-1716 # 8218 <malloc+0x21f6>
  ...
  int continuous = 0;
    ...
    58fc:	8d850513          	addi	a0,a0,-1832 # 81d0 <malloc+0x21ae>
    5900:	00000097          	auipc	ra,0x0
    5904:	664080e7          	jalr	1636(ra) # 5f64 <printf>
    exit(1);
    5908:	4505                	li	a0,1
    590a:	00000097          	auipc	ra,0x0
    590e:	2d2080e7          	jalr	722(ra) # 5bdc <exit>
  int continuous = 0;
    5912:	84aa                	mv	s1,a0
  char *justone = 0;
    5914:	4601                	li	a2,0
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5928:	8dc50513          	addi	a0,a0,-1828 # 8200 <malloc+0x21de>
    592c:	00000097          	auipc	ra,0x0
    5930:	638080e7          	jalr	1592(ra) # 5f64 <printf>
  exit(0);
    5934:	4501                	li	a0,0
    5936:	00000097          	auipc	ra,0x0
    593a:	2a6080e7          	jalr	678(ra) # 5bdc <exit>
...
_main()
{
  ...
  exit(0);
    ...
    5954:	28c080e7          	jalr	652(ra) # 5bdc <exit>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    5a46:	1b2080e7          	jalr	434(ra) # 5bf4 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    5a98:	188080e7          	jalr	392(ra) # 5c1c <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    5aa8:	190080e7          	jalr	400(ra) # 5c34 <fstat>
    5aac:	892a                	mv	s2,a0
  close(fd);
    5aae:	8526                	mv	a0,s1
    5ab0:	00000097          	auipc	ra,0x0
    5ab4:	154080e7          	jalr	340(ra) # 5c04 <close>
  return r;
}
    5ab8:	854a                	mv	a0,s2
...
ugetpid(void)
{
  ...
  return u->pid;
    5bc4:	040007b7          	lui	a5,0x4000
}
    5bc8:	17f5                	addi	a5,a5,-3
    5bca:	07b2                	slli	a5,a5,0xc
    5bcc:	4388                	lw	a0,0(a5)
    5bce:	6422                	ld	s0,8(sp)
    5bd0:	0141                	addi	sp,sp,16
    5bd2:	8082                	ret

0000000000005bd4 <fork>:
...
putc(int fd, char c)
{
    5c8c:	1101                	addi	sp,sp,-32
    5c8e:	ec06                	sd	ra,24(sp)
    5c90:	e822                	sd	s0,16(sp)
    5c92:	1000                	addi	s0,sp,32
    5c94:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5c98:	4605                	li	a2,1
    5c9a:	fef40593          	addi	a1,s0,-17
    5c9e:	00000097          	auipc	ra,0x0
    5ca2:	f5e080e7          	jalr	-162(ra) # 5bfc <write>
}
    5ca6:	60e2                	ld	ra,24(sp)
    5ca8:	6442                	ld	s0,16(sp)
    5caa:	6105                	addi	sp,sp,32
    5cac:	8082                	ret

0000000000005cae <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
    5cbe:	c299                	beqz	a3,5cc4 <printint+0x16>
    5cc0:	0805c863          	bltz	a1,5d50 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5cc4:	2581                	sext.w	a1,a1
  neg = 0;
    5cc6:	4881                	li	a7,0
    5cc8:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5cce:	2601                	sext.w	a2,a2
    5cd0:	00003517          	auipc	a0,0x3
    5cd4:	8c050513          	addi	a0,a0,-1856 # 8590 <digits>
    5cd8:	883a                	mv	a6,a4
    5cda:	2705                	addiw	a4,a4,1
    5cdc:	02c5f7bb          	remuw	a5,a1,a2
    5ce0:	1782                	slli	a5,a5,0x20
    5ce2:	9381                	srli	a5,a5,0x20
    5ce4:	97aa                	add	a5,a5,a0
    5ce6:	0007c783          	lbu	a5,0(a5) # 4000000 <base+0x3ff0388>
    5cea:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5cee:	0005879b          	sext.w	a5,a1
    5cf2:	02c5d5bb          	divuw	a1,a1,a2
    5cf6:	0685                	addi	a3,a3,1
    5cf8:	fec7f0e3          	bgeu	a5,a2,5cd8 <printint+0x2a>
  if(neg)
    5cfc:	00088b63          	beqz	a7,5d12 <printint+0x64>
    buf[i++] = '-';
    5d00:	fd040793          	addi	a5,s0,-48
    5d04:	973e                	add	a4,a4,a5
    5d06:	02d00793          	li	a5,45
    5d0a:	fef70823          	sb	a5,-16(a4)
    5d0e:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5d12:	02e05863          	blez	a4,5d42 <printint+0x94>
    5d16:	fc040793          	addi	a5,s0,-64
    5d1a:	00e78933          	add	s2,a5,a4
    5d1e:	fff78993          	addi	s3,a5,-1
    5d22:	99ba                	add	s3,s3,a4
    5d24:	377d                	addiw	a4,a4,-1
    5d26:	1702                	slli	a4,a4,0x20
    5d28:	9301                	srli	a4,a4,0x20
    5d2a:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5d2e:	fff94583          	lbu	a1,-1(s2)
    5d32:	8526                	mv	a0,s1
    5d34:	00000097          	auipc	ra,0x0
    5d38:	f58080e7          	jalr	-168(ra) # 5c8c <putc>
  while(--i >= 0)
    5d3c:	197d                	addi	s2,s2,-1
    5d3e:	ff3918e3          	bne	s2,s3,5d2e <printint+0x80>
}
    ...
    5d4c:	6121                	addi	sp,sp,64
    5d4e:	8082                	ret
    x = -xx;
    5d50:	40b005bb          	negw	a1,a1
    neg = 1;
    5d54:	4885                	li	a7,1
    x = -xx;
    5d56:	bf8d                	j	5cc8 <printint+0x1a>

0000000000005d58 <vprintf>:
}
...
{
    5d58:	7119                	addi	sp,sp,-128
    5d5a:	fc86                	sd	ra,120(sp)
    5d5c:	f8a2                	sd	s0,112(sp)
    5d5e:	f4a6                	sd	s1,104(sp)
    5d60:	f0ca                	sd	s2,96(sp)
    5d62:	ecce                	sd	s3,88(sp)
    5d64:	e8d2                	sd	s4,80(sp)
    5d66:	e4d6                	sd	s5,72(sp)
    5d68:	e0da                	sd	s6,64(sp)
    5d6a:	fc5e                	sd	s7,56(sp)
    5d6c:	f862                	sd	s8,48(sp)
    5d6e:	f466                	sd	s9,40(sp)
    5d70:	f06a                	sd	s10,32(sp)
    5d72:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    5d76:	0005c903          	lbu	s2,0(a1)
    5d7a:	18090f63          	beqz	s2,5f18 <vprintf+0x1c0>
    5d7e:	8aaa                	mv	s5,a0
    5d80:	8b32                	mv	s6,a2
    5d82:	00158493          	addi	s1,a1,1
  state = 0;
    5d86:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5d88:	02500a13          	li	s4,37
      if(c == 'd'){
    5d8c:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    5d90:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5d94:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5d98:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5d9c:	00002b97          	auipc	s7,0x2
    5da0:	7f4b8b93          	addi	s7,s7,2036 # 8590 <digits>
    5da4:	a839                	j	5dc2 <vprintf+0x6a>
        putc(fd, c);
    5da6:	85ca                	mv	a1,s2
    5da8:	8556                	mv	a0,s5
    5daa:	00000097          	auipc	ra,0x0
    5dae:	ee2080e7          	jalr	-286(ra) # 5c8c <putc>
    5db2:	a019                	j	5db8 <vprintf+0x60>
    } else if(state == '%'){
    5db4:	01498f63          	beq	s3,s4,5dd2 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5db8:	0485                	addi	s1,s1,1
    5dba:	fff4c903          	lbu	s2,-1(s1)
    5dbe:	14090d63          	beqz	s2,5f18 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5dc2:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5dc6:	fe0997e3          	bnez	s3,5db4 <vprintf+0x5c>
      if(c == '%'){
    5dca:	fd479ee3          	bne	a5,s4,5da6 <vprintf+0x4e>
        state = '%';
    5dce:	89be                	mv	s3,a5
    5dd0:	b7e5                	j	5db8 <vprintf+0x60>
      if(c == 'd'){
    5dd2:	05878063          	beq	a5,s8,5e12 <vprintf+0xba>
      } else if(c == 'l') {
    5dd6:	05978c63          	beq	a5,s9,5e2e <vprintf+0xd6>
      } else if(c == 'x') {
    5dda:	07a78863          	beq	a5,s10,5e4a <vprintf+0xf2>
      } else if(c == 'p') {
    5dde:	09b78463          	beq	a5,s11,5e66 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5de2:	07300713          	li	a4,115
    5de6:	0ce78663          	beq	a5,a4,5eb2 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5dea:	06300713          	li	a4,99
    5dee:	0ee78e63          	beq	a5,a4,5eea <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5df2:	11478863          	beq	a5,s4,5f02 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5dfe:	e92080e7          	jalr	-366(ra) # 5c8c <putc>
        putc(fd, c);
    5e02:	85ca                	mv	a1,s2
    5e04:	8556                	mv	a0,s5
    5e06:	00000097          	auipc	ra,0x0
    5e0a:	e86080e7          	jalr	-378(ra) # 5c8c <putc>
      }
      state = 0;
    5e0e:	4981                	li	s3,0
    5e10:	b765                	j	5db8 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    5e24:	e8e080e7          	jalr	-370(ra) # 5cae <printint>
    5e28:	8b4a                	mv	s6,s2
      state = 0;
    5e2a:	4981                	li	s3,0
    5e2c:	b771                	j	5db8 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    5e40:	e72080e7          	jalr	-398(ra) # 5cae <printint>
    5e44:	8b4a                	mv	s6,s2
      state = 0;
    5e46:	4981                	li	s3,0
    5e48:	bf85                	j	5db8 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    5e4a:	008b0913          	addi	s2,s6,8
    5e4e:	4681                	li	a3,0
    5e50:	4641                	li	a2,16
    5e52:	000b2583          	lw	a1,0(s6)
    5e56:	8556                	mv	a0,s5
    5e58:	00000097          	auipc	ra,0x0
    5e5c:	e56080e7          	jalr	-426(ra) # 5cae <printint>
    5e60:	8b4a                	mv	s6,s2
      state = 0;
    5e62:	4981                	li	s3,0
    5e64:	bf91                	j	5db8 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5e66:	008b0793          	addi	a5,s6,8
    5e6a:	f8f43423          	sd	a5,-120(s0)
    5e6e:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5e72:	03000593          	li	a1,48
    5e76:	8556                	mv	a0,s5
    5e78:	00000097          	auipc	ra,0x0
    5e7c:	e14080e7          	jalr	-492(ra) # 5c8c <putc>
  putc(fd, 'x');
    5e80:	85ea                	mv	a1,s10
    5e82:	8556                	mv	a0,s5
    5e84:	00000097          	auipc	ra,0x0
    5e88:	e08080e7          	jalr	-504(ra) # 5c8c <putc>
    5e8c:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5e8e:	03c9d793          	srli	a5,s3,0x3c
    5e92:	97de                	add	a5,a5,s7
    5e94:	0007c583          	lbu	a1,0(a5)
    5e98:	8556                	mv	a0,s5
    5e9a:	00000097          	auipc	ra,0x0
    5e9e:	df2080e7          	jalr	-526(ra) # 5c8c <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5ea2:	0992                	slli	s3,s3,0x4
    5ea4:	397d                	addiw	s2,s2,-1
    5ea6:	fe0914e3          	bnez	s2,5e8e <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5eaa:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5eae:	4981                	li	s3,0
    5eb0:	b721                	j	5db8 <vprintf+0x60>
        s = va_arg(ap, char*);
    5eb2:	008b0993          	addi	s3,s6,8
    5eb6:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5eba:	02090163          	beqz	s2,5edc <vprintf+0x184>
        while(*s != 0){
    5ebe:	00094583          	lbu	a1,0(s2)
    5ec2:	c9a1                	beqz	a1,5f12 <vprintf+0x1ba>
          putc(fd, *s);
    5ec4:	8556                	mv	a0,s5
    5ec6:	00000097          	auipc	ra,0x0
    5eca:	dc6080e7          	jalr	-570(ra) # 5c8c <putc>
          s++;
    5ece:	0905                	addi	s2,s2,1
        while(*s != 0){
    5ed0:	00094583          	lbu	a1,0(s2)
    5ed4:	f9e5                	bnez	a1,5ec4 <vprintf+0x16c>
        s = va_arg(ap, char*);
    5ed6:	8b4e                	mv	s6,s3
      state = 0;
    5ed8:	4981                	li	s3,0
    5eda:	bdf9                	j	5db8 <vprintf+0x60>
          s = "(null)";
    5edc:	00002917          	auipc	s2,0x2
    5ee0:	6ac90913          	addi	s2,s2,1708 # 8588 <malloc+0x2566>
        while(*s != 0){
    5ee4:	02800593          	li	a1,40
    5ee8:	bff1                	j	5ec4 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5eea:	008b0913          	addi	s2,s6,8
    5eee:	000b4583          	lbu	a1,0(s6)
    5ef2:	8556                	mv	a0,s5
    5ef4:	00000097          	auipc	ra,0x0
    5ef8:	d98080e7          	jalr	-616(ra) # 5c8c <putc>
    5efc:	8b4a                	mv	s6,s2
      state = 0;
    5efe:	4981                	li	s3,0
    5f00:	bd65                	j	5db8 <vprintf+0x60>
        putc(fd, c);
    5f02:	85d2                	mv	a1,s4
    5f04:	8556                	mv	a0,s5
    5f06:	00000097          	auipc	ra,0x0
    5f0a:	d86080e7          	jalr	-634(ra) # 5c8c <putc>
      state = 0;
    5f0e:	4981                	li	s3,0
    5f10:	b565                	j	5db8 <vprintf+0x60>
        s = va_arg(ap, char*);
    5f12:	8b4e                	mv	s6,s3
      state = 0;
    5f14:	4981                	li	s3,0
    5f16:	b54d                	j	5db8 <vprintf+0x60>
    }
  }
}
    5f18:	70e6                	ld	ra,120(sp)
    5f1a:	7446                	ld	s0,112(sp)
    5f1c:	74a6                	ld	s1,104(sp)
    5f1e:	7906                	ld	s2,96(sp)
    5f20:	69e6                	ld	s3,88(sp)
    5f22:	6a46                	ld	s4,80(sp)
    5f24:	6aa6                	ld	s5,72(sp)
    5f26:	6b06                	ld	s6,64(sp)
    5f28:	7be2                	ld	s7,56(sp)
    5f2a:	7c42                	ld	s8,48(sp)
    5f2c:	7ca2                	ld	s9,40(sp)
    5f2e:	7d02                	ld	s10,32(sp)
    5f30:	6de2                	ld	s11,24(sp)
    5f32:	6109                	addi	sp,sp,128
    5f34:	8082                	ret

0000000000005f36 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5f36:	715d                	addi	sp,sp,-80
    5f38:	ec06                	sd	ra,24(sp)
    5f3a:	e822                	sd	s0,16(sp)
    5f3c:	1000                	addi	s0,sp,32
    5f3e:	e010                	sd	a2,0(s0)
    5f40:	e414                	sd	a3,8(s0)
    5f42:	e818                	sd	a4,16(s0)
    5f44:	ec1c                	sd	a5,24(s0)
    5f46:	03043023          	sd	a6,32(s0)
    5f4a:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5f4e:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5f52:	8622                	mv	a2,s0
    5f54:	00000097          	auipc	ra,0x0
    5f58:	e04080e7          	jalr	-508(ra) # 5d58 <vprintf>
}
    5f5c:	60e2                	ld	ra,24(sp)
    5f5e:	6442                	ld	s0,16(sp)
    5f60:	6161                	addi	sp,sp,80
    5f62:	8082                	ret

0000000000005f64 <printf>:

void
printf(const char *fmt, ...)
{
    5f64:	711d                	addi	sp,sp,-96
    5f66:	ec06                	sd	ra,24(sp)
    5f68:	e822                	sd	s0,16(sp)
    5f6a:	1000                	addi	s0,sp,32
    5f6c:	e40c                	sd	a1,8(s0)
    5f6e:	e810                	sd	a2,16(s0)
    5f70:	ec14                	sd	a3,24(s0)
    5f72:	f018                	sd	a4,32(s0)
    5f74:	f41c                	sd	a5,40(s0)
    5f76:	03043823          	sd	a6,48(s0)
    5f7a:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5f7e:	00840613          	addi	a2,s0,8
    5f82:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5f86:	85aa                	mv	a1,a0
    5f88:	4505                	li	a0,1
    5f8a:	00000097          	auipc	ra,0x0
    5f8e:	dce080e7          	jalr	-562(ra) # 5d58 <vprintf>
}
    5f92:	60e2                	ld	ra,24(sp)
    5f94:	6442                	ld	s0,16(sp)
    5f96:	6125                	addi	sp,sp,96
    5f98:	8082                	ret

0000000000005f9a <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5f9a:	1141                	addi	sp,sp,-16
    5f9c:	e422                	sd	s0,8(sp)
    5f9e:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5fa0:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fa4:	00003797          	auipc	a5,0x3
    5fa8:	4ac7b783          	ld	a5,1196(a5) # 9450 <freep>
    5fac:	a805                	j	5fdc <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5fae:	4618                	lw	a4,8(a2)
    5fb0:	9db9                	addw	a1,a1,a4
    5fb2:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5fb6:	6398                	ld	a4,0(a5)
    5fb8:	6318                	ld	a4,0(a4)
    5fba:	fee53823          	sd	a4,-16(a0)
    5fbe:	a091                	j	6002 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5fc0:	ff852703          	lw	a4,-8(a0)
    5fc4:	9e39                	addw	a2,a2,a4
    5fc6:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5fc8:	ff053703          	ld	a4,-16(a0)
    5fcc:	e398                	sd	a4,0(a5)
    5fce:	a099                	j	6014 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fd0:	6398                	ld	a4,0(a5)
    5fd2:	00e7e463          	bltu	a5,a4,5fda <free+0x40>
    5fd6:	00e6ea63          	bltu	a3,a4,5fea <free+0x50>
{
    5fda:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5fdc:	fed7fae3          	bgeu	a5,a3,5fd0 <free+0x36>
    5fe0:	6398                	ld	a4,0(a5)
    5fe2:	00e6e463          	bltu	a3,a4,5fea <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5fe6:	fee7eae3          	bltu	a5,a4,5fda <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5fea:	ff852583          	lw	a1,-8(a0)
    5fee:	6390                	ld	a2,0(a5)
    5ff0:	02059713          	slli	a4,a1,0x20
    5ff4:	9301                	srli	a4,a4,0x20
    5ff6:	0712                	slli	a4,a4,0x4
    5ff8:	9736                	add	a4,a4,a3
    5ffa:	fae60ae3          	beq	a2,a4,5fae <free+0x14>
    bp->s.ptr = p->s.ptr;
    5ffe:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    6002:	4790                	lw	a2,8(a5)
    6004:	02061713          	slli	a4,a2,0x20
    6008:	9301                	srli	a4,a4,0x20
    600a:	0712                	slli	a4,a4,0x4
    600c:	973e                	add	a4,a4,a5
    600e:	fae689e3          	beq	a3,a4,5fc0 <free+0x26>
  } else
    p->s.ptr = bp;
...
malloc(uint nbytes)
{
  ...
  if(p == (char*)-1)
    ...
    6090:	b7e1                	j	6058 <malloc+0x36>
      if(p->s.size == nunits)
    6092:	02e48b63          	beq	s1,a4,60c8 <malloc+0xa6>
        p->s.size -= nunits;
    6096:	4137073b          	subw	a4,a4,s3
    609a:	c798                	sw	a4,8(a5)
        p += p->s.size;
    609c:	1702                	slli	a4,a4,0x20
    609e:	9301                	srli	a4,a4,0x20
    60a0:	0712                	slli	a4,a4,0x4
    ...
    60cc:	bff1                	j	60a8 <malloc+0x86>
  hp->s.size = nu;
    60ce:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    60d2:	0541                	addi	a0,a0,16
    60d4:	00000097          	auipc	ra,0x0
    60d8:	ec6080e7          	jalr	-314(ra) # 5f9a <free>
  return freep;
    60dc:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    60e0:	d971                	beqz	a0,60b4 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    60e2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    60e4:	4798                	lw	a4,8(a5)
    60e6:	fa9776e3          	bgeu	a4,s1,6092 <malloc+0x70>
    if(p == freep)
    60ea:	00093703          	ld	a4,0(s2)
    60ee:	853e                	mv	a0,a5
    60f0:	fef719e3          	bne	a4,a5,60e2 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    60f4:	8552                	mv	a0,s4
    60f6:	00000097          	auipc	ra,0x0
    60fa:	b6e080e7          	jalr	-1170(ra) # 5c64 <sbrk>
  if(p == (char*)-1)
    60fe:	fd5518e3          	bne	a0,s5,60ce <malloc+0xac>
        return 0;
    6102:	4501                	li	a0,0
    6104:	bf45                	j	60b4 <malloc+0x92>
