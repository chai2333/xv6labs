...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	30e58593          	addi	a1,a1,782 # 1320 <malloc+0xe6>
      1a:	4509                	li	a0,2
      1c:	00001097          	auipc	ra,0x1
      20:	df8080e7          	jalr	-520(ra) # e14 <write>
  memset(buf, 0, nbuf);
      24:	864a                	mv	a2,s2
      26:	4581                	li	a1,0
      28:	8526                	mv	a0,s1
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2c858593          	addi	a1,a1,712 # 1328 <malloc+0xee>
      68:	4509                	li	a0,2
      6a:	00001097          	auipc	ra,0x1
      6e:	0e4080e7          	jalr	228(ra) # 114e <fprintf>
  exit(1);
      72:	4505                	li	a0,1
      74:	00001097          	auipc	ra,0x1
      78:	d80080e7          	jalr	-640(ra) # df4 <exit>
...
fork1(void)
{
  ...
  pid = fork();
      ...
      88:	d68080e7          	jalr	-664(ra) # dec <fork>
  if(pid == -1)
      8c:	57fd                	li	a5,-1
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	29650513          	addi	a0,a0,662 # 1330 <malloc+0xf6>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	36a70713          	addi	a4,a4,874 # 1430 <malloc+0x1f6>
    ...
    exit(1);
      ...
      dc:	d1c080e7          	jalr	-740(ra) # df4 <exit>
    panic("runcmd");
      e0:	00001517          	auipc	a0,0x1
      e4:	25850513          	addi	a0,a0,600 # 1338 <malloc+0xfe>
    ...
    exec(ecmd->argv[0], ecmd->argv);
      ...
      fc:	d34080e7          	jalr	-716(ra) # e2c <exec>
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     100:	6490                	ld	a2,8(s1)
     102:	00001597          	auipc	a1,0x1
     106:	23e58593          	addi	a1,a1,574 # 1340 <malloc+0x106>
     10a:	4509                	li	a0,2
     10c:	00001097          	auipc	ra,0x1
     110:	042080e7          	jalr	66(ra) # 114e <fprintf>
  exit(0);
     114:	4501                	li	a0,0
     116:	00001097          	auipc	ra,0x1
     11a:	cde080e7          	jalr	-802(ra) # df4 <exit>
      exit(1);
     11e:	4505                	li	a0,1
     120:	00001097          	auipc	ra,0x1
     124:	cd4080e7          	jalr	-812(ra) # df4 <exit>
    close(rcmd->fd);
     128:	5148                	lw	a0,36(a0)
     12a:	00001097          	auipc	ra,0x1
     12e:	cf2080e7          	jalr	-782(ra) # e1c <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     132:	508c                	lw	a1,32(s1)
     134:	6888                	ld	a0,16(s1)
     136:	00001097          	auipc	ra,0x1
     13a:	cfe080e7          	jalr	-770(ra) # e34 <open>
    ...
    runcmd(rcmd->cmd);
     ...
     152:	20258593          	addi	a1,a1,514 # 1350 <malloc+0x116>
     156:	4509                	li	a0,2
     158:	00001097          	auipc	ra,0x1
     15c:	ff6080e7          	jalr	-10(ra) # 114e <fprintf>
      exit(1);
     160:	4505                	li	a0,1
     162:	00001097          	auipc	ra,0x1
     166:	c92080e7          	jalr	-878(ra) # df4 <exit>
    if(fork1() == 0)
    ...
    wait(0);
     ...
     184:	c7c080e7          	jalr	-900(ra) # dfc <wait>
    runcmd(lcmd->right);
    ...
    if(pipe(p) < 0)
     ...
     19a:	c6e080e7          	jalr	-914(ra) # e04 <pipe>
    ...
    if(fork1() == 0){
     ...
     1b2:	c6e080e7          	jalr	-914(ra) # e1c <close>
      dup(p[1]);
     1b6:	fdc42503          	lw	a0,-36(s0)
     1ba:	00001097          	auipc	ra,0x1
     1be:	cb2080e7          	jalr	-846(ra) # e6c <dup>
      close(p[0]);
     1c2:	fd842503          	lw	a0,-40(s0)
     1c6:	00001097          	auipc	ra,0x1
     1ca:	c56080e7          	jalr	-938(ra) # e1c <close>
      close(p[1]);
     1ce:	fdc42503          	lw	a0,-36(s0)
     1d2:	00001097          	auipc	ra,0x1
     1d6:	c4a080e7          	jalr	-950(ra) # e1c <close>
      runcmd(pcmd->left);
     1da:	6488                	ld	a0,8(s1)
     ...
     1e8:	17c50513          	addi	a0,a0,380 # 1360 <malloc+0x126>
    ...
    if(fork1() == 0){
     ...
     202:	c1e080e7          	jalr	-994(ra) # e1c <close>
      dup(p[0]);
     206:	fd842503          	lw	a0,-40(s0)
     20a:	00001097          	auipc	ra,0x1
     20e:	c62080e7          	jalr	-926(ra) # e6c <dup>
      close(p[0]);
     212:	fd842503          	lw	a0,-40(s0)
     216:	00001097          	auipc	ra,0x1
     21a:	c06080e7          	jalr	-1018(ra) # e1c <close>
      close(p[1]);
     21e:	fdc42503          	lw	a0,-36(s0)
     222:	00001097          	auipc	ra,0x1
     226:	bfa080e7          	jalr	-1030(ra) # e1c <close>
      runcmd(pcmd->right);
    ...
    close(p[0]);
     ...
     23c:	be4080e7          	jalr	-1052(ra) # e1c <close>
    close(p[1]);
     240:	fdc42503          	lw	a0,-36(s0)
     244:	00001097          	auipc	ra,0x1
     248:	bd8080e7          	jalr	-1064(ra) # e1c <close>
    wait(0);
     24c:	4501                	li	a0,0
     24e:	00001097          	auipc	ra,0x1
     252:	bae080e7          	jalr	-1106(ra) # dfc <wait>
    wait(0);
     256:	4501                	li	a0,0
     258:	00001097          	auipc	ra,0x1
     25c:	ba4080e7          	jalr	-1116(ra) # dfc <wait>
    break;
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     28a:	fb4080e7          	jalr	-76(ra) # 123a <malloc>
     28e:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d4:	f6a080e7          	jalr	-150(ra) # 123a <malloc>
     2d8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32e:	f10080e7          	jalr	-240(ra) # 123a <malloc>
     332:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     334:	4661                	li	a2,24
     336:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     374:	eca080e7          	jalr	-310(ra) # 123a <malloc>
     378:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     37a:	4661                	li	a2,24
     37c:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b6:	e88080e7          	jalr	-376(ra) # 123a <malloc>
     3ba:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3bc:	4641                	li	a2,16
     3be:	4581                	li	a1,0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a8:	de4b8b93          	addi	s7,s7,-540 # 1388 <malloc+0x14e>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	db250513          	addi	a0,a0,-590 # 1368 <malloc+0x12e>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	cf260613          	addi	a2,a2,-782 # 1390 <malloc+0x156>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d2:	ce2b0b13          	addi	s6,s6,-798 # 13b0 <malloc+0x176>
  ...
  return ret;
     ...
     70c:	c9050513          	addi	a0,a0,-880 # 1398 <malloc+0x15e>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	c3650513          	addi	a0,a0,-970 # 13a0 <malloc+0x166>
...
0000000000000788 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a8:	c1460613          	addi	a2,a2,-1004 # 13b8 <malloc+0x17e>
     7ac:	85ce                	mv	a1,s3
     7ae:	854a                	mv	a0,s2
...
00000000000007f6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     818:	baca0a13          	addi	s4,s4,-1108 # 13c0 <malloc+0x186>
  ...
  if(peek(ps, es, ";")){
     ...
     84e:	b7e60613          	addi	a2,a2,-1154 # 13c8 <malloc+0x18e>
     852:	85ce                	mv	a1,s3
     854:	854a                	mv	a0,s2
...
000000000000089e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b4:	ae060613          	addi	a2,a2,-1312 # 1390 <malloc+0x156>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e4:	b0060613          	addi	a2,a2,-1280 # 13e0 <malloc+0x1a6>
     8e8:	85ca                	mv	a1,s2
     8ea:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     926:	aae50513          	addi	a0,a0,-1362 # 13d0 <malloc+0x196>
     92a:	fffff097          	auipc	ra,0xfffff
     92e:	72c080e7          	jalr	1836(ra) # 56 <panic>
    panic("syntax - missing )");
     932:	00001517          	auipc	a0,0x1
     936:	ab650513          	addi	a0,a0,-1354 # 13e8 <malloc+0x1ae>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     962:	aea70713          	addi	a4,a4,-1302 # 1448 <malloc+0x20e>
...
00000000000009da <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0e:	9f660613          	addi	a2,a2,-1546 # 1400 <malloc+0x1c6>
     a12:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a44:	9c858593          	addi	a1,a1,-1592 # 1408 <malloc+0x1ce>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	704080e7          	jalr	1796(ra) # 114e <fprintf>
    panic("syntax");
     a52:	00001517          	auipc	a0,0x1
     a56:	94650513          	addi	a0,a0,-1722 # 1398 <malloc+0x15e>
...
0000000000000a62 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a78:	9a448493          	addi	s1,s1,-1628 # 1418 <malloc+0x1de>
     a7c:	4589                	li	a1,2
     a7e:	8526                	mv	a0,s1
     a80:	00000097          	auipc	ra,0x0
     a84:	3b4080e7          	jalr	948(ra) # e34 <open>
    ...
    if(fd >= 3){
     ...
     a96:	38a080e7          	jalr	906(ra) # e1c <close>
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     ab6:	96ea8a93          	addi	s5,s5,-1682 # 1420 <malloc+0x1e6>
    ...
    wait(0);
     ...
     acc:	334080e7          	jalr	820(ra) # dfc <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b1c:	34c080e7          	jalr	844(ra) # e64 <chdir>
     ...
     b2e:	624080e7          	jalr	1572(ra) # 114e <fprintf>
  ...
  exit(0);
     ...
     b52:	2a6080e7          	jalr	678(ra) # df4 <exit>
...
_main()
{
  ...
  exit(0);
     ...
     b6c:	28c080e7          	jalr	652(ra) # df4 <exit>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     c5e:	1b2080e7          	jalr	434(ra) # e0c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     cb0:	188080e7          	jalr	392(ra) # e34 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     cc0:	190080e7          	jalr	400(ra) # e4c <fstat>
     cc4:	892a                	mv	s2,a0
  close(fd);
     cc6:	8526                	mv	a0,s1
     cc8:	00000097          	auipc	ra,0x0
     ccc:	154080e7          	jalr	340(ra) # e1c <close>
  return r;
}
     cd0:	854a                	mv	a0,s2
...
ugetpid(void)
{
  ...
  return u->pid;
     ddc:	040007b7          	lui	a5,0x4000
}
     de0:	17f5                	addi	a5,a5,-3
     de2:	07b2                	slli	a5,a5,0xc
     de4:	4388                	lw	a0,0(a5)
     de6:	6422                	ld	s0,8(sp)
     de8:	0141                	addi	sp,sp,16
     dea:	8082                	ret

0000000000000dec <fork>:
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     eba:	f5e080e7          	jalr	-162(ra) # e14 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     ed8:	0805c863          	bltz	a1,f68 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     eec:	58050513          	addi	a0,a0,1408 # 1468 <digits>
     ef0:	883a                	mv	a6,a4
     ...
     efe:	0007c783          	lbu	a5,0(a5) # 4000000 <base+0x3ffdf78>
  ...
  if(neg)
     f14:	00088b63          	beqz	a7,f2a <printint+0x64>
    buf[i++] = '-';
     f18:	fd040793          	addi	a5,s0,-48
     f1c:	973e                	add	a4,a4,a5
     f1e:	02d00793          	li	a5,45
     f22:	fef70823          	sb	a5,-16(a4)
     f26:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     f2a:	02e05863          	blez	a4,f5a <printint+0x94>
     f2e:	fc040793          	addi	a5,s0,-64
     f32:	00e78933          	add	s2,a5,a4
     f36:	fff78993          	addi	s3,a5,-1
     f3a:	99ba                	add	s3,s3,a4
     f3c:	377d                	addiw	a4,a4,-1
     f3e:	1702                	slli	a4,a4,0x20
     f40:	9301                	srli	a4,a4,0x20
     f42:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     f46:	fff94583          	lbu	a1,-1(s2)
     f4a:	8526                	mv	a0,s1
     f4c:	00000097          	auipc	ra,0x0
     f50:	f58080e7          	jalr	-168(ra) # ea4 <putc>
  while(--i >= 0)
     f54:	197d                	addi	s2,s2,-1
     f56:	ff3918e3          	bne	s2,s3,f46 <printint+0x80>
}
     f5a:	70e2                	ld	ra,56(sp)
     f5c:	7442                	ld	s0,48(sp)
     f5e:	74a2                	ld	s1,40(sp)
     f60:	7902                	ld	s2,32(sp)
     f62:	69e2                	ld	s3,24(sp)
     f64:	6121                	addi	sp,sp,64
     f66:	8082                	ret
    x = -xx;
...
{
     f70:	7119                	addi	sp,sp,-128
     f72:	fc86                	sd	ra,120(sp)
     f74:	f8a2                	sd	s0,112(sp)
     f76:	f4a6                	sd	s1,104(sp)
     f78:	f0ca                	sd	s2,96(sp)
     f7a:	ecce                	sd	s3,88(sp)
     f7c:	e8d2                	sd	s4,80(sp)
     f7e:	e4d6                	sd	s5,72(sp)
     f80:	e0da                	sd	s6,64(sp)
     f82:	fc5e                	sd	s7,56(sp)
     f84:	f862                	sd	s8,48(sp)
     f86:	f466                	sd	s9,40(sp)
     f88:	f06a                	sd	s10,32(sp)
     f8a:	ec6e                	sd	s11,24(sp)
  ...
  for(i = 0; fmt[i]; i++){
     ...
     f92:	18090f63          	beqz	s2,1130 <vprintf+0x1c0>
     f96:	8aaa                	mv	s5,a0
     f98:	8b32                	mv	s6,a2
  ...
  state = 0;
     ...
     fac:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
     fb0:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fb4:	00000b97          	auipc	s7,0x0
     fb8:	4b4b8b93          	addi	s7,s7,1204 # 1468 <digits>
     fbc:	a839                	j	fda <vprintf+0x6a>
        putc(fd, c);
     fbe:	85ca                	mv	a1,s2
     fc0:	8556                	mv	a0,s5
     fc2:	00000097          	auipc	ra,0x0
     fc6:	ee2080e7          	jalr	-286(ra) # ea4 <putc>
     fca:	a019                	j	fd0 <vprintf+0x60>
    } else if(state == '%'){
     fcc:	01498f63          	beq	s3,s4,fea <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
     fd0:	0485                	addi	s1,s1,1
     fd2:	fff4c903          	lbu	s2,-1(s1)
     fd6:	14090d63          	beqz	s2,1130 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
     fda:	0009079b          	sext.w	a5,s2
    if(state == 0){
     fde:	fe0997e3          	bnez	s3,fcc <vprintf+0x5c>
      if(c == '%'){
     fe2:	fd479ee3          	bne	a5,s4,fbe <vprintf+0x4e>
        state = '%';
     fe6:	89be                	mv	s3,a5
     fe8:	b7e5                	j	fd0 <vprintf+0x60>
      if(c == 'd'){
     fea:	05878063          	beq	a5,s8,102a <vprintf+0xba>
      } else if(c == 'l') {
     fee:	05978c63          	beq	a5,s9,1046 <vprintf+0xd6>
      } else if(c == 'x') {
     ff2:	07a78863          	beq	a5,s10,1062 <vprintf+0xf2>
      } else if(c == 'p') {
     ff6:	09b78463          	beq	a5,s11,107e <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
     ffa:	07300713          	li	a4,115
     ffe:	0ce78663          	beq	a5,a4,10ca <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    1002:	06300713          	li	a4,99
    1006:	0ee78e63          	beq	a5,a4,1102 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    100a:	11478863          	beq	a5,s4,111a <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    1016:	e92080e7          	jalr	-366(ra) # ea4 <putc>
        putc(fd, c);
    101a:	85ca                	mv	a1,s2
    101c:	8556                	mv	a0,s5
    101e:	00000097          	auipc	ra,0x0
    1022:	e86080e7          	jalr	-378(ra) # ea4 <putc>
      }
      state = 0;
    1026:	4981                	li	s3,0
    1028:	b765                	j	fd0 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    103c:	e8e080e7          	jalr	-370(ra) # ec6 <printint>
    1040:	8b4a                	mv	s6,s2
      state = 0;
    1042:	4981                	li	s3,0
    1044:	b771                	j	fd0 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    1058:	e72080e7          	jalr	-398(ra) # ec6 <printint>
    105c:	8b4a                	mv	s6,s2
      state = 0;
    105e:	4981                	li	s3,0
    1060:	bf85                	j	fd0 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    1074:	e56080e7          	jalr	-426(ra) # ec6 <printint>
    1078:	8b4a                	mv	s6,s2
      state = 0;
    107a:	4981                	li	s3,0
    107c:	bf91                	j	fd0 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
  ...
  putc(fd, '0');
    ...
    1094:	e14080e7          	jalr	-492(ra) # ea4 <putc>
  putc(fd, 'x');
    1098:	85ea                	mv	a1,s10
    109a:	8556                	mv	a0,s5
    109c:	00000097          	auipc	ra,0x0
    10a0:	e08080e7          	jalr	-504(ra) # ea4 <putc>
    10a4:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    10b6:	df2080e7          	jalr	-526(ra) # ea4 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10ba:	0992                	slli	s3,s3,0x4
    10bc:	397d                	addiw	s2,s2,-1
    10be:	fe0914e3          	bnez	s2,10a6 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    10c2:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    10c6:	4981                	li	s3,0
    10c8:	b721                	j	fd0 <vprintf+0x60>
        s = va_arg(ap, char*);
    10ca:	008b0993          	addi	s3,s6,8
    10ce:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    10d2:	02090163          	beqz	s2,10f4 <vprintf+0x184>
        while(*s != 0){
    10d6:	00094583          	lbu	a1,0(s2)
    10da:	c9a1                	beqz	a1,112a <vprintf+0x1ba>
          putc(fd, *s);
    10dc:	8556                	mv	a0,s5
    10de:	00000097          	auipc	ra,0x0
    10e2:	dc6080e7          	jalr	-570(ra) # ea4 <putc>
          s++;
    10e6:	0905                	addi	s2,s2,1
        while(*s != 0){
    10e8:	00094583          	lbu	a1,0(s2)
    10ec:	f9e5                	bnez	a1,10dc <vprintf+0x16c>
        s = va_arg(ap, char*);
    10ee:	8b4e                	mv	s6,s3
      state = 0;
    10f0:	4981                	li	s3,0
    10f2:	bdf9                	j	fd0 <vprintf+0x60>
          s = "(null)";
    10f4:	00000917          	auipc	s2,0x0
    10f8:	36c90913          	addi	s2,s2,876 # 1460 <malloc+0x226>
        while(*s != 0){
    10fc:	02800593          	li	a1,40
    1100:	bff1                	j	10dc <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    1102:	008b0913          	addi	s2,s6,8
    1106:	000b4583          	lbu	a1,0(s6)
    110a:	8556                	mv	a0,s5
    110c:	00000097          	auipc	ra,0x0
    1110:	d98080e7          	jalr	-616(ra) # ea4 <putc>
    1114:	8b4a                	mv	s6,s2
      state = 0;
    1116:	4981                	li	s3,0
    1118:	bd65                	j	fd0 <vprintf+0x60>
        putc(fd, c);
    111a:	85d2                	mv	a1,s4
    111c:	8556                	mv	a0,s5
    111e:	00000097          	auipc	ra,0x0
    1122:	d86080e7          	jalr	-634(ra) # ea4 <putc>
      state = 0;
    1126:	4981                	li	s3,0
    1128:	b565                	j	fd0 <vprintf+0x60>
        s = va_arg(ap, char*);
    112a:	8b4e                	mv	s6,s3
      state = 0;
    112c:	4981                	li	s3,0
    112e:	b54d                	j	fd0 <vprintf+0x60>
    }
  }
}
    1130:	70e6                	ld	ra,120(sp)
    1132:	7446                	ld	s0,112(sp)
    1134:	74a6                	ld	s1,104(sp)
    1136:	7906                	ld	s2,96(sp)
    1138:	69e6                	ld	s3,88(sp)
    113a:	6a46                	ld	s4,80(sp)
    113c:	6aa6                	ld	s5,72(sp)
    113e:	6b06                	ld	s6,64(sp)
    1140:	7be2                	ld	s7,56(sp)
    1142:	7c42                	ld	s8,48(sp)
    1144:	7ca2                	ld	s9,40(sp)
    1146:	7d02                	ld	s10,32(sp)
    1148:	6de2                	ld	s11,24(sp)
    114a:	6109                	addi	sp,sp,128
    114c:	8082                	ret

000000000000114e <fprintf>:
...
fprintf(int fd, const char *fmt, ...)
{
    ...
    1156:	e010                	sd	a2,0(s0)
    1158:	e414                	sd	a3,8(s0)
    115a:	e818                	sd	a4,16(s0)
    115c:	ec1c                	sd	a5,24(s0)
    115e:	03043023          	sd	a6,32(s0)
    1162:	03143423          	sd	a7,40(s0)
  va_list ap;
  ...
  vprintf(fd, fmt, ap);
    ...
    1170:	e04080e7          	jalr	-508(ra) # f70 <vprintf>
}
    1174:	60e2                	ld	ra,24(sp)
    1176:	6442                	ld	s0,16(sp)
    1178:	6161                	addi	sp,sp,80
    117a:	8082                	ret

000000000000117c <printf>:

void
printf(const char *fmt, ...)
{
    117c:	711d                	addi	sp,sp,-96
    117e:	ec06                	sd	ra,24(sp)
    1180:	e822                	sd	s0,16(sp)
    1182:	1000                	addi	s0,sp,32
    1184:	e40c                	sd	a1,8(s0)
    1186:	e810                	sd	a2,16(s0)
    1188:	ec14                	sd	a3,24(s0)
    118a:	f018                	sd	a4,32(s0)
    118c:	f41c                	sd	a5,40(s0)
    118e:	03043823          	sd	a6,48(s0)
    1192:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    1196:	00840613          	addi	a2,s0,8
    119a:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    119e:	85aa                	mv	a1,a0
    11a0:	4505                	li	a0,1
    11a2:	00000097          	auipc	ra,0x0
    11a6:	dce080e7          	jalr	-562(ra) # f70 <vprintf>
}
    11aa:	60e2                	ld	ra,24(sp)
    11ac:	6442                	ld	s0,16(sp)
    11ae:	6125                	addi	sp,sp,96
    11b0:	8082                	ret

00000000000011b2 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11bc:	00001797          	auipc	a5,0x1
    11c0:	e547b783          	ld	a5,-428(a5) # 2010 <freep>
    11c4:	a805                	j	11f4 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    11c6:	4618                	lw	a4,8(a2)
    11c8:	9db9                	addw	a1,a1,a4
    11ca:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    11ce:	6398                	ld	a4,0(a5)
    11d0:	6318                	ld	a4,0(a4)
    11d2:	fee53823          	sd	a4,-16(a0)
    11d6:	a091                	j	121a <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    11d8:	ff852703          	lw	a4,-8(a0)
    11dc:	9e39                	addw	a2,a2,a4
    11de:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    11e0:	ff053703          	ld	a4,-16(a0)
    11e4:	e398                	sd	a4,0(a5)
    11e6:	a099                	j	122c <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11e8:	6398                	ld	a4,0(a5)
    11ea:	00e7e463          	bltu	a5,a4,11f2 <free+0x40>
    11ee:	00e6ea63          	bltu	a3,a4,1202 <free+0x50>
{
    11f2:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11f4:	fed7fae3          	bgeu	a5,a3,11e8 <free+0x36>
    11f8:	6398                	ld	a4,0(a5)
    11fa:	00e6e463          	bltu	a3,a4,1202 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11fe:	fee7eae3          	bltu	a5,a4,11f2 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    1202:	ff852583          	lw	a1,-8(a0)
    1206:	6390                	ld	a2,0(a5)
    1208:	02059713          	slli	a4,a1,0x20
    120c:	9301                	srli	a4,a4,0x20
    120e:	0712                	slli	a4,a4,0x4
    1210:	9736                	add	a4,a4,a3
    1212:	fae60ae3          	beq	a2,a4,11c6 <free+0x14>
    bp->s.ptr = p->s.ptr;
    1216:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    121a:	4790                	lw	a2,8(a5)
    121c:	02061713          	slli	a4,a2,0x20
    1220:	9301                	srli	a4,a4,0x20
    1222:	0712                	slli	a4,a4,0x4
    1224:	973e                	add	a4,a4,a5
    1226:	fae689e3          	beq	a3,a4,11d8 <free+0x26>
  } else
    p->s.ptr = bp;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    128a:	d8a90913          	addi	s2,s2,-630 # 2010 <freep>
  if(p == (char*)-1)
    128e:	5afd                	li	s5,-1
    1290:	a88d                	j	1302 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1292:	00001797          	auipc	a5,0x1
    1296:	df678793          	addi	a5,a5,-522 # 2088 <base>
    129a:	00001717          	auipc	a4,0x1
    129e:	d6f73b23          	sd	a5,-650(a4) # 2010 <freep>
    ...
    12a8:	b7e1                	j	1270 <malloc+0x36>
      if(p->s.size == nunits)
    12aa:	02e48b63          	beq	s1,a4,12e0 <malloc+0xa6>
        p->s.size -= nunits;
    12ae:	4137073b          	subw	a4,a4,s3
    12b2:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12b4:	1702                	slli	a4,a4,0x20
    12b6:	9301                	srli	a4,a4,0x20
    12b8:	0712                	slli	a4,a4,0x4
    12ba:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    12bc:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    12c0:	00001717          	auipc	a4,0x1
    12c4:	d4a73823          	sd	a0,-688(a4) # 2010 <freep>
      return (void*)(p + 1);
    12c8:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    12cc:	70e2                	ld	ra,56(sp)
    12ce:	7442                	ld	s0,48(sp)
    12d0:	74a2                	ld	s1,40(sp)
    12d2:	7902                	ld	s2,32(sp)
    12d4:	69e2                	ld	s3,24(sp)
    12d6:	6a42                	ld	s4,16(sp)
    12d8:	6aa2                	ld	s5,8(sp)
    12da:	6b02                	ld	s6,0(sp)
    12dc:	6121                	addi	sp,sp,64
    12de:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    12e0:	6398                	ld	a4,0(a5)
    12e2:	e118                	sd	a4,0(a0)
    12e4:	bff1                	j	12c0 <malloc+0x86>
  hp->s.size = nu;
    12e6:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    12ea:	0541                	addi	a0,a0,16
    12ec:	00000097          	auipc	ra,0x0
    12f0:	ec6080e7          	jalr	-314(ra) # 11b2 <free>
  return freep;
    12f4:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    12f8:	d971                	beqz	a0,12cc <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12fa:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    12fc:	4798                	lw	a4,8(a5)
    12fe:	fa9776e3          	bgeu	a4,s1,12aa <malloc+0x70>
    if(p == freep)
    1302:	00093703          	ld	a4,0(s2)
    1306:	853e                	mv	a0,a5
    1308:	fef719e3          	bne	a4,a5,12fa <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    130c:	8552                	mv	a0,s4
    130e:	00000097          	auipc	ra,0x0
    1312:	b6e080e7          	jalr	-1170(ra) # e7c <sbrk>
  if(p == (char*)-1)
    1316:	fd5518e3          	bne	a0,s5,12e6 <malloc+0xac>
        return 0;
    131a:	4501                	li	a0,0
    131c:	bf45                	j	12cc <malloc+0x92>
