...
stat(const char *n, struct stat *st)
{
 ...
 252:	188080e7          	jalr	392(ra) # 3d6 <open>
  if(fd < 0)
...
ugetpid(void)
{
 ...
 37c:	0800                	addi	s0,sp,16
  ...
  return u->pid;
 37e:	040007b7          	lui	a5,0x4000
}
 382:	17f5                	addi	a5,a5,-3
 384:	07b2                	slli	a5,a5,0xc
 386:	4388                	lw	a0,0(a5)
 388:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4a0:	0007c783          	lbu	a5,0(a5) # 4000000 <base+0x3ffefe0>
...
malloc(uint nbytes)
{
 ...
 804:	81053503          	ld	a0,-2032(a0) # 1010 <freep>
 ...
 82c:	7e890913          	addi	s2,s2,2024 # 1010 <freep>
  if(p == (char*)-1)
 830:	5afd                	li	s5,-1
 832:	a88d                	j	8a4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 834:	00000797          	auipc	a5,0x0
 838:	7ec78793          	addi	a5,a5,2028 # 1020 <base>
 ...
 866:	7aa73723          	sd	a0,1966(a4) # 1010 <freep>
      return (void*)(p + 1);
