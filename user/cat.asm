...
cat(int fd)
{
  ...
  44:	8b058593          	addi	a1,a1,-1872 # 8f0 <malloc+0xee>
  48:	4509                	li	a0,2
  ...
  72:	89a58593          	addi	a1,a1,-1894 # 908 <malloc+0x106>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
  ...
  be:	342080e7          	jalr	834(ra) # 3fc <open>
  c2:	84aa                	mv	s1,a0
  ...
  d6:	312080e7          	jalr	786(ra) # 3e4 <close>
  for(i = 1; i < argc; i++){
  ...
  fa:	2c6080e7          	jalr	710(ra) # 3bc <exit>
      fprintf(2, "cat: cannot open %s\n", argv[i]);
  fe:	00093603          	ld	a2,0(s2)
 102:	00001597          	auipc	a1,0x1
 106:	81e58593          	addi	a1,a1,-2018 # 920 <malloc+0x11e>
 10a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4c6:	0007c783          	lbu	a5,0(a5) # 4000000 <base+0x3ffedf0>
...
malloc(uint nbytes)
{
 ...
 85e:	9b678793          	addi	a5,a5,-1610 # 1210 <base>
 ...
 8da:	b6e080e7          	jalr	-1170(ra) # 444 <sbrk>
  if(p == (char*)-1)
